...
name: Marshal
prerequisite: 'You join an organization that hunts criminals, such as the Far Mariners (see [Orden](../rule/world/orden.md) and the Timescape in Chapter 1: [The Basics](../chapter/the-basics.md)), or you are deputized to act for the local authorities.'
