...
The specific outcome of any power roll is determined by the effect or ability that requires the roll (see Abilities) or the rules for [tests](../test/test.md) (see [Tests](../../chapter/tests.md)).
...
When you roll a [natural 19 or 20](natural-19-20.md) on a power roll, it is always a tier 3 result regardless of any modifiers, and on certain types of power rolls, this is a [critical hit](../combat/critical-hit.md) (see [Critical Hit](../combat/critical-hit.md) in [Classes](../../chapter/classes.md)).
