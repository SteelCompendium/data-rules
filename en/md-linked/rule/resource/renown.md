---
name: Renown
scc: mcdm.heroes.v1/rule.resource/renown
type: rule
---
...
Your [Renown](renown.md) score allows you to attract and employ followers who perform different duties or favors for you. The [Renown](renown.md) and Followers table shows how many followers a hero can have at one time based on [Renown](renown.md). You can always let go of a follower in your employ to hire a new one.

You can recruit followers up to the maximum your [Renown](renown.md) allows as a [respite](respite.md) activity, provided you are in a place or have a means of communication that allows you to recruit such followers.

##### Renown and Followers Table

| [Renown](renown.md) | Number of [Followers](../general/follower.md) |
|--------|---------------------|
| 3      | 1                   |
| 6      | 2                   |
| 9      | 3                   |
...
Retainers are heroic [NPCs](../general/npc.md) who adventure alongside the player characters. They are controlled by players in combat and are both simpler to run and less powerful than player characters. A hero can have only one retainer in their service at a time unless the Director deems otherwise. Because retainers and their stat blocks are combat focused, the Director can also decide that a large party can have only one retainer in total—or can't have any retainers at all—to keep combat from getting long and tedious.
