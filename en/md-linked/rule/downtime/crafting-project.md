...
Crafting projects enable heroes to create vehicles, supernatural treasures, and more. When you start a crafting project, other creatures can also work on the project, using their [respite](../resource/respite.md) activity to contribute a [project roll](project-roll.md) in order to get the work done faster.
...
The number of [project points](project-points.md) it takes to complete this project is equal to 50 times the level of the creature who caused the affliction. If the affliction was created by an environmental or supernatural effect, that effect notes the [item prerequisite](item-prerequisite.md) and [project points](project-points.md) required to complete this project.
...
**[Project Source](project-source.md):** Texts or lore in a language determined by the enhancement
...
**Swift:** You gain a +1 bonus to [speed](../character/speed.md).
...
| Enhancement          | [Item Prerequisite](item-prerequisite.md)                                                                                | [Project Source](project-source.md) Language |
|----------------------|--------------------------------------------------------------------------------------------------|-------------------------|
...
**[Item Prerequisite](item-prerequisite.md):** Armor with a 1st-level enhancement; varies
...
**[Item Prerequisite](item-prerequisite.md):** Armor with a 5th-level enhancement; varies
...
**Phasing III:** Your movement doesn't provoke [opportunity attacks](../combat/opportunity-attack.md), and you can move through the space of any enemy as if they were an ally. You can't end your turn in an enemy's space.
...
On your turn, you can [teleport](../../movement/teleport.md) to the imprint's space as a [free maneuver](../combat/free-maneuver.md). When you are targeted by an ability, you can use a free [triggered action](../combat/triggered-action.md) to [teleport](../../movement/teleport.md) to your imprint, and the [power roll](../dice/power-roll.md) for the ability is an automatic tier 1 result.

**Unbending:** You can't be subjected to [forced movement](../../movement/forced-movement.md) unless you choose to be. Effects that ignore [Stability](../character/stability.md) also ignore this enhancement.
...
An implement imbued with an enhancement grants you special benefits while it is wielded. Additionally, when an implement receives its 1st-level enhancement, it grants your magic or psionic abilities that deal [rolled damage](../damage/rolled-damage.md) a +1 damage bonus. A 5th-level enhancement increases the bonus to +2, and a 9th-level enhancement increases it to +3. [Censors](../../class/censor.md), [conduits](../../class/conduit.md), [elementalists](../../class/elementalist.md), [nulls](../../class/null.md), [talents](../../class/talent.md), and [troubadours](../../class/troubadour.md) benefit from using implements more than the other classes in this book.
...
**[Item Prerequisite](item-prerequisite.md):** An implement with a 1st-level enhancement; varies
...
**Displacing II:** When you use the implement's Displacing I enhancement, you can [teleport](../../movement/teleport.md) the creature up to 4 squares. Additionally, the creature takes a [bane](../dice/bane.md) on their next [power roll](../dice/power-roll.md) made before the end of their next turn.
...
**Warding II:** The [Stamina](../health/stamina.md) bonus for the Warding I enhancement becomes +12. Additionally, your [characteristic](../character/characteristic.md) scores are treated as 1 higher for the purpose of resisting [potencies](../character/potency.md).
...
**[Item Prerequisite](item-prerequisite.md):** An implement with a 5th-level enhancement; varies
...
**Displacing III:** When you use the implement's Displacing I enhancement, you can [teleport](../../movement/teleport.md) the creature up to 5 squares. Additionally, the creature takes a [bane](../dice/bane.md) on their next [power roll](../dice/power-roll.md) made before the end of their next turn.
...
A weapon imbued with an enhancement grants you special benefits while it is wielded. Additionally, when a weapon receives its 1st-level enhancement, it grants your weapon abilities that deal [rolled damage](../damage/rolled-damage.md) a +1 damage bonus. A 5th-level enhancement increases the damage bonus to +2, and a 9th-level enhancement increases it to +3.
...
**[Item Prerequisite](item-prerequisite.md):** A weapon with a 1st-level enhancement; varies
...
**[Item Prerequisite](item-prerequisite.md):** A weapon with a 5th-level enhancement; varies
...
**Nova:** Whenever you damage a creature using this weapon, each enemy adjacent to you takes damage based on the [tier outcome](../dice/tier-outcome.md) of the [power roll](../dice/power-roll.md)-2 damage for tier 1, 6 for tier 2, or 10 for tier 3. Additionally, while you are [winded](../health/winded.md), you have the following ability.
