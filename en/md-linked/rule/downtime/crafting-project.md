...
scc: mcdm.heroes.v1/rule.downtime/crafting-project
type: rule
---

Crafting projects enable heroes to create vehicles, [supernatural](../general/supernatural.md) treasures, and more. When you start a crafting project, other creatures can also work on the project, using their [respite](../resource/respite.md) activity to contribute a [project roll](project-roll.md) in order to get the work done faster.

Unless a project has an event table of its own, the Director uses the Crafting and Research Events table for crafting [project events](project-event.md).

## Build Airship {data-scc="mcdm.heroes.v1/project/build-airship"}

**[Item Prerequisite](item-prerequisite.md):** Wind Crystal of Quintessence

**[Project Source](project-source.md):** Texts or lore in Low Rhyvian

**[Project Roll](project-roll.md) [Characteristic](../character/characteristic.md):** [Might](../character/might.md), [Reason](../character/reason.md), or [Presence](../character/presence.md)

**Project Goal:** 3,000

When you start this project, you hire a crew of carpenters, mages, and shipwrights who work in the area where the project is undertaken, with these artisans building the ship for you. You can make a [project roll](project-roll.md) whenever you are overseeing the project, which you might be able to do remotely through the use of magic or psionics.

When the project is completed, you have an airship. You and any creatures you designate can operate the ship by touching the ship's wheel. During combat, a creature touching the wheel can use a maneuver to make the ship move up to 10 squares. The ship can be moved only once per round. Out of combat, the ship has a [speed](../character/speed.md) of 130 miles per day.
...
**[Project Source](project-source.md):** Texts or lore in Caelian

**[Project Roll](project-roll.md) [Characteristic](../character/characteristic.md):** [Might](../character/might.md), [Reason](../character/reason.md), or [Presence](../character/presence.md)

**Project Goal:** Varies

When you start this project, you hire a crew of masons, engineers, and guards who start work at the location where the project begins and build or repair the road for you. You can make a [project roll](project-roll.md) whenever you are overseeing the project, whether you do so in person or remotely through the use of magic or psionics.

The number of [project points](project-points.md) required to complete work on the road equals 10 x the road's length in miles. The goal is cut in half if you are repairing an existing road, or if someone else starts work on a second road project that connects to your project.
...
| 2   | After the roll, the local population grows in excitement with each completed portion of the road. The name of the hero making the [project roll](project-roll.md) spreads as a builder of bridges both literal and social. If the [project roll](project-roll.md) is 12 or higher, the local community comes together to complete the project alongside the hero's hired crew. The hero doubles the [renown](../resource/renown.md) earned at the end of the project.                                                    |
| 3   | Before the roll, a local religious or civic authority hears of the project and sends laborers to accelerate it—in exchange for a future favor. The hero gains an immediate 50 [project points](project-points.md) for the project if they accept the help.                                                                                                                                                                                                                     |
| 4   | After the roll, local hired hands and the project engineers find themselves at odds, hindering the project. If the hero can't help defuse the situation, the project requires an additional 50 [project points](project-points.md) to complete.                                                                                                                                                                                                                                |
| 5   | Before the roll, supply caravans are disrupted by bandits, requiring extra guards. If the hero can't deal with the bandit threat personally, the project requires an additional 50 [project points](project-points.md) to complete.                                                                                                                                                                                                                                            |
| 6   | After the roll, word is heard that not everyone in the local area is happy about the road being built. The project is hindered by [supernatural](../general/supernatural.md) curses that cause stones to move, vines and overgrowth to reclaim sections already built, or churning earth to restore the road back to its previous form. The hero must make amends to the local [supernatural](../general/supernatural.md) community or have the [renown](../resource/renown.md) earned by completing the project not extend to that community. |
| 7   | After the roll, ditchers working on the project hit an ancient well, retaining wall, or hidden stream that results in an immediate flood. The work is delayed, but the new water source ultimately provides a boon to local farming communities. [Project points](project-points.md) earned by this roll are halved, but upon the project's completion, the hero earns 1 additional [renown](../resource/renown.md).                                                                                    |
| 8   | Before the roll, a new engineer arrives with specialist experience such as building sturdy wooden bridges, using bilge pumps to keep rainwater from slowing the work, and so forth. They want to work on the project, but insist on receiving a [consumable](../treasure/consumable.md) treasure first. If they are hired, the project gains an automatic breakthrough.                                                                                                                |
| 9   | Before the roll, the proposed road touches on a [supernatural](../general/supernatural.md) intersection—a crossing place between multiple worlds that draws interest from a powerful [devil](../../ancestry/devil.md). The completion of the project becomes the personal interest of this being, who offers to increase progress—but demands a future favor from the hero. If the deal is accepted, each [project roll](project-roll.md) for the project is doubled until its completion.                                            |
| 10  | After the roll, a guildmaster has it out for the hero. Whether from a past conflict or something about the way this project has unfolded, the guildmaster has made it their mission to hinder the project by dragging the hero's name through the mud. The hero's [renown](../resource/renown.md) is treated as 1 less than usual while these rumors persist.                                                                                                                      |

## Craft Teleportation Platform {data-scc="mcdm.heroes.v1/project/craft-teleportation-platform"}

**[Item Prerequisite](item-prerequisite.md):** One spatial navigator

**[Project Source](project-source.md):** Texts or lore in Voll

**[Project Roll](project-roll.md) [Characteristic](../character/characteristic.md):** [Reason](../character/reason.md)

**Project Goal:** 1,500

When you complete this project, you end up with a 3-square-by-3 square [teleport](../../movement/teleport.md)ation platform activated by a [supernatural](../general/supernatural.md) password. The platform is permanently affixed to the ground in the location where you create it. Any creature with the password can use the [teleport](../../movement/teleport.md)ation platform to instantly [teleport](../../movement/teleport.md) any creatures or objects on the platform to a location they know, including another [teleport](../../movement/teleport.md)ation platform whose [supernatural](../general/supernatural.md) password they know. You and any creature you designate upon completion of the activity can change the password as a [respite](../resource/respite.md) activity.

Each time the [teleport](../../movement/teleport.md)ation platform is used, the chance of it malfunctioning and [teleporting](../../movement/teleport.md) creatures or objects on it to a random platform increases by 1 percent (to a maximum of 50 percent). You can restore the platform back to its original [condition](../combat/condition.md) and reset this chance of malfunction as a [respite](../resource/respite.md) activity.

## Craft Treasure {data-scc="mcdm.heroes.v1/project/craft-treasure"}

You can craft the items found in Treasures in Chapter 13: [Rewards](../../chapter/rewards.md). Each treasure notes its [item prerequisite](item-prerequisite.md), [project source](project-source.md), [project roll](project-roll.md) [characteristic](../character/characteristic.md), and project goal.

## Find a Cure {data-scc="mcdm.heroes.v1/project/find-a-cure"}

**[Item Prerequisite](item-prerequisite.md):** Varies (see description)

**[Project Source](project-source.md):** None

**[Project Roll](project-roll.md) [Characteristic](../character/characteristic.md):** [Reason](../character/reason.md) or [Intuition](../character/intuition.md)

**Project Goal:** Varies

You research a cure for a disease, curse, or [supernatural](../general/supernatural.md) affliction whose text states that it can be ended by the Find a Cure downtime project. If the affliction was caused by the innate feature of a creature, you need the remains of that creature or another creature of the same kind as an [item prerequisite](item-prerequisite.md) for crafting the cure. For example, you can research the cure for the affliction of a werewolf's Accursed Bite by studying the corpse of any werewolf, not just the one who did the biting.

The number of [project points](project-points.md) it takes to complete this project is equal to 50 times the level of the creature who caused the affliction. If the affliction was created by an environmental or [supernatural](../general/supernatural.md) effect, that effect notes the [item prerequisite](item-prerequisite.md) and [project points](project-points.md) required to complete this project.

When you complete this project, you craft one dose of an alchemical cure for the affliction. Once the project is completed, you can craft subsequent doses for the same affliction for half the number of [project points](project-points.md) required for the initial project.

## Imbue Treasure {data-scc="mcdm.heroes.v1/project/imbue-treasure"}

You can create [leveled treasures](../treasure/leveled-treasure.md) by imbuing items with magic or psionic power. You must have a mundane version of the item you plan to imbue, such as a sword or shield, when you start this project.

You can imbue any item three times. The first time you imbue it, you pick a 1st-level [enhancement](../treasure/enhancement.md). The second time you imbue it, you pick a 5th-level [enhancement](../treasure/enhancement.md). The third time you imbue it, you pick a 9th-level [enhancement](../treasure/enhancement.md). A hero using armor or a weapon can't benefit from an [enhancement](../treasure/enhancement.md) unless they are using a kit that includes the armor or weapon type, and their level matches the [enhancement](../treasure/enhancement.md)'s level.

If an [enhancement](../treasure/enhancement.md) has a Roman numeral greater than I after it, such as the Phasing III [enhancement](../treasure/enhancement.md), that [enhancement](../treasure/enhancement.md) can't be applied unless the item has all previous versions of the [enhancement](../treasure/enhancement.md). This means you can't imbue armor with the Phasing III [enhancement](../treasure/enhancement.md) unless it has the Phasing I and Phasing II [enhancements](../treasure/enhancement.md) first. The effects of numbered [enhancements](../treasure/enhancement.md) are cumulative unless otherwise noted.

[Enhancements](../treasure/enhancement.md) are broken out by item type (armor, [implement](../treasure/implement.md), or weapon) and level. Each item type and level features a table showing the name, [item prerequisite](item-prerequisite.md), and [project source](project-source.md) language of each [enhancement](../treasure/enhancement.md). Imbued items take the Magic or Psionic keyword (your choice) and are part of any kit categories appropriate to the type of item (light armor, medium weapon, and so forth).

Imbuing treasure with [supernatural](../general/supernatural.md) power as a downtime project typically means you undertake that project to make use of the treasure yourself. As such, all the features of imbuing refer to "you" as the user of the item. However, imbued items can be created for other creatures, or created by other creatures and found as treasure.

### Imbue Armor {data-scc="mcdm.heroes.v1/rule.treasure/enhancement"}

Armor imbued with an enhancement grants you special benefits while it is worn. Additionally, when your armor receives its 1st-level enhancement, it also grants a +6 [bonus](../dice/bonuses-and-penalties.md) to [Stamina](../health/stamina.md). A 5th-level enhancement increases the [Stamina](../health/stamina.md) [bonus](../dice/bonuses-and-penalties.md) to +12, and a 9th-level enhancement increases it to +21.

> **Clothing as Armor Treasures**
>
> A hero who has a kit that provides no armor, such as the [Martial Artist](../../kit/martial-artist.md) or [Sniper](../../kit/sniper.md) kit, can create and make use of leveled armor treasures that imbue mundane clothing with [supernatural](../general/supernatural.md) power. At the Director's discretion, heroes who don't use kits, such as [elementalists](../../class/elementalist.md) and [nulls](../../class/null.md), can also benefit from such treasures.

#### 1st-Level Armor Enhancement

**[Item Prerequisite](item-prerequisite.md):** Varies

**[Project Source](project-source.md):** Texts or lore in a language determined by the [enhancement](../treasure/enhancement.md)

**[Project Roll](project-roll.md) [Characteristic](../character/characteristic.md):** [Might](../character/might.md), [Reason](../character/reason.md), or [Intuition](../character/intuition.md)

**Project Goal:** 150

**Awe:** When you start this project, choose either Charming or Threatening. If you choose Charming, you gain an [edge](../dice/edge.md) on [Presence](../character/presence.md) [tests](../test/test.md) made to win other creatures over or make a good impression. If you choose Threatening, you gain an [edge](../dice/edge.md) on [Presence](../character/presence.md) [tests](../test/test.md) made to intimidate, coerce, or bully.
...
**Iridescent:** When you are the sole target of an ability, you can use a free [triggered action](../combat/triggered-action.md) to reveal that the ability was targeting an afterimage of you in the same space as you. The [power roll](../dice/power-roll.md) for the ability is treated as an 11. You can't use this [enhancement](../treasure/enhancement.md) again until you earn 1 or more [Victories](../resource/victories.md).

**Magic Resistance I:** Your [characteristic](../character/characteristic.md) scores are treated as 1 higher (to a maximum of 2) for the purpose of resisting the [potencies](../character/potency.md) of magic abilities.

**Nettlebloom:** Whenever you are [grabbed](../../condition/grabbed.md) by an [adjacent](../combat/adjacent.md) creature, your armor sprouts toxic nettles. While that creature has you [grabbed](../../condition/grabbed.md), they are [weakened](../../condition/weakened.md).

**Phasing I:** Once per [turn](../combat/turn.md), you can move through 1 square of solid matter. If you end your [turn](../combat/turn.md) inside solid matter, you are forced out into the space from which you entered it and you take 5 damage that can't be reduced in any way.

**Psionic Resistance I:** Your [characteristic](../character/characteristic.md) scores are treated as 1 higher (to a maximum of 2) for the purpose of resisting the [potencies](../character/potency.md) of psionic abilities.
...
| [Enhancement](../treasure/enhancement.md)          | [Item Prerequisite](item-prerequisite.md)                                                                                | [Project Source](project-source.md) Language |
|----------------------|--------------------------------------------------------------------------------------------------|-------------------------|
| Awe                  | A lock of hair from a fey, taken in amicable bargain for Charming or in violence for Threatening | Khelt                   |
| [Damage Immunity](../damage/damage-immunity.md) I    | Elemental sand left behind when an elemental enters [Orden](../world/orden.md) from Quintessence                      | Zaliac                  |
...
**[Item Prerequisite](item-prerequisite.md):** Armor with a 1st-level [enhancement](../treasure/enhancement.md); varies
...
**Absorption:** Whenever you are targeted by a magic or psionic ability that targets only one creature, you can use a free [triggered action](../combat/triggered-action.md) to cause this armor to absorb the ability after the ability's effects resolve. While the armor has an ability absorbed, you can't absorb another.

You can use an absorbed ability as if you knew it, making [power rolls](../dice/power-roll.md) for the ability using your choice of [Reason](../character/reason.md), [Intuition](../character/intuition.md), or [Presence](../character/presence.md). You don't need to spend any [Heroic Resource](../resource/heroic-resource.md) to activate the ability. Once you use the ability, the armor loses it, and you can absorb another.
...
**Dragon Soul:** When another creature causes you to be [winded](../health/winded.md) or [dying](../health/dying.md), you can use a free [triggered action](../combat/triggered-action.md) to cause the soul of a dragon to emerge from this armor and hurtle toward the creature. Make the following [power roll](../dice/power-roll.md) against the creature.
...
**Magic Resistance II:** Your [characteristic](../character/characteristic.md) scores are treated as 2 higher (to a maximum of 3) for the purpose of resisting the [potencies](../character/potency.md) of magic abilities. This benefit replaces Magic Resistance I.

**Phasing II:** When you use the armor's Phasing I [enhancement](../treasure/enhancement.md), you can move through 3 squares of solid matter per [turn](../combat/turn.md).

**Psionic Resistance II:** Your [characteristic](../character/characteristic.md) scores are treated as 2 higher (to a maximum of 3) for the purpose of resisting the [potencies](../character/potency.md) of psionic abilities. This benefit replaces Psionic Resistance I.

**Reactive:** Whenever you take damage, you have [damage immunity](../damage/damage-immunity.md) 2 until the end of your next [turn](../combat/turn.md) after the triggering damage is resolved.

**Second Wind:** Whenever you become [winded](../health/winded.md), you can use a free [triggered action](../combat/triggered-action.md) to spend a [Recovery](../health/recoveries.md).
...
**[Item Prerequisite](item-prerequisite.md):** Armor with a 5th-level [enhancement](../treasure/enhancement.md); varies
...
**Magic Resistance III:** The benefit of the armor's Magic Resistance II [enhancement](../treasure/enhancement.md) extends to each ally within 3 squares of you.
...
**Psionic Resistance III:** The benefit of the armor's Psionic Resistance II [enhancement](../treasure/enhancement.md) extends to each ally within 3 squares of you.
...
**Unbending:** You can't be subjected to [forced movement](../../movement/forced-movement.md) unless you choose to be. Effects that ignore [Stability](../character/stability.md) also ignore this [enhancement](../treasure/enhancement.md).
...
| Life                   | The tear of a [saint](../world/saint.md)                                                                                  | High Kuric              |
...
An implement imbued with an [enhancement](../treasure/enhancement.md) grants you special benefits while it is wielded. Additionally, when an implement receives its 1st-level [enhancement](../treasure/enhancement.md), it grants your magic or psionic abilities that deal [rolled damage](../damage/rolled-damage.md) a +1 damage [bonus](../dice/bonuses-and-penalties.md). A 5th-level [enhancement](../treasure/enhancement.md) increases the [bonus](../dice/bonuses-and-penalties.md) to +2, and a 9th-level [enhancement](../treasure/enhancement.md) increases it to +3. [Censors](../../class/censor.md), [conduits](../../class/conduit.md), [elementalists](../../class/elementalist.md), [nulls](../../class/null.md), [talents](../../class/talent.md), and [troubadours](../../class/troubadour.md) benefit from using implements more than the other classes in this book.
...
**[Project Roll](project-roll.md) [Characteristic](../character/characteristic.md):** [Agility](../character/agility.md), [Reason](../character/reason.md), or [Intuition](../character/intuition.md)

**Project Goal:** 150

**Berserking:** Whenever you damage a creature using a magic or psionic ability and obtain a tier 3 outcome, that creature must make an [opportunity attack](../combat/opportunity-attack.md) against their nearest ally if possible after the ability's effects resolve. This [strike](../combat/strike.md) deals extra damage equal to the highest of your [Reason](../character/reason.md), [Intuition](../character/intuition.md), or [Presence](../character/presence.md) scores.
...
**Seeking:** Your [ranged](../combat/ranged.md) magic or psionic abilities gain a +2 [distance](../combat/distance.md) [bonus](../dice/bonuses-and-penalties.md). Additionally, if you think the name of a specific creature, place, or object to the [implement](../treasure/implement.md), the [implement](../treasure/implement.md) points toward that target, provided you are on the same world.

**Thought Sending:** Your [ranged](../combat/ranged.md) magic and psionic abilities gain a +2 [distance](../combat/distance.md) [bonus](../dice/bonuses-and-penalties.md). Additionally, you can telepathically communicate with any willing creature who knows a language and whose name you know, provided they are on the same world as you. You must initiate the conversation, but once you do, the creature can respond until you end the conversation.

**Warding I:** You gain a +6 [bonus](../dice/bonuses-and-penalties.md) to [Stamina](../health/stamina.md).
...
**[Item Prerequisite](item-prerequisite.md):** An [implement](../treasure/implement.md) with a 1st-level [enhancement](../treasure/enhancement.md); varies
...
**Lingering I:** Whenever you damage a creature using a magic or psionic ability and obtain a tier 3 outcome, that creature takes 8 damage at the start of your next [turn](../combat/turn.md).
...
**Warding II:** The [Stamina](../health/stamina.md) [bonus](../dice/bonuses-and-penalties.md) for the Warding I [enhancement](../treasure/enhancement.md) becomes +12. Additionally, your [characteristic](../character/characteristic.md) scores are treated as 1 higher for the purpose of resisting [potencies](../character/potency.md).
...
**[Item Prerequisite](item-prerequisite.md):** An [implement](../treasure/implement.md) with a 5th-level [enhancement](../treasure/enhancement.md); varies
...
**Anathema:** Whenever you damage a creature using a magic or psionic ability and obtain a tier 3 outcome, that creature is also [weakened](../../condition/weakened.md) (save ends). If the creature is within 10 squares when this [weakened](../../condition/weakened.md) effect ends, you can use a free [triggered action](../combat/triggered-action.md) to make a [free strike](../../feature/common/main-actions/free-strike.md) against them.

**Displacing III:** When you use the [implement](../treasure/implement.md)'s Displacing I [enhancement](../treasure/enhancement.md), you can [teleport](../../movement/teleport.md) the creature up to 5 squares. Additionally, the creature takes a [bane](../dice/bane.md) on their next [power roll](../dice/power-roll.md) made before the end of their next [turn](../combat/turn.md).
...
**Psionic Siphon:** Once per [turn](../combat/turn.md) when you damage one or more creatures using a magic or psionic ability and obtain a tier 3 outcome, you gain [Stamina](../health/stamina.md) equal to your highest [characteristic](../character/characteristic.md) score, and one creature you damage takes an extra 5 damage.
...
**Warding III:** The [Stamina](../health/stamina.md) [bonus](../dice/bonuses-and-penalties.md) for the Warding I [enhancement](../treasure/enhancement.md) becomes +18. Additionally, you and each ally within 3 squares of you has their [characteristic](../character/characteristic.md) scores treated as 1 higher for the purpose of resisting [potencies](../character/potency.md). This replaces the benefit of Warding II.
...
A weapon imbued with an [enhancement](../treasure/enhancement.md) grants you special benefits while it is wielded. Additionally, when a weapon receives its 1st-level [enhancement](../treasure/enhancement.md), it grants your weapon abilities that deal [rolled damage](../damage/rolled-damage.md) a +1 damage [bonus](../dice/bonuses-and-penalties.md). A 5th-level [enhancement](../treasure/enhancement.md) increases the damage [bonus](../dice/bonuses-and-penalties.md) to +2, and a 9th-level [enhancement](../treasure/enhancement.md) increases it to +3.

#### Unarmed Strike Treasures

A hero who has a kit that uses unarmed [strikes](../combat/strike.md), such as the [Martial Artist](../../kit/martial-artist.md) and [Pugilist](../../kit/pugilist.md) kit, can create leveled weapon treasures that enhance their unarmed [strikes](../combat/strike.md) by imbuing hand wraps, rings, shoes, or any other item worn on the body with [supernatural](../general/supernatural.md) power. At the Director's discretion, heroes who don't use kits, such as [elementalists](../../class/elementalist.md) and [nulls](../../class/null.md), can also benefit from such treasures.
...
**Hurling:** Whenever you use a [melee](../combat/melee.md) ability using this weapon, you can throw the weapon by treating the ability's [distance](../combat/distance.md) as [ranged](../combat/ranged.md) 3 instead. When the ability is resolved, the weapon returns to your hand. Any ability used when you throw this weapon can't impose the [grabbed](../../condition/grabbed.md) or [restrained](../../condition/restrained.md) [conditions](../combat/condition.md).
...
| Disrupting I  | A vial of blood from a living [saint](../world/saint.md)                                  | Anjali                  |
...
**[Item Prerequisite](item-prerequisite.md):** A weapon with a 1st-level [enhancement](../treasure/enhancement.md); varies
...
>
> | **[Melee](../combat/melee.md), [Strike](../combat/strike.md), Weapon** | **Free triggered** |
> |---------------------------|-------------------:|
> | **📏 [Melee](../combat/melee.md) 1**            |   **🎯 One enemy** |
>
> **Trigger:** The target willingly moves [adjacent](../combat/adjacent.md) to you.
>
...
>
> **Devastating:** Whenever you make an [ability roll](../dice/ability-roll.md) using this weapon, the number you need to roll to score a [critical hit](../combat/critical-hit.md) is reduced by 1.
>
...
> - **Large:** Abilities using this weapon gain a +1 [melee](../combat/melee.md) [distance](../combat/distance.md) [bonus](../dice/bonuses-and-penalties.md) or a +3 [ranged](../combat/ranged.md) [distance](../combat/distance.md) [bonus](../dice/bonuses-and-penalties.md).
...
>
> **Silencing:** Whenever you damage a creature with an ability using this weapon and obtain a tier 3 outcome, that creature also can't use magic abilities until the end of their next [turn](../combat/turn.md).
>
...
| Enchantment   | [Item Prerequisite](item-prerequisite.md)                                               | [Project Source](project-source.md) Language |
|---------------|-----------------------------------------------------------------|-------------------------|
...
**[Item Prerequisite](item-prerequisite.md):** A weapon with a 5th-level [enhancement](../treasure/enhancement.md); varies
...
> | **Area, Magic** |               **Main action** |
> |-----------------|------------------------------:|
> | **📏 3 [burst](../combat/burst.md)**  | **🎯 Each enemy in the area** |
>
> **[Power Roll](../dice/power-roll.md) + Your Highest [Characteristic](../character/characteristic.md) Score:**
>
> - **≤11:** 7 fire damage
...
>
> **Windcutting:** Whenever you use a [melee](../combat/melee.md) [signature ability](../combat/signature-ability.md) that usually targets one creature, you can take a [bane](../dice/bane.md) on the ability to target each enemy in a [cube](../combat/cube.md) 3 within [distance](../combat/distance.md). If your [signature ability](../combat/signature-ability.md) would usually cause its target to become [grabbed](../../condition/grabbed.md) or [restrained](../../condition/restrained.md), each target in the area is instead [slowed](../../condition/slowed.md) until the end of their next [turn](../combat/turn.md).
