...
Like [trinkets](trinket.md), leveled treasures can be used at will without a reduction in [potency](../character/potency.md). However, leveled treasures tap into their wielder's will in a way that [trinkets](trinket.md) don't, becoming more powerful and increasing their capabilities as you gain new levels.
...
- **≤11:** One of your [leveled treasures](leveled-treasure.md) (chosen by the Director) grabs hold of your psyche. It forces you to sleepwalk or otherwise enter an active fugue state and discard the rest of your [leveled treasures](leveled-treasure.md) in locations you can't remember. If you want those items back, you'd better get looking before someone else finds them.
...
>
> Because you can carry up to three [leveled treasures](leveled-treasure.md) safely, it's easy to assume that your hero should always seek out and carry three such treasures. The truth is that many heroes find carrying just one or two [leveled treasures](leveled-treasure.md) a perfect thematic and mechanical fit, and have no real need for more. That's totally fine! You'll still be super powerful with just one [leveled treasure](leveled-treasure.md), especially if you obtain or craft [trinkets](trinket.md) and [consumables](consumable.md) that might serve you better.

## Leveled Armor Treasures

Magic and psionic armor and shields are the primary tools of heroes always ready to hurl themselves into combat. This section presents [leveled armor treasures](../../chapter/treasures.md) in alphabetical order.
...
**[Item Prerequisite](../downtime/item-prerequisite.md):** Five rabid honey badger pelts, the quills of a hedgehog
...
**[Item Prerequisite](../downtime/item-prerequisite.md):** A set of wings from a [flying](../../movement/fly.md) carp, a set of chain mail rusted by seawater

**[Project Source](../downtime/project-source.md):** Texts or lore in Zaliac

**[Project Roll](../downtime/project-roll.md) [Characteristic](../character/characteristic.md):** [Might](../character/might.md), [Reason](../character/reason.md), or [Intuition](../character/intuition.md)
...
**[Item Prerequisite](../downtime/item-prerequisite.md):** A giant scarab beetle carapace

**[Project Source](../downtime/project-source.md):** Texts or lore in Phaedran
...
**[Item Prerequisite](../downtime/item-prerequisite.md):** A ballad of heroism, two ingots of sunmetal

**[Project Source](../downtime/project-source.md):** Songs in High Rhyvian

**[Project Roll](../downtime/project-roll.md) [Characteristic](../character/characteristic.md):** [Reason](../character/reason.md), [Intuition](../character/intuition.md), or [Presence](../character/presence.md)
...
**[Item Prerequisite](../downtime/item-prerequisite.md):** The eyes of a [time raider](../../ancestry/time-raider.md) who died valiantly in battle
...
**[Item Prerequisite](../downtime/item-prerequisite.md):** Ten pages from each of a hundred different books
...
**[Item Prerequisite](../downtime/item-prerequisite.md):** The will of a deceased person with no heirs
...
**[Item Prerequisite](../downtime/item-prerequisite.md):** Ten steel gears from an ancient construct
...
**[Item Prerequisite](../downtime/item-prerequisite.md):** A large vessel of astral ice, a pint of supercooled mercury
...
**[Item Prerequisite](../downtime/item-prerequisite.md):** Three ingots of steel, six crystals that resonate with psionic power
...
[Implements](implement.md) are pieces of jewelry, orbs, staffs, tomes, wands, and other objects used by magic and psionic heroes to focus their power. This section presents [leveled implement treasures](../../chapter/treasures.md) in alphabetical order.
...
**[Item Prerequisite](../downtime/item-prerequisite.md):** A handful of shattered quartz
...
For combat-focused heroes, weapons channeling magic and psionic power can easily tip the balance of any battle. This section presents [leveled weapon treasures](../../chapter/treasures.md) in alphabetical order.
...
**[Item Prerequisite](../downtime/item-prerequisite.md):** A lash used to punish a mutineer
...
**[Item Prerequisite](../downtime/item-prerequisite.md):** A ruby hardened in the fires of the City of Brass, a sapphire that has been struck by lightning
...
**[Item Prerequisite](../downtime/item-prerequisite.md):** A personal blessing from the greatest duelist in the land, six fake and extremely shiny gemstones

**[Project Source](../downtime/project-source.md):** Texts or lore in Caelian

**[Project Roll](../downtime/project-roll.md) [Characteristic](../character/characteristic.md):** [Agility](../character/agility.md), [Reason](../character/reason.md), or [Intuition](../character/intuition.md)
...
**[Item Prerequisite](../downtime/item-prerequisite.md):** An ancient bronze gear covered in indecipherable runes

**[Project Source](../downtime/project-source.md):** Texts in Zaliac
...
**1st Level:** Any weapon ability that deals [rolled damage](../damage/rolled-damage.md) using this weapon deals an extra 1 psychic damage. Additionally, whenever you deal [rolled damage](../damage/rolled-damage.md) to a creature, you can use a maneuver to [teleport](../../movement/teleport.md) you and that creature, letting you trade places provided you both fit into each other's spaces.
...
**[Item Prerequisite](../downtime/item-prerequisite.md):** The skull of a convicted criminal
...
**1st Level:** Any weapon ability that deals [rolled damage](../damage/rolled-damage.md) using this weapon deals an extra 1 psychic damage, or an extra 2 psychic damage if the target is [winded](../health/winded.md). Additionally, the first time in an encounter that you cause an enemy to become [winded](../health/winded.md) with an ability using the weapon, you gain 10 [temporary Stamina](../health/temporary-stamina.md).
...
**9th Level:** The weapon's extra psychic damage increases to 3, or to 6 if the target is [winded](../health/winded.md). Additionally, you gain an [edge](../dice/edge.md) on any ability using the weapon against a [winded](../health/winded.md) target.
...
**[Item Prerequisite](../downtime/item-prerequisite.md):** Eight iron bars cooled in a glacier, the branch of an ancient evergreen
...
**1st Level:** Any weapon ability that deals [rolled damage](../damage/rolled-damage.md) using this weapon deals an extra 1 cold damage. Additionally, you can use a maneuver to create an ice field in a 3 [burst](../combat/burst.md). The ground in this area is [difficult terrain](../../movement/difficult-terrain.md) for enemies, and lasts until the end of the encounter or when you use this ability again.

**5th Level:** The weapon's extra cold damage increases to 2, and the ice field becomes a 4 [burst](../combat/burst.md). Additionally, whenever you use a weapon ability using this weapon against one or more enemies in the ice field, you gain 1 [surge](../resource/surge.md) that you can use immediately.

**9th Level:** The weapon's extra cold damage increases to 3, and the ice field becomes a 5 [burst](../combat/burst.md). Additionally, any enemy in the ice field who is reduced to 0 [Stamina](../health/stamina.md) by an ability using the weapon can be shattered, killing them and dealing 15 cold damage to each enemy within 3 squares of them.
...
**[Item Prerequisite](../downtime/item-prerequisite.md):** Eighteen daggers—nine taken from personal enemies and nine gifted by friends
...
**1st Level:** Any weapon ability that deals [rolled damage](../damage/rolled-damage.md) using this weapon deals an extra 1 psychic damage. This extra damage increases by 1 each time you deal [rolled damage](../damage/rolled-damage.md) using the weapon to the same target during the same encounter (to a maximum of 3).
...
**[Item Prerequisite](../downtime/item-prerequisite.md):** Night-blooming flower petals, a starmetal meteorite
...
**[Item Prerequisite](../downtime/item-prerequisite.md):** Four iron bars coated in magma slag
...
**1st Level:** Any weapon ability that deals [rolled damage](../damage/rolled-damage.md) using this weapon deals an extra 1 fire damage. Additionally, whenever you make a [strike](../combat/strike.md) using the net and obtain a tier 3 outcome, you can automatically grab the target. A target [grabbed](../../condition/grabbed.md) in this way takes a [bane](../dice/bane.md) when using the [Escape Grab](../../feature/common/maneuvers/escape-grab.md) maneuver.

**5th Level:** The weapon's extra fire damage increases to 2. Additionally, a target [grabbed](../../condition/grabbed.md) by a [strike](../combat/strike.md) using the net takes 8 fire damage each time they attempt to escape using the [Escape Grab](../../feature/common/maneuvers/escape-grab.md) maneuver.
...
**[Item Prerequisite](../downtime/item-prerequisite.md):** A venom sac from a giant spider, one valok gyroscope

**[Project Source](../downtime/project-source.md):** Texts or lore in Caelian and Variac
...
**[Item Prerequisite](../downtime/item-prerequisite.md):** One hundred steel arrowheads stained with blood

**[Project Source](../downtime/project-source.md):** Texts or lore in Caelian and Kalliak
...
**[Item Prerequisite](../downtime/item-prerequisite.md):** Heart strings of a tapir, a pound of tiger's eye gemstones
...
**[Item Prerequisite](../downtime/item-prerequisite.md):** A jar of captured thunder, two ingots of moon metal
...
**[Item Prerequisite](../downtime/item-prerequisite.md):** A folded metal blade infused with blood
...
In addition to armor, shields, [implements](implement.md), and weapons, heroes can make use of a wide range of [magic and psionic treasures](../../chapter/treasures.md). This section presents other types of [leveled treasures](leveled-treasure.md) in alphabetical order.
...
**[Item Prerequisite](../downtime/item-prerequisite.md):** A pair of obituaries that each mention the subject of the other
...
**[Item Prerequisite](../downtime/item-prerequisite.md):** One cotton bolt soaked in the blood of six adventurers

**[Project Source](../downtime/project-source.md):** Texts or lore in Caelian

**[Project Roll](../downtime/project-roll.md) [Characteristic](../character/characteristic.md):** [Might](../character/might.md), [Agility](../character/agility.md), or [Intuition](../character/intuition.md)
...
*Sparks strike from these boots whenever they touch the ground, increasing in number as the wearer gathers [speed](../character/speed.md).*

**Keywords:** Feet, Magic

**[Item Prerequisite](../downtime/item-prerequisite.md):** One jar of lightning
...
**[Item Prerequisite](../downtime/item-prerequisite.md):** A cloak worn by a murdered monarch
...
**[Item Prerequisite](../downtime/item-prerequisite.md):** A pound of feathers, a pound of bricks from the Seven Cities of Hell

**[Project Source](../downtime/project-source.md):** Texts or lore in Anjali

**[Project Roll](../downtime/project-roll.md) [Characteristic](../character/characteristic.md):** [Might](../character/might.md), [Reason](../character/reason.md), or [Presence](../character/presence.md)
