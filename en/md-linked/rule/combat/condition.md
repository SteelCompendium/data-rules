...
A creature can release a creature they have [grabbed](../../condition/grabbed.md) at any time to end that condition (no action required). A [grabbed](../../condition/grabbed.md) creature can attempt to escape being [grabbed](../../condition/grabbed.md) using the [Escape Grab](../../feature/common/maneuvers/escape-grab.md) maneuver (see Chapter 10: [Combat](../../chapter/combat.md)). If a [grabbed](../../condition/grabbed.md) creature [teleports](../../movement/teleport.md), or if either the [grabbed](../../condition/grabbed.md) creature or the creature grabbing them is [force moved](../../movement/forced-movement.md) so that both creatures are not adjacent to each other, that creature is no longer [grabbed](../../condition/grabbed.md).
