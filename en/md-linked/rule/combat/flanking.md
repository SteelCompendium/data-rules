...
You must have [line of effect](line-of-effect.md) to the enemy and be able to take [triggered actions](triggered-action.md) to gain or grant the flanking benefit.
