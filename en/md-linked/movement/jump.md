...
You can't jump farther or higher than the distance of the effect that allows you to move. You can't jump out of [difficult terrain](difficult-terrain.md) or [damaging terrain](damaging-terrain.md) (see below).
