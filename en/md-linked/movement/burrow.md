...
If you are on the ground, you have line of effect to a [burrowing](burrow.md) creature if that creature occupies 1 or more squares of terrain that can be burrowed through and that touch the ground, and if you have line of effect to any of those squares. The [burrowing](burrow.md) creature gains the benefit of cover from you.

If you are completely beneath the ground while [burrowing](burrow.md), you don't have line of effect to any creature on the surface unless a rule states otherwise.

If you are completely beneath the ground while [burrowing](burrow.md) and are adjacent to another creature who is [burrowing](burrow.md), you have line of effect to that creature, though you both have cover from each other.
