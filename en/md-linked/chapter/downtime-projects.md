...
The language with which project sources are set down or can be shared is chosen by the Director. The sample projects below have suggestions using languages in Orden (see that section in Chapter 4: [Background](background.md)), though you might be able to find a version of a source in other languages as well.
...
Since project rolls don't use success tiers, they don't follow the usual rules for double [edges](../rule/dice/edge.md) and double [banes](../rule/dice/bane.md). If you gain an [edge](../rule/dice/edge.md) on a project roll, you add 2 to the roll, as usual. But if you have a double [edge](../rule/dice/edge.md), you add 4 to the roll. Likewise, you subtract 2 from a project roll that takes a [bane](../rule/dice/bane.md), and you subtract 4 from a roll that has a double [bane](../rule/dice/bane.md).
...
Time spent traveling between locations on the road is cut in half. Access to resources and knowledge is improved in locations along the road, giving you and your allies an [edge](../rule/dice/edge.md) on project rolls to discover lore while you are in those areas.
...
You can craft the items found in Treasures in Chapter 13: [Rewards](rewards.md). Each treasure notes its item prerequisite, project source, project roll [characteristic](../rule/character/characteristic.md), and project goal.
...
**Magic Resistance I:** Your [characteristic](../rule/character/characteristic.md) scores are treated as 1 higher (to a maximum of 2) for the purpose of resisting the potencies of magic abilities.
...
**Psionic Resistance I:** Your [characteristic](../rule/character/characteristic.md) scores are treated as 1 higher (to a maximum of 2) for the purpose of resisting the potencies of psionic abilities.
...
| [Damage Immunity](../rule/damage/damage-immunity.md) I    | Elemental sand left behind when an elemental enters Orden from Quintessence                      | Zaliac                  |
...
You can use an absorbed ability as if you knew it, making power rolls for the ability using your choice of [Reason](../rule/character/reason.md), [Intuition](../rule/character/intuition.md), or [Presence](../rule/character/presence.md). You don't need to spend any [Heroic Resource](../rule/resource/heroic-resource.md) to activate the ability. Once you use the ability, the armor loses it, and you can absorb another.
...
**Dragon Soul:** When another creature causes you to be [winded](../rule/health/winded.md) or [dying](../rule/health/dying.md), you can use a free triggered action to cause the soul of a dragon to emerge from this armor and hurtle toward the creature. Make the following power roll against the creature.
...
**Magic Resistance II:** Your [characteristic](../rule/character/characteristic.md) scores are treated as 2 higher (to a maximum of 3) for the purpose of resisting the potencies of magic abilities. This benefit replaces Magic Resistance I.

**Phasing II:** When you use the armor's Phasing I enhancement, you can move through 3 squares of solid matter per turn.

**Psionic Resistance II:** Your [characteristic](../rule/character/characteristic.md) scores are treated as 2 higher (to a maximum of 3) for the purpose of resisting the potencies of psionic abilities. This benefit replaces Psionic Resistance I.
...
**Second Wind:** Whenever you become [winded](../rule/health/winded.md), you can use a free triggered action to spend a [Recovery](../rule/health/recoveries.md).
...
**Rat Form:** As a maneuver, you transform into a rat. Your equipment transforms with you. As a rat, you have speed 5 and can automatically climb at full speed while moving, your [size](../rule/character/size.md) is 1T, and you can see in the dark. You can speak and keep your skills while in rat form, but your [Might](../rule/character/might.md) is −5 and you lose all your regular abilities, features, and benefits. You can revert to your natural form as a maneuver, and do so automatically if you take any damage.
...
**Celerity:** Immediately after using a magic or psionic ability that requires a main action, you can [shift](../movement/shifting.md) up to 3 squares, or you can use the [Escape Grab](../feature/common/maneuvers/escape-grab.md) maneuver as a free maneuver (see Maneuvers in Chapter 10: [Combat](combat.md)).
...
**Displacing II:** When you use the implement's Displacing I enhancement, you can [teleport](../movement/teleport.md) the creature up to 4 squares. Additionally, the creature takes a [bane](../rule/dice/bane.md) on their next power roll made before the end of their next turn.
...
**Warding II:** The [Stamina](../rule/health/stamina.md) bonus for the Warding I enhancement becomes +12. Additionally, your [characteristic](../rule/character/characteristic.md) scores are treated as 1 higher for the purpose of resisting potencies.
...
**Displacing III:** When you use the implement's Displacing I enhancement, you can [teleport](../movement/teleport.md) the creature up to 5 squares. Additionally, the creature takes a [bane](../rule/dice/bane.md) on their next power roll made before the end of their next turn.
...
**Warding III:** The [Stamina](../rule/health/stamina.md) bonus for the Warding I enhancement becomes +18. Additionally, you and each ally within 3 squares of you has their [characteristic](../rule/character/characteristic.md) scores treated as 1 higher for the purpose of resisting potencies. This replaces the benefit of Warding II.
...
| 17-18  | The project source is cursed. Before the roll, the hero must succeed on a hard [Intuition](../rule/character/intuition.md) test or become obsessed with the project. Until the project is complete, the hero can't use Victories to increase their [Heroic Resource](../rule/resource/heroic-resource.md). The curse can be broken by slaying the creature who bestowed it, or by finding a priest to perform a holy ritual over the project source.                                                                                                                                     |
...
| 29-30  | After the roll, the project draws the attention of a [devil](../ancestry/devil.md), who tries to subtly change the project source from the Seven Cities of Hell. If the hero doesn't notice, the [devil](../ancestry/devil.md) is summoned the next time the hero makes a project roll, with goals of the Director's determination.                                                                                                                                                                                                                             |
...
| 65-66  | After the roll, a physical project source or a component of the project creates an unstable portal to another world related to the nature of the project. Tiny [devils](../ancestry/devil.md), elementals, or other creatures start clawing their way out of the item and causing mischief.                                                                                                                                                                                                                                             |
...
| 2   | After the roll, the hero is hurt on the job. They end the respite with 1 fewer [Recoveries](../rule/health/recoveries.md) than usual.                                                                                                                                                                                                                                                                                                                 |
...
| 9   | Before the roll, the hero stumbles upon an old memento from when they worked their former career. They can choose between gaining an automatic breakthrough on the project roll or gaining a [hero token](../rule/resource/hero-token.md).                                                                                                                                                                                                              |
...
**Project Roll [Characteristic](../rule/character/characteristic.md):** [Intuition](../rule/character/intuition.md)

**Project Goal:** 240 if your career granted you two skills, or 360 if your career granted you three skills

You revisit your previous life to freshen up on the experience it provided you. When this project is complete, you gain an [edge](../rule/dice/edge.md) on tests made using the skills provided by your career.
...
| 4   | Before the roll, the master requires the hero's aid with manual labor before their training can begin. The hero must spend this respite completing that labor, earning a [hero token](../rule/resource/hero-token.md) for their efforts instead of making a project roll.                                                                                                                         |
| 5   | Before the roll, the hero must undertake the master's grueling training regimen. The hero rolls an additional d10 for the project roll during this respite, but at the end of the respite, they regain 1 fewer [Recoveries](../rule/health/recoveries.md) than usual.                                                                                                                           |
...
You gain one signature ability of your choice from the master's class (gaining a second signature ability if the master is of the same class as you). If the master is a [tactician](../class/tactician.md), you can gain the [Strike Now](../feature/ability/tactician/level-1/strike-now.md) ability instead. You can't gain this benefit again for the same class.
...
You learn to use one of your heroic abilities more efficiently, reducing its baseline [Heroic Resource](../rule/resource/heroic-resource.md) cost by 1 (to a minimum of 1). An ability can only be improved this way once.
...
**Project Roll [Characteristic](../rule/character/characteristic.md):** Varies
...
While undertaking this project, you provide help to people in need, doing odd jobs, tutoring life skills, cleaning streets or public spaces, finding lost valuables, and the like. The Director determines the [characteristic](../rule/character/characteristic.md) that applies to the project roll based on the activities you undertake. When you complete this project, you receive a random consumable treasure of the Director's choice from someone in the community as thanks for your hard work.
...
| 7   | After the roll, a saint blesses the hero's work. The hero feels supernaturally rejuvenated, increasing their [Recoveries](../rule/health/recoveries.md) by 1 until the end of their next respite. If the character is a [conduit](../class/conduit.md), they also gain an automatic breakthrough on the project.                                                                                                                                                                        |
| 8   | Before the roll, the hero becomes aware of a previously unknown radenwight warren within the community, which has the potential to become a point of tension and conflict. The hero must engage with the radenwights and other locals to create understanding between the two communities or take a [bane](../rule/dice/bane.md) on the project roll.                                                                                                    |
...
| 2   | While fishing, the hero reels in a note in a bottle. The note is written in Anjali and binds the reader into a deal with a powerful [devil](../ancestry/devil.md) if read out loud. This gives the [devil](../ancestry/devil.md) ownership of the reader's soul in exchange for rolling an additional d10 on all future Fishing project rolls.                                                                                                                                                                                                                                                                                                                                                                                                                                                                                          |
...
| 6   | While fishing, the hero is energized by fond memories of their life up to that point. They gain an [edge](../rule/dice/edge.md) on [Presence](../rule/character/presence.md) tests until the end of their next respite.                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                          |
...
You revitalize your spirit by spending time with people you love who you haven't seen in a long while. You must be able to communicate with those people to undertake this project or make project rolls for it. When you complete this project, your [Stamina](../rule/health/stamina.md) maximum increases by 12 + your level until the end of your next respite, and you can't start another Spend Time With Loved Ones project for a month.
