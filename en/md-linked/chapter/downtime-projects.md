...
**Celerity:** Immediately after using a magic or psionic ability that requires a main action, you can [shift](../movement/shifting.md) up to 3 squares, or you can use the [Escape Grab](../feature/trait/common/maneuvers/escape-grab.md) maneuver as a free maneuver (see Maneuvers in Chapter 10: [Combat](combat.md)).
...
| 7   | After the roll, a saint blesses the hero's work. The hero feels supernaturally rejuvenated, increasing their Recoveries by 1 until the end of their next respite. If the character is a [conduit](../class/conduit.md), they also gain an automatic breakthrough on the project.                                                                                                                                                                        |
