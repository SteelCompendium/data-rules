...
Virtue is its own reward... but wouldn't a magic sword also be kind of nice? As heroes adventure, they find and craft treasures even as they are awarded titles, earn [renown](../rule/resource/renown.md), attract [followers](../rule/general/follower.md), and amass wealth. This chapter presents all the various rewards a hero can earn during their career! As you read over the rewards within, make note of the treasures and titles your hero would like to earn. Then you can start pursuing them during your adventures.
...
Consumables are treasures that can be used a limited number of times before they expire, losing whatever makes them [supernatural](../rule/general/supernatural.md). You can drink a potion once, and when you do so, that's it. It's consumed. Other consumables might have a specific number of charges that can be spent. Once those charges are gone, the treasure is useless.

Consumables are organized by [echelon](../rule/general/echelon.md) to make life easy for the Director handing them out (see [Echelons](../rule/general/echelon.md) of Play in Chapter 1: [The Basics](the-basics.md)). As a [guide](../rule/downtime/guide.md)line, a hero should always be able to find consumable treasures or the materials required to craft consumables of their [echelon](../rule/general/echelon.md) and lower. For example, heroes who are 5th level should be able to find consumables of 1st and 2nd [echelon](../rule/general/echelon.md). In some cases, the Director might decide to award consumables of an [echelon](../rule/general/echelon.md) higher than the heroes' [echelon](../rule/general/echelon.md), but such a choice means giving the heroes more power than the encounter-building [guide](../rule/downtime/guide.md)lines in *Draw Steel: Monsters* accounts for.
...
>
> [Recoveries](../rule/health/recoveries.md), [respites](../rule/resource/respite.md), [Victories](../rule/resource/victories.md): Chapter 1: [The Basics](the-basics.md)
>
> Languages: Chapter 4: [Background](background.md)
>
> Abilities, [conditions](../rule/combat/condition.md), [potencies](../rule/character/potency.md), [surges](../rule/resource/surge.md): Chapter 5: [Classes](classes.md)
>
> Skills, [tests](../rule/test/test.md): Chapter 9: [Tests](tests.md)
>
> Item creation rules, crafting and [research projects](../rule/downtime/research-project.md): Chapter 12: [Downtime Projects](downtime-projects.md)
>
> Main actions and maneuvers, creature [size](../rule/character/size.md), damage and [Stamina](../rule/health/stamina.md), [dying](../rule/health/dying.md) and death, movement and [forced movement](../movement/forced-movement.md), [winded](../rule/health/winded.md): Chapter 10: [Combat](combat.md)
>
...
This section presents 1st-[echelon](../rule/general/echelon.md) [consumable](../rule/treasure/consumable.md) treasures in alphabetical order.
...
**[Item Prerequisite](../rule/downtime/item-prerequisite.md):** Three vials of black ash from the College of Black Ash

**[Project Source](../rule/downtime/project-source.md):** Texts or lore in Szetch
...
**[Item Prerequisite](../rule/downtime/item-prerequisite.md):** A ruby purloined from a vampire

**[Project Source](../rule/downtime/project-source.md):** Texts or lore in Proto-Ctholl

**[Project Roll](../rule/downtime/project-roll.md) [Characteristic](../rule/character/characteristic.md):** [Agility](../rule/character/agility.md) or [Reason](../rule/character/reason.md)
...
**[Item Prerequisite](../rule/downtime/item-prerequisite.md):** An ounce of witherite crystal
...
**[Item Prerequisite](../rule/downtime/item-prerequisite.md):** One vial of fire giant blood
...
**[Item Prerequisite](../rule/downtime/item-prerequisite.md):** One imp's tongue
...
- **17+:** You can affect up to seven additional targets with this [strike](../rule/combat/strike.md).
...
**[Item Prerequisite](../rule/downtime/item-prerequisite.md):** Three sheets of glass, sunbaked gold dust
...
**[Item Prerequisite](../rule/downtime/item-prerequisite.md):** A strip of starmetal coated in the blood of the item's crafter
...
**Effect:** When activated as a maneuver, this item erupts in a bright flash, you can [shift](../movement/shifting.md) 1 square without your enemies noticing your movement, and a homunculus perfectly resembling you appears in an [adjacent](../rule/combat/adjacent.md) space. The homunculus is a creature with [Stamina](../rule/health/stamina.md) 15, a 0 in all their [characteristics](../rule/character/characteristic.md), and a [speed](../rule/character/speed.md) and [stability](../rule/character/stability.md) equal to yours. They appear indistinguishable from you but can't use any abilities.

While you have [line of effect](../rule/combat/line-of-effect.md) to your homunculus, you can use a maneuver to issue them a telepathic command. The homunculus performs the command to the best of their ability. If not commanded, the homunculus mimics your movements and speech. When you move, the homunculus moves with you, matching your pace. The homunculus crumbles to dust after 1 hour or if reduced to 0 [Stamina](../rule/health/stamina.md).
...
**[Item Prerequisite](../rule/downtime/item-prerequisite.md):** The roots of a just-budded nightshade
...
**Effect:** As a maneuver, you sprinkle a dose of this powder onto food or drink, or blow it at an [adjacent](../rule/combat/adjacent.md) creature who is [grabbed](../condition/grabbed.md), [restrained](../condition/restrained.md), or unconscious. A creature who is exposed to blown powder (even if they hold their breath) or consumes a dose of the powder must communicate in only true statements for 1 hour. Additionally, other creatures gain an [edge](../rule/dice/edge.md) on [Intuition](../rule/character/intuition.md) and [Presence](../rule/character/presence.md) [tests](../rule/test/test.md) made to convince the target to communicate, or to read the target's emotions. Any such creature has a double [edge](../rule/dice/edge.md) on the [test](../rule/test/test.md) if the target doesn't realize they've been affected by the snuff.
...
This section presents 2nd-[echelon](../rule/general/echelon.md) [consumable](../rule/treasure/consumable.md) treasures in alphabetical order.
...
**[Item Prerequisite](../rule/downtime/item-prerequisite.md):** One vial of pure bovine essence
...
**[Item Prerequisite](../rule/downtime/item-prerequisite.md):** An ounce of sap from a tree damaged by psionic fire
...
**[Item Prerequisite](../rule/downtime/item-prerequisite.md):** A sheet of paper infused with the dust of a painite

**[Project Source](../rule/downtime/project-source.md):** Texts or lore in the First Language
...
**[Item Prerequisite](../rule/downtime/item-prerequisite.md):** A shard of prismacore, an ounce of ferrous metal
...
**[Item Prerequisite](../rule/downtime/item-prerequisite.md):** A signed agreement with a ghost, a large obsidian disk
...
This section presents 3rd-[echelon](../rule/general/echelon.md) [consumable](../rule/treasure/consumable.md) treasures in alphabetical order.
...
**[Item Prerequisite](../rule/downtime/item-prerequisite.md):** A grub steeped in voiceless talker bile
...
**[Item Prerequisite](../rule/downtime/item-prerequisite.md):** A month's lifespan from the creator or another willing creature, ground sapphire
...
**[Item Prerequisite](../rule/downtime/item-prerequisite.md):** One vial of archdevil's blood, an expired contract
...
**[Item Prerequisite](../rule/downtime/item-prerequisite.md):** A time crystal
...
This section presents 4th-[echelon](../rule/general/echelon.md) [consumable](../rule/treasure/consumable.md) treasures in alphabetical order.
...
**[Item Prerequisite](../rule/downtime/item-prerequisite.md):** The captured breath of a god, an ounce of condensed dreams
...
**[Item Prerequisite](../rule/downtime/item-prerequisite.md):** A year's lifespan from the creator or another willing creature, the laughter of a young hero
...
Trinkets are treasures that can be used at will without a reduction in their [potency](../rule/character/potency.md). They generally provide a small benefit, such as allowing you to see farther or become a bit better at picking locks.

Like [consumables](../rule/treasure/consumable.md), trinket treasures are organized by [echelon](../rule/general/echelon.md). You can carry any number of trinkets.

#### 1st-Echelon Trinkets

This section presents 1st-[echelon](../rule/general/echelon.md) [trinket](../rule/treasure/trinket.md) treasures in alphabetical order.
...
**[Item Prerequisite](../rule/downtime/item-prerequisite.md):** A pint of blue ichor, soul chalk

**[Project Source](../rule/downtime/project-source.md):** Licensing agreements in Anjali
...
Additionally, when you are targeted by any effect that deals cold damage, you can use a [triggered action](../rule/combat/triggered-action.md) to [shift](../movement/shifting.md) a number of squares equal to your level. If you do so, the cold immunity granted by the cloak becomes cold weakness with the same value until the end of the next round. You can't use this [triggered action](../rule/combat/triggered-action.md) again until this weakness ends.
...
**[Item Prerequisite](../rule/downtime/item-prerequisite.md):** A pint of red ichor, soul chalk
...
Additionally, when you are targeted by any effect that deals fire damage, you can use a [triggered action](../rule/combat/triggered-action.md) to reduce the damage to 0. If you do so, the fire immunity granted by this cloak becomes fire weakness with the same value until the end of the next round. You can't use this [triggered action](../rule/combat/triggered-action.md) again until this weakness ends.
...
**[Item Prerequisite](../rule/downtime/item-prerequisite.md):** A pint of yellow ichor, soul chalk
...
Additionally, when you are targeted by any effect that deals lightning damage, you can use a [triggered action](../rule/combat/triggered-action.md) to cause the next damage-dealing ability you use to deal extra lightning damage equal to your level. Once you deal this extra damage, your lightning immunity becomes lightning weakness with the same value until the end of the next round. You can't use this [triggered action](../rule/combat/triggered-action.md) again until this weakness ends.

##### Deadweight {data-scc="mcdm.heroes.v1/treasure.1st-echelon.trinket/deadweight"}

*Though this humanoid femur is coated in lead, it feels impossibly heavy for its [size](../rule/character/size.md).*
...
**[Item Prerequisite](../rule/downtime/item-prerequisite.md):** Petrified wood from a tree that has not been observed since falling
...
**Effect:** As a maneuver, you transfer an object of [size](../rule/character/size.md) 1S or 1T held in one hand with another object of the same [size](../rule/character/size.md) that is within 10 squares. The objects change locations instantaneously and without creating any auditory or visual disturbance. If another creature is wearing or holding the object you transfer to your hand and they have I < 4, they fail to notice the transfer.
...
**[Item Prerequisite](../rule/downtime/item-prerequisite.md):** A humanoid's shadow disconnected from its source
...
If the object is too thick or has no open space on the other side, your hand becomes stuck inside the object. Removing your hand takes a successful hard [Might](../rule/character/might.md) [test](../rule/test/test.md) made as a main action.
...
**[Item Prerequisite](../rule/downtime/item-prerequisite.md):** One broken contract, one ingot of steel

**[Project Source](../rule/downtime/project-source.md):** Texts or lore in Anjali and Caelian

**[Project Roll](../rule/downtime/project-roll.md) [Characteristic](../rule/character/characteristic.md):** [Might](../rule/character/might.md) or [Reason](../rule/character/reason.md)
...
**[Item Prerequisite](../rule/downtime/item-prerequisite.md):** One uncut opal
...
**[Item Prerequisite](../rule/downtime/item-prerequisite.md):** One battered gold chain of at least fifty links
...
This section presents 2nd-[echelon](../rule/general/echelon.md) [trinket](../rule/treasure/trinket.md) treasures in alphabetical order.
...
**[Item Prerequisite](../rule/downtime/item-prerequisite.md):** An eyeball from a pirate captain who drowned at sea
...
**[Item Prerequisite](../rule/downtime/item-prerequisite.md):** One measure of pure crystal, a jarred memory of true joy
...
**Effect:** While wearing the crown, you gain an [edge](../rule/dice/edge.md) on [Intuition](../rule/character/intuition.md) [tests](../rule/test/test.md) made to read the emotions and discern the honesty of other creatures. If you succeed on an [Intuition](../rule/character/intuition.md) [test](../rule/test/test.md) to read the emotions of another creature within 5 squares, you can ask the Director one question about something the creature knows, which the Director must answer honestly. At the Director's discretion, you might not be able to tap into the creature's deepest secrets this way.
...
**[Item Prerequisite](../rule/downtime/item-prerequisite.md):** The gold nib of a fountain pen used to sign a major treaty or compact, a ruby once worn by a [devil](../ancestry/devil.md)
...
**[Item Prerequisite](../rule/downtime/item-prerequisite.md):** A coin minted during an earthquake
...
- **1-Red:** The area within 2 squares of you is [difficult terrain](../movement/difficult-terrain.md) for enemies until the end of your next [turn](../rule/combat/turn.md).
- **2-Green:** You and each ally who starts their [turn](../rule/combat/turn.md) within 2 squares of you gains a +1 [bonus](../rule/dice/bonuses-and-penalties.md) to [speed](../rule/character/speed.md) until the end of your next [turn](../rule/combat/turn.md).
...
This section presents 3rd-[echelon](../rule/general/echelon.md) [trinket](../rule/treasure/trinket.md) treasures in alphabetical order.
...
**[Item Prerequisite](../rule/downtime/item-prerequisite.md):** An overmind egg, the skin of any shapeshifter
...
>
> **Effect:** While [slowed](../condition/slowed.md) in this way, the target takes a [bane](../rule/dice/bane.md) on magic or psionic abilities.
...
**[Item Prerequisite](../rule/downtime/item-prerequisite.md):** One-third of a pound of diamond dust, one nugget of pure silver
...
This section presents 4th-[echelon](../rule/general/echelon.md) [trinket](../rule/treasure/trinket.md) treasures in alphabetical order.
...
**[Item Prerequisite](../rule/downtime/item-prerequisite.md):** The powdered jawbone of a powerful spellcaster, wood from a tree marking multiple graves
...
**[Item Prerequisite](../rule/downtime/item-prerequisite.md):** Steel alloy, one fine-cut topaz
...
Like [trinkets](../rule/treasure/trinket.md), leveled treasures can be used at will without a reduction in [potency](../rule/character/potency.md). However, leveled treasures tap into their wielder's will in a way that [trinkets](../rule/treasure/trinket.md) don't, becoming more powerful and increasing their capabilities as you gain new levels.

#### Leveled Benefits

Each [leveled treasure](../rule/treasure/leveled-treasure.md) has benefits that you gain at 1st, 5th, and 9th levels. You can't use a treasure's benefit until you achieve the appropriate benefits level. [Leveled benefits](treasures.md) are cumulative.

#### Carry Three Safely

Your connection with [leveled treasures](../rule/treasure/leveled-treasure.md) doesn't just make them useful. It also makes them dangerous. Each [leveled treasure](../rule/treasure/leveled-treasure.md) is a quasi-sentient, purpose-driven entity. A magic sword wishes to be used in combat. A psionic [implement](../rule/treasure/implement.md) yearns to unleash its powerful magic. As such, a creature can safely carry a maximum of three [leveled treasures](../rule/treasure/leveled-treasure.md) at a time. If you carry more [leveled treasures](../rule/treasure/leveled-treasure.md), those items become jealous of one another and fight for your attention, attempting to subconsciously influence you into using them—and leaving your other items behind.

It's fine to own or possess more than three [leveled treasures](../rule/treasure/leveled-treasure.md), as long as the extras are stored away or in the possession of other creatures. But if you carry more than three [leveled treasures](../rule/treasure/leveled-treasure.md), you must make a [Presence](../rule/character/presence.md) [test](../rule/test/test.md) during each [respite](../rule/resource/respite.md):

- **≤11:** One of your [leveled treasures](../rule/treasure/leveled-treasure.md) (chosen by the Director) grabs hold of your psyche. It forces you to sleepwalk or otherwise enter an active fugue state and discard the rest of your [leveled treasures](../rule/treasure/leveled-treasure.md) in locations you can't remember. If you want those items back, you'd better get looking before someone else finds them.
...
>
> Because you can carry up to three [leveled treasures](../rule/treasure/leveled-treasure.md) safely, it's easy to assume that your hero should always seek out and carry three such treasures. The truth is that many heroes find carrying just one or two [leveled treasures](../rule/treasure/leveled-treasure.md) a perfect thematic and mechanical fit, and have no real need for more. That's totally fine! You'll still be super powerful with just one [leveled treasure](../rule/treasure/leveled-treasure.md), especially if you obtain or craft [trinkets](../rule/treasure/trinket.md) and [consumables](../rule/treasure/consumable.md) that might serve you better.
...
**1st Level:** While you wear this armor, you gain a +6 [bonus](../rule/dice/bonuses-and-penalties.md) to [Stamina](../rule/health/stamina.md), and you have immunity to acid and poison damage equal to your highest [characteristic](../rule/character/characteristic.md) score.

**5th Level:** The armor's [bonus](../rule/dice/bonuses-and-penalties.md) to [Stamina](../rule/health/stamina.md) increases to +12. Additionally, whenever an [adjacent](../rule/combat/adjacent.md) creature deals damage to you, they take 3 acid or poison damage (your choice).

**9th Level:** The armor's [bonus](../rule/dice/bonuses-and-penalties.md) to [Stamina](../rule/health/stamina.md) increases to +21, and an [adjacent](../rule/combat/adjacent.md) creature who deals damage to you takes 6 acid or poison damage. Additionally, you can use a maneuver to transmute a 2-[cube](../rule/combat/cube.md) area of liquid or gas [adjacent](../rule/combat/adjacent.md) to you into liquid acid or poison gas until the start of your next [turn](../rule/combat/turn.md). Any creature who enters the area for the first time in a [combat round](../rule/combat/combat-round.md) or starts their turn there takes 6 acid or poison damage, as appropriate.
...
**[Item Prerequisite](../rule/downtime/item-prerequisite.md):** A set of wings from a [flying](../movement/fly.md) carp, a set of chain mail rusted by seawater
...
**1st Level:** While you wear this armor, you gain a +6 [bonus](../rule/dice/bonuses-and-penalties.md) to [Stamina](../rule/health/stamina.md), you can automatically swim at full [speed](../rule/character/speed.md) while moving, and you can breathe underwater for up to 1 hour. Returning to the surface to breathe air again for any length of time reset's the armor's water-breathing benefit.

**5th Level:** The armor's [bonus](../rule/dice/bonuses-and-penalties.md) to [Stamina](../rule/health/stamina.md) increases to +12, and you have cold immunity 5. Additionally, whenever you fall, you can extend your arms (no action required) to unfurl a thick membrane between your arms and your body, slowing your fall and allowing you to glide. While gliding this way, you move downward at 1 square per round, and you can glide up to 6 squares horizontally as a [free maneuver](../rule/combat/free-maneuver.md) once during each of your [turns](../rule/combat/turn.md).

**9th Level:** The armor's [bonus](../rule/dice/bonuses-and-penalties.md) to [Stamina](../rule/health/stamina.md) increases to +21, and you have cold immunity 10. Additionally, whenever your feet are not touching the ground (including floating in water or being in midair), you gain an [edge](../rule/dice/edge.md) on [ability rolls](../rule/dice/ability-roll.md), and any ability takes a [bane](../rule/dice/bane.md) when targeting you.
...
**[Item Prerequisite](../rule/downtime/item-prerequisite.md):** The eyes of a [time raider](../ancestry/time-raider.md) who died valiantly in battle
...
**1st Level:** You gain a +6 [bonus](../rule/dice/bonuses-and-penalties.md) to [Stamina](../rule/health/stamina.md) while you wear this armor. Additionally, whenever a creature within 5 squares deals damage to you, you can use a [triggered action](../rule/combat/triggered-action.md) to capture a moment of time in the armor, making that creature [slowed](../condition/slowed.md) until the end of their next [turn](../rule/combat/turn.md).

**5th Level:** The armor's [bonus](../rule/dice/bonuses-and-penalties.md) to [Stamina](../rule/health/stamina.md) increases to +12. Additionally, when you capture a moment of time in the armor, the triggering creature also takes corruption damage equal to twice your highest [characteristic](../rule/character/characteristic.md) score.

**9th Level:** The armor's [bonus](../rule/dice/bonuses-and-penalties.md) to [Stamina](../rule/health/stamina.md) increases to +21. Additionally, whenever you capture a moment of time in the armor, you can immediately release it to gain a +3 [bonus](../rule/dice/bonuses-and-penalties.md) to [speed](../rule/character/speed.md) that lasts until the end of your next [turn](../rule/combat/turn.md).
...
**5th Level:** The armor's [bonus](../rule/dice/bonuses-and-penalties.md) to [Stamina](../rule/health/stamina.md) increases to +12, and when you return to your true form, you are [dazed](../condition/dazed.md) only until the end of your next [turn](../rule/combat/turn.md). Additionally, while you are paper thin, you can use a maneuver to wrap yourself around an [adjacent](../rule/combat/adjacent.md) target who is the same [size](../rule/character/size.md) or smaller than you, automatically grabbing them.

**9th Level:** The armor's [bonus](../rule/dice/bonuses-and-penalties.md) to [Stamina](../rule/health/stamina.md) increases to +21, and you are no longer [dazed](../condition/dazed.md) when you return to your true form. Additionally, while you have a target [grabbed](../condition/grabbed.md) when you are paper thin, you can use a maneuver to constrict the target, dealing 10 damage to them. A creature damaged this way takes a [bane](../rule/dice/bane.md) when using the [Escape Grab](../feature/common/maneuvers/escape-grab.md) maneuver against you and when making [strikes](../rule/combat/strike.md) against you.
...
**[Item Prerequisite](../rule/downtime/item-prerequisite.md):** The will of a deceased person with no heirs
...
**1st Level:** You gain a +6 [bonus](../rule/dice/bonuses-and-penalties.md) to [Stamina](../rule/health/stamina.md) while you wear this armor. Additionally, you gain an [edge](../rule/dice/edge.md) on [tests](../rule/test/test.md) made to lie about or conceal your identity.

**5th Level:** The armor's [bonus](../rule/dice/bonuses-and-penalties.md) to [Stamina](../rule/health/stamina.md) increases to +12. Additionally, whenever you take damage, you can use a [triggered action](../rule/combat/triggered-action.md) to [teleport](../movement/teleport.md) up to 5 squares. If you do, you create an illusion of you [dying](../rule/health/dying.md) in your previous space, which fades at the end of your next [turn](../rule/combat/turn.md).

**9th Level:** The armor's [bonus](../rule/dice/bonuses-and-penalties.md) to [Stamina](../rule/health/stamina.md) increases to +21. Whenever you use the armor's [triggered action](../rule/combat/triggered-action.md) to [teleport](../movement/teleport.md), you can [teleport](../movement/teleport.md) up to a number of squares equal to the damage taken (minimum 5 squares). Additionally, if a creature dealt you the triggering damage, you become invisible to that creature until the end of your next [turn](../rule/combat/turn.md).
...
**5th Level:** The armor's [bonus](../rule/dice/bonuses-and-penalties.md) to [Stamina](../rule/health/stamina.md) increases to +12, and the damage the wall can take before retracting increases to 25. Additionally, while the wall is expanded, spikes extrude from it, and any creature who deals damage to the wall while [adjacent](../rule/combat/adjacent.md) to it takes 3 damage.

**9th Level:** The armor's [bonus](../rule/dice/bonuses-and-penalties.md) to [Stamina](../rule/health/stamina.md) increases to +21. Additionally, spikes cover the armor, and any [adjacent](../rule/combat/adjacent.md) creature who deals damage to you takes 6 damage.
...
**1st Level:** While you wear this armor, you gain a +6 [bonus](../rule/dice/bonuses-and-penalties.md) to [Stamina](../rule/health/stamina.md), but any magic ability gains an [edge](../rule/dice/edge.md) when targeting you. Additionally, you instinctively know the location of any creature with [concealment](../rule/combat/concealment.md) within 2 squares. You can also [turn](../rule/combat/turn.md) invisible as a maneuver. Your invisibility ends if you take damage or use an ability, or at the end of your next [turn](../rule/combat/turn.md).

**5th Level:** The armor's [bonus](../rule/dice/bonuses-and-penalties.md) to [Stamina](../rule/health/stamina.md) increases to +12, you instinctively know the location of any creature with [concealment](../rule/combat/concealment.md) within 5 squares, and your invisibility no longer ends at the end of your next [turn](../rule/combat/turn.md). Additionally, you have psychic immunity 5.

**9th Level:** The armor's [bonus](../rule/dice/bonuses-and-penalties.md) to [Stamina](../rule/health/stamina.md) increases to +21, and you instinctively know the location of any creature with [concealment](../rule/combat/concealment.md) within 10 squares. Your invisibility no longer ends when you use an ability, and you have psychic immunity 10.
...
**[Item Prerequisite](../rule/downtime/item-prerequisite.md):** Three ingots of steel, six crystals that resonate with psionic power
...
**1st Level:** While you wield or carry this shield, you gain a +2 [bonus](../rule/dice/bonuses-and-penalties.md) to [Stamina](../rule/health/stamina.md). This [Stamina](../rule/health/stamina.md) [bonus](../rule/dice/bonuses-and-penalties.md) adds to the [Stamina](../rule/health/stamina.md) [bonus](../rule/dice/bonuses-and-penalties.md) granted by other treasures. Additionally, once per [turn](../rule/combat/turn.md) when an [adjacent](../rule/combat/adjacent.md) enemy uses an ability, you can use a free [triggered action](../rule/combat/triggered-action.md) to use the [Grab](../feature/common/maneuvers/grab.md) maneuver against that enemy. You can have any number of enemies [grabbed](../condition/grabbed.md) in this way.
...
[Implements](../rule/treasure/implement.md) are pieces of jewelry, orbs, staffs, tomes, wands, and other objects used by magic and psionic heroes to focus their power. This section presents [leveled implement treasures](treasures.md) in alphabetical order.
...
**Keywords:** [Implement](../rule/treasure/implement.md), Magic

**[Item Prerequisite](../rule/downtime/item-prerequisite.md):** A diamond ring
...
**1st Level:** While you wield this [implement](../rule/treasure/implement.md), your magic or psionic abilities that deal [rolled damage](../rule/damage/rolled-damage.md) gain a +1 damage [bonus](../rule/dice/bonuses-and-penalties.md). Additionally, whenever you deal [rolled damage](../rule/damage/rolled-damage.md) to a creature using a magic or psionic ability, you gain [temporary Stamina](../rule/health/temporary-stamina.md) equal to your highest [characteristic](../rule/character/characteristic.md) score.

**5th Level:** The [implement](../rule/treasure/implement.md)'s damage [bonus](../rule/dice/bonuses-and-penalties.md) increases to +2. Additionally, whenever you deal [rolled damage](../rule/damage/rolled-damage.md) using a magic or psionic ability, you can use a maneuver to create an immobile field of protection that is a 1 [cube](../rule/combat/cube.md), around yourself or around an ally within 5 squares. While in the area, you or the chosen ally has [damage immunity](../rule/damage/damage-immunity.md) 5. The field disappears at the start of your next [turn](../rule/combat/turn.md).

**9th Level:** The [implement](../rule/treasure/implement.md)'s damage [bonus](../rule/dice/bonuses-and-penalties.md) increases to +3. Whenever you deal [rolled damage](../rule/damage/rolled-damage.md) to a creature using a magic or psionic ability, you and each ally within 5 squares of you gains [temporary Stamina](../rule/health/temporary-stamina.md) equal to your highest [characteristic](../rule/character/characteristic.md) score. Additionally, the size of your field of protection increases to a 3 [cube](../rule/combat/cube.md), and it can be placed anywhere within 10 squares of you. You and each ally in the area gain its benefits.
...
**1st Level:** While you wield this [implement](../rule/treasure/implement.md), your magic or psionic abilities that deal [rolled damage](../rule/damage/rolled-damage.md) deal an extra 2 psychic damage. Additionally, you have [damage weakness](../rule/damage/damage-weakness.md) 3, and you gain an [edge](../rule/dice/edge.md) on magic or psionic abilities if you aren't at full [Stamina](../rule/health/stamina.md), or a double [edge](../rule/dice/edge.md) if you are [winded](../rule/health/winded.md).

**5th Level:** The [implement](../rule/treasure/implement.md)'s extra psychic damage increases to 3. Additionally, once per round when you take more than 20 damage from a single source, the [implement](../rule/treasure/implement.md)'s extra damage is doubled until the end of your next [turn](../rule/combat/turn.md).

**9th Level:** The [implement](../rule/treasure/implement.md)'s extra psychic damage increases to 4. Additionally, whenever you use a damage-dealing magic or psionic ability, you can take half as much total damage as is dealt to all targets to immediately use the same ability again. The damage you take can't be reduced in any way. You can't use this benefit more than once a [turn](../rule/combat/turn.md).
...
**[Item Prerequisite](../rule/downtime/item-prerequisite.md):** An ounce of primordial ice, an ounce of mammoth-ivory shards
...
**1st Level:** While you wield this [implement](../rule/treasure/implement.md), your magic or psionic abilities that deal [rolled damage](../rule/damage/rolled-damage.md) gain a +1 damage [bonus](../rule/dice/bonuses-and-penalties.md). Additionally, if you make a magic [strike](../rule/combat/strike.md), the [strike](../rule/combat/strike.md) must deal cold damage instead of its usual damage.

**5th Level:** The [implement](../rule/treasure/implement.md)'s damage [bonus](../rule/dice/bonuses-and-penalties.md) increases to +2. Additionally, whenever you use a magic or psionic ability, a whirlwind of sleet and ice whips around you, dealing 3 cold damage to each [adjacent](../rule/combat/adjacent.md) enemy.

**9th Level:** The [implement](../rule/treasure/implement.md)'s damage [bonus](../rule/dice/bonuses-and-penalties.md) increases to +3, and the whirlwind you create when you use a magic or psionic ability deals 6 cold damage to each enemy within 2 squares of you. Additionally, the whirlwind creates a 2 [aura](../rule/combat/aura.md) around you that lasts until the start of your next [turn](../rule/combat/turn.md). Each enemy who enters the [aura](../rule/combat/aura.md) for the first time in a [combat round](../rule/combat/combat-round.md) or starts their turn there takes 6 cold damage.
...
**Keywords:** [Implement](../rule/treasure/implement.md), Psionic
...
**9th Level:** The [implement](../rule/treasure/implement.md)'s damage [bonus](../rule/dice/bonuses-and-penalties.md) increases to +3. Additionally, any creature who is insubstantial to you and isn't a leader or solo creature also can't make [opportunity attacks](../rule/combat/opportunity-attack.md) against your allies while they remain insubstantial.
...
**[Item Prerequisite](../rule/downtime/item-prerequisite.md):** Two clear lenses carved from volcanic glass
...
**1st Level:** While you wield this [implement](../rule/treasure/implement.md), your magic or psionic abilities that deal [rolled damage](../rule/damage/rolled-damage.md) gain a +1 damage [bonus](../rule/dice/bonuses-and-penalties.md). Additionally, whenever you deal [rolled damage](../rule/damage/rolled-damage.md) to a creature using a magic or psionic ability, you can use that creature's senses until the end of your next [turn](../rule/combat/turn.md), allowing you to experience all they observe and to use your abilities as if you were in their space. You also benefit from your own senses at the same time.

**5th Level:** The [implement](../rule/treasure/implement.md)'s damage [bonus](../rule/dice/bonuses-and-penalties.md) increases to +2. Additionally, whenever you deal 20 or more [rolled damage](../rule/damage/rolled-damage.md) with a magic or psionic ability to a creature whose senses you are using, that creature is weakend until the end of their next [turn](../rule/combat/turn.md).

**9th Level:** The [implement](../rule/treasure/implement.md)'s damage [bonus](../rule/dice/bonuses-and-penalties.md) increases to +3. Additionally, whenever you deal 30 or more [rolled damage](../rule/damage/rolled-damage.md) with a magic or psionic ability to a creature whose senses you are using, that creature is [dazed](../condition/dazed.md) until the end of their next [turn](../rule/combat/turn.md).
...
**[Item Prerequisite](../rule/downtime/item-prerequisite.md):** Written permission from a [high elf](../ancestry/high-elf.md) magistrate
...
**1st Level:** You can open or close the tome as a maneuver while speaking or thinking its full name. While the tome is open, it floats in an [adjacent](../rule/combat/adjacent.md) space and flips to specific pages at your command, you gain an [edge](../rule/dice/edge.md) on [Reason](../rule/character/reason.md) [tests](../rule/test/test.md) made to recall lore, and you gain a +3 [bonus](../rule/dice/bonuses-and-penalties.md) to [distance](../rule/combat/distance.md) for your [ranged](../rule/combat/ranged.md) magic or psionic abilities.

**5th Level:** While the tome is open, the [bonus](../rule/dice/bonuses-and-penalties.md) to [distance](../rule/combat/distance.md) for your [ranged](../rule/combat/ranged.md) magic or psionic abilities increases to +5. Additionally, when you or a creature you have [line of effect](../rule/combat/line-of-effect.md) to uses a magic or psionic ability, you can use a [triggered action](../rule/combat/triggered-action.md) to grant a +3 [bonus](../rule/dice/bonuses-and-penalties.md) to the [power roll](../rule/dice/power-roll.md).

**9th Level:** While the tome is open, you automatically obtain a tier 3 outcome on [Reason](../rule/character/reason.md) [tests](../rule/test/test.md) made to recall lore, and when you use a [heroic ability](../rule/general/heroic-ability.md), its [Heroic Resource](../rule/resource/heroic-resource.md) cost is reduced by 1 (to a minimum of 1).
...
**[Item Prerequisite](../rule/downtime/item-prerequisite.md):** A lash used to punish a mutineer
...
**1st Level:** Any weapon ability that deals [rolled damage](../rule/damage/rolled-damage.md) using this weapon gains a +1 damage [bonus](../rule/dice/bonuses-and-penalties.md). Whenever you damage a creature with the weapon, you can immediately use a maneuver to end one effect imposed by that creature on you or another creature within 5 squares of you.

**5th Level:** The weapon's damage [bonus](../rule/dice/bonuses-and-penalties.md) increases to +2. Additionally, you and each ally within 2 squares of you gains a +1 [bonus](../rule/dice/bonuses-and-penalties.md) to [saving throws](../rule/general/saving-throw.md).

**9th Level:** The weapon's damage [bonus](../rule/dice/bonuses-and-penalties.md) increases to +3. Additionally, you no longer need to use a maneuver to end one effect when you damage a creature with the weapon. The weapon also refuses to vie for control of your psyche, and no longer counts against the limit of [leveled treasures](../rule/treasure/leveled-treasure.md) you can carry safely.
...
**[Item Prerequisite](../rule/downtime/item-prerequisite.md):** A ruby hardened in the fires of the City of Brass, a sapphire that has been struck by lightning
...
**1st Level:** Any weapon ability that deals [rolled damage](../rule/damage/rolled-damage.md) using this weapon gains a +1 damage [bonus](../rule/dice/bonuses-and-penalties.md). Additionally, you can change the [damage type](../rule/damage/damage-type.md) of such abilities to cold, fire, lightning, or sonic.

**5th Level:** The weapon's damage [bonus](../rule/dice/bonuses-and-penalties.md) increases to +2. Additionally, the weapon can be used with [ranged](../rule/combat/ranged.md) weapon abilities, and returns to you when a [ranged](../rule/combat/ranged.md) ability is resolved. [Ranged](../rule/combat/ranged.md) abilities used with the weapon increase their [distance](../rule/combat/distance.md) by 3, and must deal cold, fire, lightning, or sonic damage (chosen when you use the ability).

**9th Level:** The weapon's damage [bonus](../rule/dice/bonuses-and-penalties.md) increases to +3. Additionally, while you wield or carry the weapon, you have immunity 10 to cold, fire, lightning, and sonic damage.
...
**1st Level:** Any weapon ability that deals [rolled damage](../rule/damage/rolled-damage.md) using this weapon gains a +1 damage [bonus](../rule/dice/bonuses-and-penalties.md). Additionally, whenever you deal [rolled damage](../rule/damage/rolled-damage.md) with this weapon, you can immediately [shift](../movement/shifting.md) 1 square. As well, while you wield or carry the weapon and are present in a negotiation, if an [NPC](../rule/general/npc.md) in the negotiation has the greed, legacy, power, or revelry motivation, their starting interest increases by 1 (to a maximum of 5).
...
**[Item Prerequisite](../rule/downtime/item-prerequisite.md):** An ancient bronze gear covered in indecipherable runes

**[Project Source](../rule/downtime/project-source.md):** Texts in Zaliac

**[Project Roll](../rule/downtime/project-roll.md) [Characteristic](../rule/character/characteristic.md):** [Might](../rule/character/might.md) or [Intuition](../rule/character/intuition.md)

**Project Goal:** 450

**1st Level:** Any weapon ability that deals [rolled damage](../rule/damage/rolled-damage.md) using this weapon deals an extra 1 psychic damage. Additionally, whenever you deal [rolled damage](../rule/damage/rolled-damage.md) to a creature, you can use a maneuver to [teleport](../movement/teleport.md) you and that creature, letting you trade places provided you both fit into each other's spaces.

**5th Level:** The weapon's extra psychic damage increases to 2. Additionally, whenever you deal [rolled damage](../rule/damage/rolled-damage.md) to a creature, you can use a maneuver to trade places with that creature or any creature within 4 squares of them, provided you both fit into each other's spaces.
...
**[Item Prerequisite](../rule/downtime/item-prerequisite.md):** The skull of a convicted criminal
...
**9th Level:** The weapon's extra psychic damage increases to 3, or to 6 if the target is [winded](../rule/health/winded.md). Additionally, you gain an [edge](../rule/dice/edge.md) on any ability using the weapon against a [winded](../rule/health/winded.md) target.
...
**[Item Prerequisite](../rule/downtime/item-prerequisite.md):** Eight iron bars cooled in a glacier, the branch of an ancient evergreen
...
**1st Level:** Any weapon ability that deals [rolled damage](../rule/damage/rolled-damage.md) using this weapon deals an extra 1 cold damage. Additionally, you can use a maneuver to create an ice field in a 3 [burst](../rule/combat/burst.md). The ground in this area is [difficult terrain](../movement/difficult-terrain.md) for enemies, and lasts until the end of the encounter or when you use this ability again.

**5th Level:** The weapon's extra cold damage increases to 2, and the ice field becomes a 4 [burst](../rule/combat/burst.md). Additionally, whenever you use a weapon ability using this weapon against one or more enemies in the ice field, you gain 1 [surge](../rule/resource/surge.md) that you can use immediately.

**9th Level:** The weapon's extra cold damage increases to 3, and the ice field becomes a 5 [burst](../rule/combat/burst.md). Additionally, any enemy in the ice field who is reduced to 0 [Stamina](../rule/health/stamina.md) by an ability using the weapon can be shattered, killing them and dealing 15 cold damage to each enemy within 3 squares of them.
...
**[Item Prerequisite](../rule/downtime/item-prerequisite.md):** Eighteen daggers—nine taken from personal enemies and nine gifted by friends
...
**1st Level:** Any weapon ability that deals [rolled damage](../rule/damage/rolled-damage.md) using this weapon deals an extra 1 psychic damage. This extra damage increases by 1 each time you deal [rolled damage](../rule/damage/rolled-damage.md) using the weapon to the same target during the same encounter (to a maximum of 3).

**5th Level:** Whenever you reduce a creature to 0 [Stamina](../rule/health/stamina.md) with an ability using this weapon, one of its indentations glows brighter. When you use a [signature ability](../rule/combat/signature-ability.md) using the weapon, you can use a [triggered action](../rule/combat/triggered-action.md) to expend any number of bright-glowing indentations, with the ability dealing extra psychic damage equal to the number of indentations. The expended indentations then return to a dim glow.

**9th Level:** If you make a weapon [strike](../rule/combat/strike.md) using this weapon against a target after dropping down on them from a height of 2 squares or more, the attack deals an extra 10 psychic damage. You can distribute all extra psychic damage dealt by the attack between the target and any enemies [adjacent](../rule/combat/adjacent.md) to them.
...
**[Item Prerequisite](../rule/downtime/item-prerequisite.md):** A venom sac from a giant spider, one valok gyroscope

**[Project Source](../rule/downtime/project-source.md):** Texts or lore in Caelian and Variac

**[Project Roll](../rule/downtime/project-roll.md) [Characteristic](../rule/character/characteristic.md):** [Might](../rule/character/might.md), [Reason](../rule/character/reason.md), or [Intuition](../rule/character/intuition.md)

**Project Goal:** 450

**1st Level:** Any weapon ability that deals [rolled damage](../rule/damage/rolled-damage.md) using this weapon deals an extra 1 poison damage. Additionally, any [signature ability](../rule/combat/signature-ability.md) using the weapon that obtains a tier 3 outcome also makes the target [weakened](../condition/weakened.md) until the end of their next [turn](../rule/combat/turn.md).

**5th Level:** The weapon's extra poison damage increases to 2. A [signature ability](../rule/combat/signature-ability.md) made using the weapon that obtains a tier 3 outcome also makes the target [weakened](../condition/weakened.md) and [slowed](../condition/slowed.md) until the end of their next [turn](../rule/combat/turn.md).

**9th Level:** The weapon's extra poison damage increases to 3. Additionally, if you use an ability using the weapon that targets one creature and you don't have a [bane](../rule/dice/bane.md) or double [bane](../rule/dice/bane.md) on the ability, you can take a [bane](../rule/dice/bane.md). Doing so lets you target another creature [adjacent](../rule/combat/adjacent.md) to the original target. Alternatively, you can have a double [bane](../rule/dice/bane.md) to target two creatures [adjacent](../rule/combat/adjacent.md) to the original target.
...
**[Item Prerequisite](../rule/downtime/item-prerequisite.md):** One hundred steel arrowheads stained with blood

**[Project Source](../rule/downtime/project-source.md):** Texts or lore in Caelian and Kalliak

**[Project Roll](../rule/downtime/project-roll.md) [Characteristic](../rule/character/characteristic.md):** [Might](../rule/character/might.md), [Reason](../rule/character/reason.md), or [Intuition](../rule/character/intuition.md)

**Project Goal:** 450

**1st Level:** You gain a +1 [bonus](../rule/dice/bonuses-and-penalties.md) to [melee](../rule/combat/melee.md) [distance](../rule/combat/distance.md) with weapon abilities using this weapon. Additionally, any damage-dealing weapon ability using the weapon against a target who has A < AVERAGE also leaves that target [bleeding](../condition/bleeding.md) (save ends).

**5th Level:** The weapon's [bonus](../rule/dice/bonuses-and-penalties.md) to [melee](../rule/combat/melee.md) [distance](../rule/combat/distance.md) increases to +2. Additionally, any weapon ability that deals [rolled damage](../rule/damage/rolled-damage.md) using the weapon gains a +3 damage [bonus](../rule/dice/bonuses-and-penalties.md) against any target who is [bleeding](../condition/bleeding.md).

**9th Level:** The weapon's [bonus](../rule/dice/bonuses-and-penalties.md) to [melee](../rule/combat/melee.md) [distance](../rule/combat/distance.md) increases to +3. Additionally, if you use a [signature ability](../rule/combat/signature-ability.md) using the weapon that targets one or more [bleeding](../condition/bleeding.md) creatures, you can use the same ability again immediately as a maneuver.
...
**[Item Prerequisite](../rule/downtime/item-prerequisite.md):** Heart strings of a tapir, a pound of tiger's eye gemstones
...
**1st Level:** Any weapon ability that deals [rolled damage](../rule/damage/rolled-damage.md) using this weapon deals an extra 1 psychic damage. Additionally, any damage-dealing weapon ability using the weapon that achieves a tier 3 outcome also leaves the target [dazed](../condition/dazed.md) until the end of their next [turn](../rule/combat/turn.md). **5th Level:** The weapon's extra psychic damage increases to 2. Additionally, whenever a creature within [distance](../rule/combat/distance.md) of your [ranged](../rule/combat/ranged.md) weapon free strike uses a [triggered action](../rule/combat/triggered-action.md), you can use a [triggered action](../rule/combat/triggered-action.md) after their [triggered action](../rule/combat/triggered-action.md) resolves to make a [ranged](../rule/combat/ranged.md) weapon free strike using this weapon against the creature.

**9th Level:** The weapon's extra psychic damage increases to 3. Additionally, you have a double [edge](../rule/dice/edge.md) on weapon abilities that use the weapon against creatures who have used a psionic ability since the end of your last [turn](../rule/combat/turn.md).
...
**[Item Prerequisite](../rule/downtime/item-prerequisite.md):** A jar of captured thunder, two ingots of moon metal
...
**[Item Prerequisite](../rule/downtime/item-prerequisite.md):** A folded metal blade infused with blood
...
**1st Level:** Any weapon ability that deals [rolled damage](../rule/damage/rolled-damage.md) using this weapon deals an extra 1 psychic damage. Additionally, if you reduce a creature to 0 [Stamina](../rule/health/stamina.md) using this weapon, you can immediately use a maneuver to make a [melee](../rule/combat/melee.md) [free strike](../feature/common/main-actions/free-strike.md).

**5th Level:** The weapon's extra psychic damage increases to 2. Additionally, if you reduce a creature to 0 [Stamina](../rule/health/stamina.md) using the weapon, you can use a maneuver to make a [melee](../rule/combat/melee.md) [free strike](../feature/common/main-actions/free-strike.md) and can move up to 2 squares before or after the [strike](../rule/combat/strike.md).

**9th Level:** The weapon's extra psychic damage increases to 3. Additionally, if you reduce a creature to 0 [Stamina](../rule/health/stamina.md) using the weapon, you can use a maneuver to move up to your [speed](../rule/character/speed.md) and make either a [signature ability](../rule/combat/signature-ability.md) strike or a [melee](../rule/combat/melee.md) [free strike](../feature/common/main-actions/free-strike.md).

#### Other Leveled Treasures

In addition to armor, shields, [implements](../rule/treasure/implement.md), and weapons, heroes can make use of a wide range of [magic and psionic treasures](treasures.md). This section presents other types of [leveled treasures](../rule/treasure/leveled-treasure.md) in alphabetical order.
...
**[Item Prerequisite](../rule/downtime/item-prerequisite.md):** A pair of obituaries that each mention the subject of the other
...
**1st Level:** While you wear these hand wraps, any weapon ability that deals [rolled damage](../rule/damage/rolled-damage.md) using your unarmed [strikes](../rule/combat/strike.md) gains a +1 damage [bonus](../rule/dice/bonuses-and-penalties.md). Additionally, once per [turn](../rule/combat/turn.md), you can take 5 damage that can't be reduced in any way to use the [Grab](../feature/common/maneuvers/grab.md) maneuver (no action required).

**5th Level:** The damage [bonus](../rule/dice/bonuses-and-penalties.md) granted by the hand wraps increases to +2. Additionally, once per [turn](../rule/combat/turn.md), you can take 10 damage that can't be reduced in any way to make a [melee](../rule/combat/melee.md) [free strike](../feature/common/main-actions/free-strike.md) (no action required). On your [turn](../rule/combat/turn.md), you can use the wraps' [melee](../rule/combat/melee.md) [free strike](../feature/common/main-actions/free-strike.md) option or [Grab](../feature/common/maneuvers/grab.md) maneuver option, but only one.

**9th Level:** The damage [bonus](../rule/dice/bonuses-and-penalties.md) granted by the hand wraps increases to +3. Additionally, once per [turn](../rule/combat/turn.md), you can take 15 damage that can't be reduced in any way to use a [signature ability](../rule/combat/signature-ability.md) (no action required). On your [turn](../rule/combat/turn.md), you can use the wraps' [signature ability](../rule/combat/signature-ability.md) option, [melee](../rule/combat/melee.md) [free strike](../feature/common/main-actions/free-strike.md) option, or [Grab](../feature/common/maneuvers/grab.md) maneuver option, but only one.

##### Lightning Treads {data-scc="mcdm.heroes.v1/treasure.leveled.other/lightning-treads"}

*Sparks strike from these boots whenever they touch the ground, increasing in number as the wearer gathers [speed](../rule/character/speed.md).*

**Keywords:** Feet, Magic

**[Item Prerequisite](../rule/downtime/item-prerequisite.md):** One jar of lightning
...
**[Item Prerequisite](../rule/downtime/item-prerequisite.md):** A cloak worn by a murdered monarch
...
**1st Level:** While you wear this cloak, any creature who damages you is marked for revenge until the end of your next [turn](../rule/combat/turn.md) or until another creature damages you. Any strike you make against a creature marked for revenge deals extra damage equal to your highest [characteristic](../rule/character/characteristic.md) score, and whenever you damage a creature marked for revenge, they are also [bleeding](../condition/bleeding.md) until the end of their next [turn](../rule/combat/turn.md).

**5th Level:** Each creature who damages you is marked for revenge until the end of your next [turn](../rule/combat/turn.md). Whenever you damage a creature marked for revenge, they are also [bleeding](../condition/bleeding.md) (save ends).

**9th Level:** When you have three or more creatures marked for revenge and you target one of them with an ability that targets only one creature, you target all the creatures marked for revenge, regardless of their [distance](../rule/combat/distance.md) from you and even if you don't have [line of effect](../rule/combat/line-of-effect.md) to them.
...
**1st Level:** While you wear this torque, you gain a [bonus](../rule/dice/bonuses-and-penalties.md) to [Stamina](../rule/health/stamina.md) equal to twice your highest [characteristic](../rule/character/characteristic.md) score. Additionally, you can use a maneuver to choose a creature in your [line of effect](../rule/combat/line-of-effect.md) and learn their level. If their level is higher than yours, the torque grants you envy. If their level is equal to or lower than yours, the torque grants you disdain. You can have both envy and disdain from different creatures, but not more than one instance of either.

Whenever a creature within 10 squares of you deals damage to another creature, you can use a [triggered action](../rule/combat/triggered-action.md) to expend your envy or disdain. If you expend envy, you deal damage equal to the triggering damage to a creature [adjacent](../rule/combat/adjacent.md) to you. If you expend disdain, you reduce the triggering damage by half. At the end of the encounter, you lose any envy or disdain granted by the torque.

**5th Level:** The torque's [bonus](../rule/dice/bonuses-and-penalties.md) to [Stamina](../rule/health/stamina.md) increases to three times your highest [characteristic](../rule/character/characteristic.md) score. Additionally, when you use the torque's maneuver and the target creature is the same level as you, you gain your choice of envy or disdain.

**9th Level:** The torque's [bonus](../rule/dice/bonuses-and-penalties.md) to [Stamina](../rule/health/stamina.md) increases to five times your highest [characteristic](../rule/character/characteristic.md) score. Additionally, you can have multiple instances of envy and disdain, with no limit on either.

### Artifacts

Artifacts are powerful treasures, with entire campaigns to be built around finding, using, hiding, protecting, or destroying one. Make no mistake—these items unbalance the game. If the heroes or villains have access to such a treasure, their power is far beyond what the encounter—building [guide](../rule/downtime/guide.md)lines in *Draw Steel: Monsters* expect. That's part of the fun!
...
**Suited for [Victory](../rule/resource/victories.md):** This sword takes on the size, shape, and make that the wielder wills into it. It can be a light, medium, or heavy weapon, and you can change its weapon type and appearance as a [free maneuver](../rule/combat/free-maneuver.md). Any weapon ability that deals [rolled damage](../rule/damage/rolled-damage.md) using the Blade of a Thousand Years gains a +5 damage [bonus](../rule/dice/bonuses-and-penalties.md), and that ability always deals holy damage. Any creature with weakness to holy damage who takes damage from this weapon is also [frightened](../condition/frightened.md) and [weakened](../condition/weakened.md) until the end of their next [turn](../rule/combat/turn.md).

**Rally the Righteous:** This blade fills all around it with hope and courage. Each ally within 1 mile of the weapon gains an [edge](../rule/dice/edge.md) on weapon abilities and magic abilities, and has [damage immunity](../rule/damage/damage-immunity.md) 5. Additionally, each such creature's [Stamina](../rule/health/stamina.md) maximum increases by 15 and they gain a +15 [bonus](../rule/dice/bonuses-and-penalties.md) to [Stamina](../rule/health/stamina.md) when this ability first affects them.

**Turn the Tide:** Each enemy minion within 1 mile of the sword is [dazed](../condition/dazed.md). Any enemy leader or solo creature in that area takes a [bane](../rule/dice/bane.md) on [ability rolls](../rule/dice/ability-roll.md).

**[Victory](../rule/resource/victories.md)'s Assurance:** This weapon always appears on the eve before what will later come to be known as a historic battle. It disappears after 24 hours or when the battle is won, whichever comes first. By taking the blade, the wielder unwittingly enters into a pact with the weapon. If they don't secure [victory](../rule/resource/victories.md) against monumental odds or some great foe by the time the sword disappears, they are pulled into the sword, preventing any chance of resurrection, and forever dooming them to lend their strength to the heroes of other ages.

**Soul of the Martyr:** If the wielder dies while holding this blade, their soul is drawn into the starlight hilt, where it remains for the rest of time to prevent any chance of resurrection. The sword disappears, but the lingering feeling of hope that spreads from it remains. For the next hour, the effects of Rally the Righteous increase to provide a double [edge](../rule/dice/edge.md) on weapon abilities and magic abilities, [damage immunity](../rule/damage/damage-immunity.md) 10, an increase to [Stamina](../rule/health/stamina.md) maximum of 30, and a [bonus](../rule/dice/bonuses-and-penalties.md) to [Stamina](../rule/health/stamina.md) of +30.
...
**Shining [Presence](../rule/character/presence.md):** The one who wields the Encepter is always cast in a brilliant glow. Any [power roll](../rule/dice/power-roll.md) made by the wielder that uses [Presence](../rule/character/presence.md) automatically achieves a tier 3 outcome, though the wielder can still roll in an attempt to score a critical success or [critical hit](../rule/combat/critical-hit.md).

**Champion's Lasso:** As a [free maneuver](../rule/combat/free-maneuver.md), the wielder of the scepter can trigger a glowing line of light that traces their path as they move, or can dismiss the glowing line. If the wielder crosses over this line, each creature and object of the wielder's choice enclosed inside the line and within 2 squares above and below it are considered lassoed by the Encepter. Creatures remain lassoed until the lasso is released or until a new line is drawn.

**Dominion:** Each creature lassoed by the Encepter is [restrained](../condition/restrained.md) and can't [teleport](../movement/teleport.md). A creature caught in midair while lassoed stays in place rather than falling.
...
Only one destined for death can contain the power of the Mortal Coil. A mortal creature who carries this artifact serves as its host, gaining an additional main action on each of their [turns](../rule/combat/turn.md), aging at ten times the usual rate, and becoming unable to ever regain [Stamina](../rule/health/stamina.md). A host with no natural maximum lifespan permanently reduces their [Stamina](../rule/health/stamina.md) maximum by 10 each year.
...
Players don't simply choose their characters' titles. Like treasures and [Renown](../rule/resource/renown.md) (in the next section), titles must be won. Each title has a unique requirement, so that earning a title might mean your character needs to defeat a specific monster, research dangerous forbidden lore, or—in the case of the [Monarch](../title/monarch.md) title—win a kingdom!
...
Although the Director gives out titles, if you want to earn a specific title, let your Director know. For instance, you might say, "I'm interested in the [Dragon Blooded](../title/dragon-blooded.md) title. Can my hero listen for rumors of any wicked dragons nearby that need smiting?" Having ambition is good! Pursue the titles you want that will make you a better hero.

### Title Echelons

Each title is assigned to an [echelon](../rule/general/echelon.md) of play where it is most likely to be earned. For instance, knighthood is something that can be typically earned by the 2nd [echelon](../rule/general/echelon.md), but becoming a [monarch](../title/monarch.md) can usually only be achieved in the 4th [echelon](../rule/general/echelon.md). But don't let the rules get in the way of a good story! If the Director decides that your character somehow wins a knighthood at 1st level, bask in the glory of this great accomplishment.

> For the Director: Granting Titles Early
>
> Granting titles before characters reach the recommended [echelon](../rule/general/echelon.md) can be fun, but it's worth noting that doing so might have unwanted effects on the game. Higher-[echelon](../rule/general/echelon.md) titles often grant more significant benefits than lower-[echelon](../rule/general/echelon.md) titles. If a hero becomes queen at 1st level, her royal responsibilities might overshadow her other adventures. Don't grant a title more than one [echelon](../rule/general/echelon.md) early unless you know what you're getting yourself into!

### Customizing Titles

This section details a number of ready-to-use titles. But the Director can also create custom titles, both to reward specific player accomplishments and to flesh out organizations, locations, and foes within their own game world. When a hero finally achieves a long-term goal after many game sessions of struggle, the Director can memorialize the moment by granting a unique title. Similarly, the Director can grant custom titles when the heroes befriend specific factions, defeat notorious villains, or learn new moves from skilled [NPCs](../rule/general/npc.md).

The easiest way to create custom titles is to modify an existing title's requirements to fit the adventure at hand. For instance, your world might contain a secretive organization of freedom fighters—the Jesters—who never carry weapons, defeating foes with unarmed attacks and improvised weapons. Creating a Jester title can be as easy as modifying the [Brawler](../title/brawler.md) title by changing its requirements to "Fight alongside the Jesters against a mutual foe."
...
Most titles, however, are earned by all the heroes at once for accomplishing a great task, benefiting them all. These titles typically offer a selection of three or four different options. When the party earns the title, each player decides which benefit their hero takes. For instance, if the party triumphs in a tavern fight and gains the [Brawler](../title/brawler.md) title, one hero might become more adept at fighting with improvised weapons, another might learn a special dodge to use when flanked by multiple enemies, and two others might simply revel in the increased notoriety. A hero can take any of a title's benefits they qualify for, and multiple heroes can take the same benefit.

### Granting Titles

Titles are rewards for heroic activities, and they often go hand in hand with treasure and other goodies. If the party defeats a fearsome monster and earns [Renown](../rule/resource/renown.md), or accomplishes a quest and wins a magic [leveled treasure](../rule/treasure/leveled-treasure.md), one or more characters might earn a title at the same time.

There is no hard-and-fast rule for the number of titles characters should accumulate by a certain level. If a character wins a title whenever they accomplish a truly notable deed—once every few adventures—then they might earn about one title per [echelon](../rule/general/echelon.md). Sticking to this rate isn't a requirement, though. Characters might easily earn twice or half as many titles, making them a bit more or less powerful than they otherwise would be. A Director can even skip granting titles altogether if they wish.

### 1st-Echelon Titles

Titles suitable for 1st-[echelon](../rule/general/echelon.md) characters are presented in alphabetical order.

> **Optional Rule: Players Choose Titles**
>
> If the Director doesn't want to track player accomplishments, they can let the players do it instead. In this case, whenever a hero enters a new [echelon](../rule/general/echelon.md) of play, they gain one title of their choice for which they qualify.

> **For the Director: Planning Titles**
>
> While running a game session, it can be hard to track the heroes' actions and remember which titles they might qualify for. As such, it's easier to plan titles ahead of time. If the heroes might face a demon or dragon in an upcoming adventure, you can include the [Demon Slayer](../title/demon-slayer.md) or [Dragon Blooded](../title/dragon-blooded.md) titles as potential rewards alongside that magic cloak or psionic dagger. You can even use titles to inspire adventures. What challenges should a hero face to earn the [Demigod](../title/demigod.md) title?
...
- *Leverage:* You know a priceless secret. The Director chooses the type of person who would value this secret—usually a member of a particular faction, such as a Higaran [noble](../title/noble.md), or a type of person, such as a fence of stolen goods. When engaged in a negotiation with this type of person, you can offer this secret. If they accept, their interest increases by 3 (to a maximum of 5). You can share this secret only once.
- *Rare Books:* You add rare, ancient books to your collection. Whenever you undertake a [research project](../rule/downtime/research-project.md), roll 1d6 for each dead language you know and add the total to the [project roll](../rule/downtime/project-roll.md).
- *Susurrus Codex:* You find a sinister book that whispers advice in a voice no one else can hear. As long as you follow the book's advice, you gain an [edge](../rule/dice/edge.md) on [Reason](../rule/character/reason.md) [tests](../rule/test/test.md) and take a [bane](../rule/dice/bane.md) on [Presence](../rule/character/presence.md) [tests](../rule/test/test.md). You can stop following the book's advice at any time, but the book won't speak to you for the rest of the day.
...
- *Discerning Shopper:* When looking for an [item prerequisite](../rule/downtime/item-prerequisite.md) for a [crafting project](../rule/downtime/crafting-project.md), you can remember meeting someone who might have the item—or at least information about it.
- *One with the Crowd:* While you're using one or more creatures as [cover](../rule/combat/cover.md), you gain an [edge](../rule/dice/edge.md) on [tests](../rule/test/test.md) made to hide and sneak.
- *Street Smart:* While in a settlement, you can't be [surprised](../rule/combat/surprised.md).
...
**Prerequisite:** You join an organization that hunts criminals, such as the Far Mariners (see [Orden](../rule/world/orden.md) and the Timescape in Chapter 1: [The Basics](the-basics.md)), or you are deputized to act for the local authorities.
...
- *Beast [Bane](../rule/dice/bane.md):* Creatures with the Animal keyword take a [bane](../rule/dice/bane.md) on [strikes](../rule/combat/strike.md) made against you.
- *Monster Soother:* You gain an [edge](../rule/dice/edge.md) on [tests](../rule/test/test.md) made to calm or tame nonsapient creatures.
- *Monster Trophy:* You decorate your equipment with a trophy from a creature you defeated. While the trophy is visible, you gain an [edge](../rule/dice/edge.md) on [tests](../rule/test/test.md) made to intimidate sapient creatures.
...
At a dramatic moment determined by the Director, you rejoin your party with an explanation for your narrow escape, and how you found your new [trinket](../rule/treasure/trinket.md) along the way.
...
**Prerequisite:** You defeat a leader or solo creature who is [size](../rule/character/size.md) 1S or smaller, such as a goblin [monarch](../title/monarch.md).
...
- *Deep-Sea Diver:* You can automatically swim at full [speed](../rule/character/speed.md) while moving.
- *Ship Speaker:* You magically know the location of any ship controlled by your party even while you aren't aboard. You can telepathically communicate with anyone on board one of your ships who understands a language, and they can respond, no matter your [distance](../rule/combat/distance.md) from the ship.
- *Signal Flags:* While aboard a ship, you can communicate with and conduct negotiations with another ship up to 5 miles away, as long as you and creatures on the other ship have [line of effect](../rule/combat/line-of-effect.md) to each other. You gain an [edge](../rule/dice/edge.md) on [Presence](../rule/character/presence.md) [tests](../rule/test/test.md) made while negotiating in this way.
- *Trained Crewmember:* You gain an [edge](../rule/dice/edge.md) on [tests](../rule/test/test.md) made to handle air or sea vessels.
...
Titles suitable for 2nd-[echelon](../rule/general/echelon.md) characters are presented in alphabetical order.
...
> **[Power Roll](../rule/dice/power-roll.md) + [Might](../rule/character/might.md) or [Agility](../rule/character/agility.md):**
>
> - **≤11:** 6 damage; I < WEAK, [slowed](../condition/slowed.md) (save ends)
> - **12-16:** 10 damage; I < AVERAGE, [frightened](../condition/frightened.md) (save ends)
> - **17+:** 14 damage; I < STRONG, [dazed](../condition/dazed.md) (save ends)
>
> **Effect:** If you kill a non-minion opponent using this ability, each enemy within 3 squares of you is [frightened](../condition/frightened.md) (save ends).
...
- *Foresight:* You don't take a [bane](../rule/dice/bane.md) when using abilities against creatures with [concealment](../rule/combat/concealment.md).
- *Rogue [Talent](../class/talent.md):* Choose one [triggered action](../rule/combat/triggered-action.md) that the [talent](../class/talent.md) class has access to at 1st level. You gain that ability regardless of whether your class and [subclass](../rule/general/subclass.md) allow you to take it. If this ability allows you to gain or spend clarity, you can't do so unless you have the Clarity class feature.
...
**Prerequisite:** You have the [Ship Captain](../title/ship-captain.md) title, and you sink or capture a ship of equal or greater [size](../rule/character/size.md) than your own.
...
- *Heraldic Fame:* You earn 1 [Renown](../rule/resource/renown.md).
...
**Prerequisite:** You have the [Ancient Loremaster](../title/ancient-loremaster.md) title, and you have completed a Discover Lore project to learn lost knowledge or forbidden knowledge.
...
- *Spy Ring:* You gain a piece of magic jewelry, such as a ring. As a main action while wearing the jewelry, you can take on the illusory appearance of an individual within 10 squares who you have [line of effect](../rule/combat/line-of-effect.md) to. This disguise lets you automatically succeed on [tests](../rule/test/test.md) made using the Disguise skill based solely on visual identification.

##### Boffin Properties

Taking the Boffin benefit lets you use the following boffin properties as a maneuver:

- Make a [test](../rule/test/test.md) that uses the Disguise skill. You gain an [edge](../rule/dice/edge.md) on the [test](../rule/test/test.md).
- One mundane lock you touch is unlocked.
- Choose a square within 10 squares, even if you don't have [line of effect](../rule/combat/line-of-effect.md) to it. You can observe the area around that square as if you were in it.
- You throw the boffin up to 10 squares, where it explodes in a 5 [cube](../rule/combat/cube.md). Each creature in the area takes fire damage equal to 2d10 + your level. The boffin is permanently destroyed but can be replaced by your spymaster... though they don't like doing so too often.
...
Titles suitable for 3rd-[echelon](../rule/general/echelon.md) characters are presented in alphabetical order.
...
**Special:** When you make a [Presence](../rule/character/presence.md) [test](../rule/test/test.md) and roll a natural 5 or lower, you are cursed to communicate in only Proto-Ctholl for 1 minute, whether you know that language or not.
...
- *Dragon Scaled:* Dragon scales grow on your body wherever the heart's blood of the dragon touched you. You gain the Wyrmplate signature trait from the [dragon knight](../ancestry/dragon-knight.md) ancestry (see Chapter 3: [Ancestries](ancestries.md)).
- *Dragon Touched:* You gain 3 ancestry points to spend on purchased [dragon knight](../ancestry/dragon-knight.md) [ancestry traits](ancestries.md).

#### Fleet Admiral {data-scc="mcdm.heroes.v1/title/fleet-admiral"}

*All hail the Pirate Queen!*

**Prerequisite:** You have the [Corsair](../title/corsair.md) title, and you lead a fleet of at least three ships.

**Effect:** Choose one of the following benefits:

- *First Mate:* You have a pirate [retainer](../rule/general/retainer.md), such as a **[human](../ancestry/human.md) warrior**, chosen by the Director from *Draw Steel: Monsters*. This [retainer](../rule/general/retainer.md)'s level increases to your level.
- *[Swashbuckler](../kit/swashbuckler.md):* You can automatically climb at full [speed](../rule/character/speed.md) while moving
- *Treasure Keeper:* You earn 1 [Wealth](../rule/resource/wealth.md).
- *Weather Wizard:* Once per day, you can spend 10 uninterrupted minutes to magically alter mundane weather in a 5-mile radius around you. The weather moves with you and persists for 6 hours or until you dismiss it as a [free maneuver](../rule/combat/free-maneuver.md). Choose from one of the following weather types:
  - *Calm:* Wind-powered vessels and technology cease working
  - *Fog:* Visibility is reduced to 6 squares.
  - *High Winds:* The [speed](../rule/character/speed.md) of wind-powered vessels is doubled.
  - *Light Winds:* No effects due to weather.
  - *Storm:* The crew of an unsheltered wind-powered vessel must make a medium group [Reason](../rule/character/reason.md) [test](../rule/test/test.md). On a failure, the vessel needs repairs and moves at half [speed](../rule/character/speed.md) until those repairs are made.
...
> - **17+:** 10 sonic damage; M < STRONG, [weakened](../condition/weakened.md) and [bleeding](../condition/bleeding.md) (save ends)
>
...
**Prerequisite:** A [monarch](../title/monarch.md) or important [noble](../title/noble.md) grants you a [noble](../title/noble.md) rank.

**Effect:** Choose one of the following benefits:

- *I Know How to Talk to These People:* You gain an [edge](../rule/dice/edge.md) on [Presence](../rule/character/presence.md) [tests](../rule/test/test.md) made to interact with royals, nobles, and their feudal [followers](../rule/general/follower.md), provided they are aware of your [noble](../title/noble.md) rank.
- *Noble Splendor:* You earn 1 [Renown](../rule/resource/renown.md) and 1 [Wealth](../rule/resource/wealth.md).
- *Retinue:* The number of [followers](../rule/general/follower.md) you can recruit increases by two.

**Special:** If you take this title, you might occasionally be called upon to perform duties for the person who granted your [noble](../title/noble.md) rank.
...
**Effect:** You gain a visible scar in a location of your choice. Additionally, your [Stamina](../rule/health/stamina.md) maximum increases by 20, and the creature who [scarred](../title/scarred.md) you takes a [bane](../rule/dice/bane.md) on abilities against you.
...
*There goes Diana, [peace bringer](../title/peace-bringer.md). She has won many a [victory](../rule/resource/victories.md) with her sword, but her greatest deed was convincing two nations to stop fighting.*
...
Additionally, choose a [heroic ability](../rule/general/heroic-ability.md) belonging to any class. You gain this [heroic ability](../rule/general/heroic-ability.md), which can be paid for using the [Heroic Resource](../rule/resource/heroic-resource.md) of your class. You can't use a [heroic ability](../rule/general/heroic-ability.md) that requires a class feature you don't have.
...
**Prerequisite:** You have the [Unstoppable](../title/unstoppable.md) title, and you make or assist on a [test](../rule/test/test.md) as part of a [montage test](../rule/test/montage-test.md) that obtains a full success.
...
**Prerequisite:** You have the [Heist Hero](../title/heist-hero.md) title, and you have stolen a precious object or escaped from captivity while evading guards of 8th level or higher.

**Effect:** Your choice of your [Might](../rule/character/might.md) or [Agility](../rule/character/agility.md) increases by 1 (to a maximum of 6). Additionally, choose one of the following benefits:

- *Bye-Bye:* You can use a maneuver to [teleport](../movement/teleport.md) yourself and each willing ally within 5 squares of you to new positions within 10 squares of your original starting point. Once you use this benefit, you can't use it again until you earn 1 or more [Victories](../rule/resource/victories.md).
- *Laughs at Locks:* Whenever you make a [test](../rule/test/test.md) to open a lock or break a restraint, you don't need any tools and you automatically obtain a tier 3 outcome.
- *Slippery:* You can't be [grabbed](../condition/grabbed.md) against your will.

## Renown {data-scc="mcdm.heroes.v1/rule.resource/renown"}

As you accomplish heroic deeds, your fame allows you to influence [NPCs](../rule/general/npc.md) and attract [followers](../rule/general/follower.md). Your infamy among your enemies also grows. Every hero has a Renown score that represents how they can use their reputation to influence others. The higher the score, the greater your impact with those who know of your legend.
...
Some perks (see Chapter 7), downtime projects (Chapter 12: [Downtime Projects](downtime-projects.md)), and titles and treasures (part of Chapter 13: [Rewards](rewards.md)) can increase your [renown](../rule/resource/renown.md). But for the most part, you earn [Renown](../rule/resource/renown.md) at the end of an exciting adventure, often after the acknowledgement of a powerful [NPC](../rule/general/npc.md) that you helped save them, their family, their home, their organization—or even their nation or world. That [NPC](../rule/general/npc.md) and anyone else who witnessed your heroics can tell the tale, and from there, your legend grows.

In most campaigns, the Director sets the characters up to earn 1 [Renown](../rule/resource/renown.md) per level, but some campaigns will feature heroes who are more or less famous (or infamous) than that.

### Influence Negotiation

[Renown](../rule/resource/renown.md) changes the way [NPCs](../rule/general/npc.md) respond to heroes during negotiations (see Chapter 11: [Negotiation](negotiation.md)), whether that [renown](../rule/resource/renown.md) takes the form of fame or infamy.

### Attract Followers {data-scc="mcdm.heroes.v1/rule.general/follower"}

Your [Renown](../rule/resource/renown.md) score allows you to attract and employ followers who perform different duties or favors for you. The [Renown](../rule/resource/renown.md) and Followers table shows how many followers a hero can have at one time based on [Renown](../rule/resource/renown.md). You can always let go of a follower in your employ to hire a new one.

You can recruit followers up to the maximum your [Renown](../rule/resource/renown.md) allows as a [respite](../rule/resource/respite.md) activity, provided you are in a place or have a means of communication that allows you to recruit such followers.

###### Renown and Followers Table

| [Renown](../rule/resource/renown.md) | Number of [Followers](../rule/general/follower.md) |
|--------|---------------------|
| 3      | 1                   |
| 6      | 2                   |
| 9      | 3                   |
...
Many [followers](../rule/general/follower.md) stay at a [stronghold](../title/stronghold.md), which is a home base you designate and can change. Your [stronghold](../title/stronghold.md) is typically a location shared by your fellow heroes. It could be a few rooms at an inn in a sleepy village, an old castle you claimed after clearing it of monsters, or a fleet of sailing ships.

#### Follower Types {data-scc="mcdm.heroes.v1/title/follower-types"}

When you attract a new [follower](../rule/general/follower.md), you decide on their name and ancestry, and choose what role they play in their service to you.
...
Retainers are heroic [NPCs](../rule/general/npc.md) who adventure alongside the player characters. They are controlled by players in combat and are both simpler to run and less powerful than player characters. A hero can have only one retainer in their service at a time unless the Director deems otherwise. Because retainers and their stat blocks are combat focused, the Director can also decide that a large party can have only one retainer in total—or can't have any retainers at all—to keep combat from getting long and tedious.
...
Draw Steel isn't about accumulating and counting every piece of copper you acquire. Instead of tracking a bank account, the amount of stuff your hero can purchase is based on their Wealth score. As you accomplish more deeds, you acquire more treasure and rewards from grateful [NPCs](../rule/general/npc.md) that allow you to be an even more effective hero.
...
Treasures such as magic swords, psionic crowns, and even healing potions are rare to the point where they don't appear on the Hero Wealth table. Such items typically can't be purchased, and are instead found on adventures, traded for other treasures, given as rewards by [NPCs](../rule/general/npc.md), or crafted by the heroes.

### Earning Wealth

Each hero starts with a [Wealth](../rule/resource/wealth.md) score of 1 that can be improved by their choice of career during character creation (see Chapter 4: [Background](background.md)). Your hero earns [Wealth](../rule/resource/wealth.md) whenever you find and keep a massive amount of monetary treasure, such as a hoard of coins and gems from a dragon's lair, or several unique and valuable paintings gifted by a [monarch](../title/monarch.md) as a reward for a job well done.

In general, a hero earns 1 wealth every second level of play. The Director can increase this rate if they wish.

### Losing Wealth

As an optional rule, the Director can allow a hero to make a purchase that is one above their [Wealth](../rule/resource/wealth.md) score. If this occurs, the hero's [Wealth](../rule/resource/wealth.md) is reduced by 1 (to a minimum of 0) after making the purchase.
...
| Score       | Affordable                                                                                                                            |
|-------------|---------------------------------------------------------------------------------------------------------------------------------------|
| 1           | Mundane clothing, gear, armor, [implements](../rule/treasure/implement.md), and weapons; meals or drinks at a common tavern; a stay at a common inn; passage on a boat |
