...
For our purposes, a hero's culture represents people, not a place. Yes, you might have grown up in the great city of [Capital](../rule/world/capital.md), but your culture is more specific than that. One hero's culture might be House Alvaro, a noble house in [Capital](../rule/world/capital.md) where they were raised. Another's culture could be a group or organization that moves around, such as a band of pirates or a secret order of sorcerers sworn to protect books of fell magic. It helps to get specific when thinking about your culture, and working with the four aspects of a culture can help you do that: **language**, **environment**, **organization**, and **upbringing**.
...
- You gain an [edge](../rule/dice/edge.md) on [tests](../rule/test/test.md) made to recall lore about your culture, and on [tests](../rule/test/test.md) made to influence and interact with people of your culture. (See [Edges](../rule/dice/edge.md) and [Banes](../rule/dice/bane.md) in Chapter 1: [The Basics](the-basics.md).)

#### Language

Your culture's language aspect determines how the people of your culture communicate. Languages in [Orden](../rule/world/orden.md) below discusses the many languages of the world of [Orden](../rule/world/orden.md), including Caelian—the language of the fallen empire that once dominated that world.
...
A [nomadic](../culture/nomadic.md) culture travels from place to place to survive. Members of a [nomadic](../culture/nomadic.md) culture might follow animal migrations or the weather, travel to sell their wares or services, or simply enjoy a restless lifestyle full of new experiences and peoples. Those who grow up in [nomadic](../culture/nomadic.md) cultures learn to navigate the wilderness and work closely with others to survive.

**Skill Options:** One skill from the [exploration](../skill/exploration/exploration.md) or [interpersonal](../skill/interpersonal/interpersonal.md) skill groups. (*Quick Build:* [Navigate](../skill/exploration/navigate.md).)

##### Rural {data-scc="mcdm.heroes.v1/culture/rural"}

A [rural](../culture/rural.md) culture is one located in a town, village, or smaller settled enclave. People dwelling in such places often cultivate the land, trade goods or services with travelers passing through, harvest fish from the sea, or mine metals and gems from the earth.

Living among a small population, most folks in a [rural](../culture/rural.md) community learn a trade and are handed down bits of essential knowledge to help their community survive. For example, when a rural culture has only one blacksmith, it's important to have an apprentice already learning at the anvil well before that smith starts to get old. If the only priest in town

gets the sniffles, folks want an acolyte ready to wear the fancy robes should the worst occur.

**Skill Options:** One skill from the [crafting](../skill/crafting/crafting.md) or [lore](../skill/lore/lore.md) skill groups. (*Quick Build:* [Nature](../skill/lore/nature.md).)

##### Secluded {data-scc="mcdm.heroes.v1/culture/secluded"}

A [secluded](../culture/secluded.md) culture is based in one relatively close-quarters structure—a building, a cavern, and so forth—and interacts with other cultures only rarely. Such places are often buildings or complexes such as monasteries, castles, or prisons. Folk in a [secluded](../culture/secluded.md) culture have little or no reason to leave their home or interact with other cultures on the outside, but might have an awareness of those cultures and of events happening beyond their enclave.
...
An [urban](../culture/urban.md) culture is always centered in a city. Such a culture might arise within the walls of [Capital](../rule/world/capital.md), a massive metropolis with a cosmopolitan population; within a network of caverns that hold an underground city; or in any other place where a large population lives relatively close together. The people of [urban](../culture/urban.md) cultures often learn to effectively misdirect others in order to navigate the crowds and the political machinations that can come with city life.

**Skill Options:** One skill from the [interpersonal](../skill/interpersonal/interpersonal.md) or [intrigue](../skill/intrigue/intrigue.md) skill groups. (*Quick Build:* [Alertness](../skill/intrigue/alertness.md).)

##### Wilderness {data-scc="mcdm.heroes.v1/culture/wilderness"}

A [wilderness](../culture/wilderness.md) culture doesn't try to tame the terrain in which its people live, whether desert, forest, swamp, tundra, ocean, or more exotic climes. Instead, the folk of such a culture thrive amid nature, taking their sustenance and shelter from the land. A wilderness culture might be a circle of druids protecting a remote wode, a band of brigands hiding out in desert caves, or a camp of [orc](../ancestry/orc.md) mercenaries who call the trackless mountains home. People in a [wilderness](../culture/wilderness.md) culture learn how to use the land for all they need to live, typically crafting their own tools, clothing, and more.

**Skill Options:** One skill from the [crafting](../skill/crafting/crafting.md) or [exploration](../skill/exploration/exploration.md) skill groups. (*Quick Build:* [Endurance](../skill/exploration/endurance.md).)
...
When you build a culture, select its organization aspect from the following options: [bureaucratic](../culture/bureaucratic.md) or [communal](../culture/communal.md). You gain skill options from your chosen system of organization.

##### Bureaucratic {data-scc="mcdm.heroes.v1/culture/bureaucratic"}

[Bureaucratic](../culture/bureaucratic.md) cultures are steeped in official leadership and formally recorded laws. Members of such a culture are often ranked in power according to those laws, with a small group of people holding the power to rule according to birthright, popular vote, or some other official and measurable standard. Many bureaucratic communities

have one person at the top, though others might be ruled by a council. A trade guild with a guildmaster, treasurer, secretary, and a charter of rules and regulations for membership; a feudal lord who rules over a group of knights who in [turn](../rule/combat/turn.md) rule over peasants working the land; and a militaristic society with ranks and rules that its people must abide are all examples of bureaucratic cultures.

Those who thrive in [bureaucratic](../culture/bureaucratic.md) cultures don't simply follow the rules. They know how to use those rules to their advantage, either bending, changing, or reinterpreting policy to advance their own interests. Schmoozing with those who make the laws is often key to this approach. Others in a [bureaucratic](../culture/bureaucratic.md) culture might specialize in operating outside the strict regulations that govern the culture without getting caught.

**Skill Options:** One skill from the [interpersonal](../skill/interpersonal/interpersonal.md) or [intrigue](../skill/intrigue/intrigue.md) skill groups. (*Quick Build:* [Persuade](../skill/interpersonal/persuade.md).)

##### Communal {data-scc="mcdm.heroes.v1/culture/communal"}

A [communal](../culture/communal.md) culture is a place where all members of the culture are considered equal. The community works together to make important decisions that affect the majority of the culture. While they elect leaders to carry out these decisions and organize their efforts, each person has a relatively equal say in how the culture operates, and everyone contributes to help their people survive and thrive. Individuals often share the burdens of governing, physical labor, childcare, and other duties. A collective of farmers who work together to cultivate and protect their land without a noble, a city of pirates where each person can do as they wish, and a traveling theatrical troupe whose members vote on every artistic and administrative decision are all communal cultures.

Many [communal](../culture/communal.md) cultures operate outside settled lands, sticking to the wilds, a specific district in a larger settlement, city sewers, forgotten ruins, or other isolated places. For even when such cultures are harmless, their members know that outsiders might try to impose rules upon them if they live in the same place. As such, many folks in [communal](../culture/communal.md) cultures focus on fending for themselves while avoiding the danger that other groups can represent.

**Skill Options:** One skill from the [crafting](../skill/crafting/crafting.md) or [exploration](../skill/exploration/exploration.md) skill groups. (*Quick Build:* [Jump](../skill/exploration/jump.md).)
...
Pick your upbringing aspect from the following list: [academic](../culture/academic.md), [creative](../culture/creative.md), [labor](../culture/labor.md), [lawless](../culture/lawless.md), [martial](../culture/martial.md), or [noble](../culture/noble.md). You gain skill options from your chosen aspect.

##### Academic {data-scc="mcdm.heroes.v1/culture/academic"}

Your hero was raised by people who collect, study, and share books and other records. Some academics focus on one area of study, such as a college for wizards dedicated to the study of magic, or a church that teaches the word of one deity. People in an [academic](../culture/academic.md) culture learn how to wield the power that is knowledge.

**Skill Options:** One skill from the [lore skill group](../skill/lore/lore.md). (*Quick Build:* [History](../skill/lore/history.md).)

##### Creative {data-scc="mcdm.heroes.v1/culture/creative"}

A hero with a [creative](../culture/creative.md) upbringing was raised among folk who create art or other works valuable enough to trade. A [creative](../culture/creative.md) culture might produce fine art such as dance, music, or sculpture, or more practical wares such as wagons, weapons, tools, or buildings. People in such cultures learn the value of quality crafting and attention to detail.

**Skill Options:** The [Music](../skill/interpersonal/music.md) or [Perform](../skill/interpersonal/perform.md) skill (from the [interpersonal skill group](../skill/interpersonal/interpersonal.md)), or one skill from the [crafting group](../skill/crafting/crafting.md). (*Quick Build:* [Perform](../skill/interpersonal/perform.md).)

##### Labor {data-scc="mcdm.heroes.v1/culture/labor"}

Your hero came of age in a culture where people labored for a living. They might have been cultivators, typically raising crops or livestock on a farm. They might have harvested natural resources, whether by hunting, trapping, logging, or mining. Or they might have excelled at manual [labor](../culture/labor.md) tied to settlement and trade, such as construction, carting, loading cargo, and so forth. People with a [labor](../culture/labor.md) upbringing know the value of hard work.

**Skill Options:** The [Blacksmithing](../skill/crafting/blacksmithing.md) skill (from the [crafting skill group](../skill/crafting/crafting.md)), the [Handle Animals](../skill/interpersonal/handle-animals.md) skill (from the [interpersonal group](../skill/interpersonal/interpersonal.md)), or a skill from the [exploration group](../skill/exploration/exploration.md). (*Quick Build:* [Lift](../skill/exploration/lift.md).)

##### Lawless {data-scc="mcdm.heroes.v1/culture/lawless"}

Your hero grew up among folk who performed activities that other people—whether within or outside their culture—considered unlawful. A band of pirates, a guild of assassins, or an organization of spies all commit unlawful acts for money. And under tyranny, people engaged in rebellion are often considered [lawless](../culture/lawless.md) in their actions and activities. People brought up in a [lawless](../culture/lawless.md) culture typically don't mind breaking the rules when it suits them—and are good at making sure no one finds out they did.

**Skill Options:** One skill from the [intrigue skill group](../skill/intrigue/intrigue.md). (*Quick Build:* [Sneak](../skill/intrigue/sneak.md).)

##### Martial {data-scc="mcdm.heroes.v1/culture/martial"}

A hero with a [martial](../culture/martial.md) upbringing was raised by warriors. These might have been the soldiers of an established army, a band of mercenaries, a guild of monster-slaying adventurers, or any other folk whose lives revolve around combat. Heroes with a [martial](../culture/martial.md) upbringing are always ready for a fight—and they know how to finish that fight.

**Skill Options:** One of the following: [Blacksmithing](../skill/crafting/blacksmithing.md) or [Fletching](../skill/crafting/fletching.md) from the [crafting skill group](../skill/crafting/crafting.md); [Climb](../skill/exploration/climb.md), [Endurance](../skill/exploration/endurance.md), or [Ride](../skill/exploration/ride.md) from the [exploration group](../skill/exploration/exploration.md); [Intimidate](../skill/interpersonal/intimidate.md) from the [interpersonal group](../skill/interpersonal/interpersonal.md); [Alertness](../skill/intrigue/alertness.md) or [Track](../skill/intrigue/track.md) from the [intrigue group](../skill/intrigue/intrigue.md); or [Monsters](../skill/lore/monsters.md) or [Strategy](../skill/lore/strategy.md) from the [lore skill group](../skill/lore/lore.md) (*Quick Build:* [Intimidate](../skill/interpersonal/intimidate.md).)

##### Noble {data-scc="mcdm.heroes.v1/culture/noble"}

Your hero grew up among leaders who rule over others and play the games of politics to maintain power. Many families are [noble](../culture/noble.md)s by birthright, but some cultures have [noble](../culture/noble.md) titles earned through deeds or popularity. Whatever the case, heroes with this background understand why the whispered words in the right ear can sometimes be more powerful than any army.
...
The languages on the Languages by Ancestry table are the most common languages actively spoken and signed by significant populations of people in [Orden](../rule/world/orden.md). The Vaslorian [Human](../ancestry/human.md) Languages table shows the dominant languages in that region's human-centric territories. Most languages are associated with a specific ancestry and its culture, but being a member of an ancestry doesn't automatically make you part of the associated culture the language is tied to. For example, if your [orc](../ancestry/orc.md) hero was raised in a culture of elves, you probably speak one of the elf languages, and might never have learned Kalliak.

Most languages have colloquial or casual names. For instance, many people in [Orden](../rule/world/orden.md) call Kalliak "Orcish" and Hyrallic "Elvish," but any sage knows there are lots of orcish and elf languages, just as there are multiple [human](../ancestry/human.md) languages.
...
| Rioja                     | Riojan      |
| Vanigar                   | Vaniric     |
| [Vasloria](../rule/world/vasloria.md)                  | Vaslorian   |

###### Languages by Ancestry Table

| Language              | Ancestry                              | Notes                                                                          |
|-----------------------|---------------------------------------|--------------------------------------------------------------------------------|
| Anjali                | [Devils](../ancestry/devil.md), hobgoblins                    | Language of contract law                                                       |
| Axiomatic             | [Memonek](../ancestry/memonek.md)                               | Native language of Axiom, and the common<br>language of the timescape by trade |
| Caelian               | [Orden](../rule/world/orden.md) denizens                        | Common language of [Orden](../rule/world/orden.md)                                                       |
| Filliaric             | Angulotls                             |                                                                                |
| The First<br>Language | Elder dragons                         | Language of magic                                                              |
| Hyrallic              | [High elves](../ancestry/high-elf.md)                            | Language of interspecies diplomacy                                             |
| Illyvric              | Shadow elves                          |                                                                                |
| Kalliak               | [Orcs](../ancestry/orc.md)                                  | Offshoot of Zaliac                                                             |
| Kethaic               | Kobolds                               | Patois of Vastariax and Caelian                                                |
| Khelt                 | Bugbears, fey                         | Offshoot of Kheltivari                                                         |
| Khoursirian           | [Polder](../ancestry/polder.md), [humans](../ancestry/human.md)                        | Distant offshoot of Khamish                                                    |
...
| Vastariax             | Dragons, [dragon<br>knights](../ancestry/dragon-knight.md)            |                                                                                |
| Vhoric                | [Hakaan](../ancestry/hakaan.md)                                | Offshoot of the stone giant dialect of High<br>Kuric                           |
| Voll                  | [Time raiders](../ancestry/time-raider.md)                          |                                                                                |
| Yllyric               | [Wode elves](../ancestry/wode-elf.md)                            | Language of druids                                                             |
| Za'hariax             | Overminds                             |                                                                                |
| Zaliac                | [Dwarves](../ancestry/dwarf.md)                               | Language of engineering                                                        |

##### Language Usage

**Hyrallic** is the primary language of the [high elves](../ancestry/high-elf.md) in [Orden](../rule/world/orden.md). Although young for an elf language, Hyrallic is older than almost all other modern cultural languages, save those of the [dwarves](../ancestry/dwarf.md). As a result, while anyone who lives near or trades with a [human](../ancestry/human.md) culture probably speaks at least a little Caelian, most nobles across all ancestries make sure their children or offspring speak Hyrallic. Caelian is new from many cultures' point of view, while Hyrallic as a language for diplomacy is considered cultured and traditional.

**Yllyric** is the cultural language of [wode elves](../ancestry/wode-elf.md), and also the common language among those who defend and protect the natural forests of [Orden](../rule/world/orden.md).

Within any document concerning the workings of machines, masonry, or geology, you are likely to find a healthy supply of jargon using **Zaliac**, the most popular [dwarf](../ancestry/dwarf.md) language. Even when such texts aren't fully written in Zaliac, they use a lot of [dwarf](../ancestry/dwarf.md) language when describing esoteric, complex ideas.
...
In the same way that intelligent creatures in [Orden](../rule/world/orden.md) who live near or trade with other cultures use Caelian as a common language, the denizens of the World Below, the Dark Under All, often speak **Variac**, the language of the voiceless talkers.
...
The Dead Languages table shows some of the dead languages of [Orden](../rule/world/orden.md), and the modern languages related to those ancient languages.
...
| Rallarian      | Steel [dwarf](../ancestry/dwarf.md)                | Zaliac             | Valiar, the truemetal                  |
...
Some careers increase your starting [Wealth](../rule/resource/wealth.md) score (from a base score of 1). See [Wealth](../rule/resource/wealth.md) in Chapter 13: [Rewards](rewards.md) for more information.

#### Project Points {data-scc="mcdm.heroes.v1/rule.downtime/project-points"}

Some careers provide [project points](../rule/downtime/project-points.md) you can put toward crafting and [research projects](../rule/downtime/research-project.md) (see Chapter 12: [Downtime Projects](downtime-projects.md)). These [project points](../rule/downtime/project-points.md) can be divided among multiple projects, but they can't be used more than once. You must meet the other prerequisites for a project to start it, as usual.

At the Director's discretion, your career might also let you start the game with the materials needed for one or more projects, so you can immediately put your [project points](../rule/downtime/project-points.md) toward those projects—possibly before the adventure begins! This is especially useful for characters who are going on only one adventure. Otherwise, you can hold onto the points and spend them once you do start a project.
...
**Skills:** The [Sneak](../skill/intrigue/sneak.md) skill from the [intrigue skill group](../skill/intrigue/intrigue.md), plus one skill from the [interpersonal group](../skill/interpersonal/interpersonal.md) and one other skill from the [intrigue group](../skill/intrigue/intrigue.md) (*Quick Build:* [Disguise](../skill/intrigue/disguise.md), [Lie](../skill/interpersonal/lie.md), [Sneak](../skill/intrigue/sneak.md).)
...
**Skills:** One skill from the [interpersonal skill group](../skill/interpersonal/interpersonal.md) and one skill from the [lore group](../skill/lore/lore.md) (*Quick Build:* [Brag](../skill/interpersonal/brag.md), [Society](../skill/lore/society.md).)
...
| 2  | **Charmed Life:** Whether through some [supernatural](../rule/general/supernatural.md) power or your innate persuasiveness, you were able to defraud other aristocrats. You did it for fun. And when you were found out, you lost your status. Whether you served time or escaped punishment, you decided to rehabilitate yourself and became a hero. |
...
**Skills:** Two skills from the [crafting skill group](../skill/crafting/crafting.md) (*Quick Build:* [Blacksmithing](../skill/crafting/blacksmithing.md), [Carpentry](../skill/crafting/carpentry.md).)

**Languages:** One language

**[Project Points](../rule/downtime/project-points.md):** 240
...
| 3  | **Robbery:** A [criminal](../career/criminal.md) gang stole your goods and harmed a number of people who worked for you. You became a hero to prevent such indignities from being visited upon others, to seek revenge for the assault, or to find the thieves and get your stuff back. |
| 4  | **Stolen Passions:** Your parents discouraged your artistic [talents](../class/talent.md), instead trying to focus your passions on the family business. You refused to dim your spark and continued your work in secret. Enraged at discovering your disobedience, they sold your work to a traveling merchant. You left your hometown, seeking your lost art and encouraging others to live freely. |
...
**Skills:** The [Rumors](../skill/lore/rumors.md) skill (from the [lore skill group](../skill/lore/lore.md)), plus one skill from the [exploration group](../skill/exploration/exploration.md) and one skill from the [interpersonal group](../skill/interpersonal/interpersonal.md) (*Quick Build:* [Empathize](../skill/interpersonal/empathize.md), [Endurance](../skill/exploration/endurance.md), [Rumors](../skill/lore/rumors.md).)
...
- Who was your nemesis while you were a [criminal](../career/criminal.md)?

You gain the following career benefits:

**Skills:** The [Criminal Underworld](../skill/lore/criminal-underworld.md) skill (from the [lore skill group](../skill/lore/lore.md)), plus two skills from the [intrigue group](../skill/intrigue/intrigue.md) (*Quick Build:* [Criminal Underworld](../skill/lore/criminal-underworld.md), Pick Lock, Pick Pocket.)
...
| 2  | **Atonement:** The last [criminal](../career/criminal.md) job you pulled led to the death of someone or the destruction of something you love. To make up for the loss you caused, you left your [criminal](../career/criminal.md) ways behind and became a hero. |
...
- What gods or [saints](../rule/world/saint.md) did your institution venerate?
...
**Skills:** The [Religion](../skill/lore/religion.md) skill (from the [lore skill group](../skill/lore/lore.md)), plus two more skills from the [lore group](../skill/lore/lore.md) (*Quick Build:* [Culture](../skill/lore/culture.md), [Magic](../skill/lore/magic.md), [Religion](../skill/lore/religion.md).)
...
**Skills:** The [Navigate](../skill/exploration/navigate.md) skill (from the [exploration skill group](../skill/exploration/exploration.md)), plus two more skills from the [exploration group](../skill/exploration/exploration.md) (*Quick Build:* [Climb](../skill/exploration/climb.md), [Heal](../skill/exploration/heal.md), [Navigate](../skill/exploration/navigate.md).)
...
| 4  | **Unschooled:** You delved into dungeons and far-off places by studying them in books. You were an [explorer](../career/explorer.md) who never felt the need to experience the dangers your peers did. Then your theory about a lost world cost you your reputation, and gave you the impetus to go on adventures and stand up for those with different ideas. |
...
**Skills:** Two skills from the [exploration skill group](../skill/exploration/exploration.md) (*Quick Build:*  [Gymnastics](../skill/exploration/gymnastics.md), [Jump](../skill/exploration/jump.md).)
...
| 5  | **Shining Light:** You kept a lighthouse along the constantly stormy cliffs of your village with your mentor. On a clear and sunny day, your mentor vanished. Finding only a cryptic notebook filled with his musings on the [supernatural](../rule/general/supernatural.md), you left to find out what really happened. The trail has gone cold for now, and you're helping others find their loved ones in the meantime. |
...
| 6  | **Ultimate Power:** The mage you worked for was a kindly old soul, but the basic magic they taught you always seemed like a small part of something bigger. It wasn't until you met an adventuring [elementalist](../class/elementalist.md) that you realized hitting the road as a hero was the only way to truly improve and hone your skills. You resigned your apprenticeship and found yourself walking the path of a hero the next day. |
...
**Skills:** Two skills from the [interpersonal skill group](../skill/interpersonal/interpersonal.md) (*Quick Build:* [Lead](../skill/interpersonal/lead.md), [Lie](../skill/interpersonal/lie.md).)
...
**Skills:** Two skills from the [lore skill group](../skill/lore/lore.md) (*Quick Build:* [History](../skill/lore/history.md), [Magic](../skill/lore/magic.md).)
...
**Deserter:** It was in the middle of a pirate raid (whether you were part of it or targeted by it) that you realized you no longer yearned for a [sailor's](../career/sailor.md) life. You used the chaos of the moment to slip away unnoticed. You now work as a hero in an effort to either end the piracy of others or atone for your past deeds, but you fear the day your old crew finds you and punishes you for your desertion.
...
**Skills:** One skill from the [exploration skill group](../skill/exploration/exploration.md) and one skill from the [intrigue group](../skill/intrigue/intrigue.md) (*Quick Build:* [Alertness](../skill/intrigue/alertness.md), [Endurance](../skill/exploration/endurance.md).)
...
| 2  | **Out of Retirement:** You had a long and storied career as a [soldier](../career/soldier.md) before deciding to retire to a simpler life. But when you returned to your old home, you found your enemies had laid waste to it. Now the skills you earned on the battlefield are helping you as you become a different kind of warrior one seeking to save others from the fate you suffered. |
...
| 4  | **Sole Survivor:** You were the last surviving member of your unit after an arduous battle or monstrous assault, surviving only through luck. You turned away from the life of a [soldier](../career/soldier.md) then, seeking to become a hero who could stand against such threats. | 
...
**Skills:** Nature (from the [lore skill group](../skill/lore/lore.md)), plus one skill from the [exploration group](../skill/exploration/exploration.md) and one skill from the [intrigue group](../skill/intrigue/intrigue.md) (*Quick Build:*  [Nature](../skill/lore/nature.md), Navigate, Track.)
...
| 4  | **Honor the Fallen:** A group of heroes arrived in your territory with trouble close on their heels. You fought alongside them to [turn](../rule/combat/turn.md) back the evil, but it was too much. The heroes fell, and your wilderness was forever altered. Though your lands are beyond saving, there are other lands you can help. |
...
- What [criminal](../career/criminal.md) still eludes your grasp to this day?
...
| 5  | **One That Got Away:** A violent or depraved [criminal](../career/criminal.md) began targeting you- perhaps stealing something personal or hurting someone you love—after slipping through your grasp. You left your career to pursue the [criminal](../career/criminal.md), but the trail has gone cold... for now. [Might](../rule/character/might.md) as well help folk in the meantime. |
