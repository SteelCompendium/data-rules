...
The [Arcane Archer](../kit/arcane-archer.md) kit allows you to combine magic and [ranged](../rule/combat/ranged.md) weapon [strikes](../rule/combat/strike.md). Your lack of armor keeps you mobile, and your magic makes your arrows explode to devastate your foes.
...
Who says lightly armored heroes can't also be hard to move? You just need to employ some psionics! The [Battlemind](../kit/battlemind.md) kit harnesses the power of your mind to make you harder to move—and to make your foes easier to push around.
...
If you want to be fast in a fight, then [Martial Artist](../kit/martial-artist.md) is the kit for you. Unencumbered by weapons or armor, this fighting style rewards quick, focused unarmed [strikes](../rule/combat/strike.md) against opponents, and allows you to be the ultimate skirmisher.
...
The [Raider](../kit/raider.md) kit keeps you protected while granting you full mobility, providing a boost to [speed](../rule/character/speed.md) and [distance](../rule/combat/distance.md) that lets you run around the battlefield like a Viking warrior.
...
The [Ranger](../kit/ranger.md) kit outfits you with medium armor and weapons for every challenge, letting you easily switch between [melee](../rule/combat/melee.md) and [ranged](../rule/combat/ranged.md) combat. This kit provides a good balance of [bonus](../rule/dice/bonuses-and-penalties.md)es to defense and offense to create a hero who is a jack-of-all-trades.
...
The [retiarius](../kit/retiarius.md) is often depicted as a lightly armored warrior with a net in one hand and a trident in the other, and this kit gives you the equipment and fighting technique to make that happen. Tie up your foe with a net and then poke them to death!
...
The [Shining Armor](../kit/shining-armor.md) kit provides the most protection a kit can afford, providing you with the sword, shield, and armor necessary to play the prototypical knight.
...
The [Sniper](../kit/sniper.md) kit gives you the tools and techniques to take down enemies from afar. This kit can help you become the archer who lurks behind trees or down tunnels, picking off enemies with a bow or crossbow as they approach.
...
The [Spellsword](../kit/spellsword.md) kit combines [melee](../rule/combat/melee.md) [strikes](../rule/combat/strike.md) and a little bit of magic, letting you create a warrior who doesn't have to choose between the incantation and the blade.
...
Armed with a simple reach weapon, often a quarterstaff, a character using the [Stick and Robe](../kit/stick-and-robe.md) kit is highly mobile thanks to their light armor. This allows your hero to make maximum use of their weapon's length.
...
If you want to be mobile and deal a lot of damage with [melee](../rule/combat/melee.md) [strikes](../rule/combat/strike.md), then you should reach for the [Swashbuckler](../kit/swashbuckler.md) kit. This is a great kit for heroes who want to be master duelists.
...
The [Sword and Board](../kit/sword-and-board.md) kit doesn't just give you a shield—it makes the shield part of your offensive arsenal. With a medium weapon in one hand and a block of steel or solid oak in the other, you protect yourself while you control the battlefield.
...
The [Whirlwind](../kit/whirlwind.md) kit makes effective use of whips, granting you mobility, damage, and reach. If you want to be a fast-moving warrior who lashes foes with a chain or whip, then this is the kit for you.
...
| [Retiarius](../kit/retiarius.md)        | Light          | Ensnaring, polearm | +3                  | +1    | -         | +2/+2/+2     | -             | +1             | -               | +1        |
| [Shining Armor](../kit/shining-armor.md)    | Heavy, shield  | Medium             | +12                 | -     | +1        | +2/+2/+2     | -             | -              | -               | -         |
| [Sniper](../kit/sniper.md)           | None           | Bow                | -                   | +1    | -         | -            | +0/+0/+4      | -              | +10             | +1        |
| [Spellsword](../kit/spellsword.md)       | Light, shield  | Medium             | +6                  | +1    | +1        | +2/+2/+2     | -             | -              | -               | -         |
| [Stick and Robe](../kit/stick-and-robe.md)   | Light          | Polearm            | +3                  | +2    | -         | +1/+1/+1     | -             | +1             | -               | +1        |
| [Swashbuckler](../kit/swashbuckler.md)     | Light          | Medium             | +3                  | +3    | -         | +2/+2/+2     | -             | -              | -               | +1        |
| [Sword and Board](../kit/sword-and-board.md)  | Medium, shield | Medium             | +9                  | -     | +1        | +2/+2/+2     | -             | -              | -               | +1        |
| [Warrior Priest](../kit/warrior-priest.md)   | Heavy          | Light              | +9                  | +1    | +1        | +1/+1/+1     | -             | -              | -               | -         |
| [Whirlwind](../kit/whirlwind.md)        | None           | Whip               | -                   | +3    | -         | +1/+1/+1     | -             | +1             | -               | +1        |
