...
**Benefit and Drawback:** As a respite activity, you can study the notebook. Make a test using your highest [characteristic](../rule/character/characteristic.md) score:
...
**Drawback:** While you have fewer than 3 [antihero](../complication/antihero.md) tokens, you exude a villainous aspect. You and each ally within 5 squares of you take a [bane](../rule/dice/bane.md) on any test made to interact with other creatures.
...
**Benefit:** You escaped with a dowry present—a 1st-echelon trinket of your choice (see Treasures in Chapter 13: [Rewards](rewards.md)).
...
**Drawback:** While [dying](../rule/health/dying.md), you grow and retract uncoordinated limbs at random, imposing a [bane](../rule/dice/bane.md) on your power rolls.
...
**Benefit:** You have 3 destiny points. Whenever you spend your [Heroic Resource](../rule/resource/heroic-resource.md) for your class, you can spend 1 or more destiny points instead. Each time you earn a Victory, you regain 1 destiny point.
...
**Benefit:** You have one skill of your choice from the lore skill group, and you can use the Study Lore project (see below) up to three times for that skill. Each time you use the project, you must use a different project source, and the project goal increases. (See Chapter 12: [Downtime Projects](downtime-projects.md).)
...
> | **📏 Self** |  **🎯 Self** |
>
> **Effect:** Until the end of your turn, whenever you use a damage-dealing heroic ability against a single target, you can weaken that target's life force. The ability deals extra corruption damage equal to your highest [characteristic](../rule/character/characteristic.md) score.
...
**Drawback:** You take a [bane](../rule/dice/bane.md) on any test made to know about anything related to the world where you [crash landed](../complication/crash-landed.md).
...
**Benefit and Drawback:** Whenever you make a test in combat and incur a consequence, you ignore that consequence. Instead, you and each ally adjacent to you [fall prone](../condition/prone.md).
...
**Benefit:** You have a +1 bonus to stability. Additionally, you can use a free maneuver to cause your body, gear, and any items you hold to take on the appearance of stone, making you appear to be a [mundane](../complication/mundane.md) statue while you remain unmoving.
...
**Benefit:** Choose 2 ancestry points' worth of purchased [dragon knight](../ancestry/dragon-knight.md) traits (see Chapter 3: [Ancestries](ancestries.md)). You can use these traits whenever you have 5 or more Victories.
...
**Benefit:** You know one extant language of your choice (see Languages in Orden in Chapter 4: [Background](background.md)).
...
**Benefit:** Choose a heroic ability for your class of a higher level than you currently are. When you take this ability in future, its [Heroic Resource](../rule/resource/heroic-resource.md) cost is permanently reduced by 2 (to a minimum of 1).

**Drawback:** In your quest for advanced techniques, you have neglected the basics. Choose a heroic ability you already know. That ability's [Heroic Resource](../rule/resource/heroic-resource.md) cost is permanently increased by 1.
...
**Benefit:** On your turn, you can choose a heroic ability that you would be able to learn if you were one level higher. Provided you meet the ability's other prerequisites and can spend any required [Heroic Resource](../rule/resource/heroic-resource.md), you can use the ability. Once you use this benefit, you can't do so again until you earn 2 or more Victories.

**Drawback:** While you are [winded](../rule/health/winded.md), you take a −2 penalty to speed.
...
**Benefit:** Whenever an ally within 5 squares is reduced to 0 [Stamina](../rule/health/stamina.md), you can use a triggered action to move up to your speed and make a [free strike](../feature/common/main-actions/free-strike.md).
...
**Drawback:** Whenever you meet an NPC for the first time, the Director can decide that NPC was a victim of one of your previous cons and remembers you. If they do so, the party gains a [hero token](../rule/resource/hero-token.md).
...
**Benefit:** You're determined to stay alive so you can set things right. When your [Stamina](../rule/health/stamina.md) reaches the negative of your [winded](../rule/health/winded.md) value, you can use a free triggered action to spend a [Recovery](../rule/health/recoveries.md).

**Drawback:** Many people blame you for the evils you caused. They might be unfriendly or hostile to you—and you can understand their point of view. You take a [bane](../rule/dice/bane.md) on any test made to interact with those who know what you did, and on [strikes](../rule/combat/strike.md) made against such creatures.
...
**Drawback:** You have fire weakness 5. Additionally, you take a [bane](../rule/dice/bane.md) on any test made to read a humanoid creature's emotions or body language.
...
**Benefit:** Whenever you are present for a battle in which both sides have creatures who aren't surprised, your side determines who goes first if the d10 roll is a 4 or higher (see Combat Round in Chapter 10: [Combat](combat.md)).
...
**Drawback:** The Director chooses one of the skills you have from this complication. You lose that skill and can't ever learn it again. Additionally, you take a [bane](../rule/dice/bane.md) on any test to which that skill would apply.
...
**Benefit:** Choose another creature who doesn't have the [Lifebonded](../complication/lifebonded.md) complication. When you die, your body disappears until that creature finishes a respite or earns 1 or more Victories. You then appear next to the creature, fully healed.
...
**Benefit:** Choose a [damage type](../rule/damage/damage-type.md) from acid, cold, corruption, fire, holy, lightning, poison, psychic, or sonic. Whenever you use a signature ability, you can have it deal your chosen [damage type](../rule/damage/damage-type.md) instead of its usual damage.
...
**Benefit:** You have a retainer, in addition to any followers you acquire through Renown or other means. As usual, you can have only one retainer in your service at a time. (See Renown in Chapter 13: [Rewards](rewards.md) and Retainers in *Draw Steel: Monsters*).
...
> | **📏 Self** |     **🎯 Self** |
>
> **Power Roll + [Intuition](../rule/character/intuition.md) or [Presence](../rule/character/presence.md):**
>
...
>
> **Effect:** If any sapient creatures have died nearby within the last 24 hours, you have a double [bane](../rule/dice/bane.md) on the power roll for this ability if any of those creatures were hostile to you, or a double [edge](../rule/dice/edge.md) if any of them were friendly to you. When you use this ability, you can't do so again until you earn 1 or more Victories.
...
**Benefit and Drawback:** When you reveal your appearance to creatures who don't know you personally, you gain an [edge](../rule/dice/edge.md) on any test involving those creatures where the [Brag](../skill/brag.md) or [Intimidate](../skill/intimidate.md) skill could be applied, but you take a [bane](../rule/dice/bane.md) on any test where the [Flirt](../skill/flirt.md), Lead, or [Persuade](../skill/persuade.md) skill could be applied.
...
**Drawback:** Whenever you carry more than three magic treasures, you take a [bane](../rule/dice/bane.md) on power rolls.
...
**Benefit:** You have one skill of your choice from the crafting skill group. Additionally, choose one of your skills from the crafting group. You gain an [edge](../rule/dice/edge.md) on any test that uses that skill.

**Drawback:** Whoever killed your mentor cursed you. You take a [bane](../rule/dice/bane.md) on any test that doesn't use one of your skills.
...
**Benefit:** You have the Handle Animals skill (from the interpersonal skill group). Additionally, choose a type of animal related to the animals who helped you, such as wolf. You gain an [edge](../rule/dice/edge.md) on tests that use the Handle Animals skill when interacting with animals of this type. You can also communicate with animals of this type as if you shared a language, and animals of this type aren't initially hostile to you unless they're supernaturally compelled to be.
...
**Drawback:** Your [rival](../complication/rival.md) has similar statistics to yours, but always had one skill they excelled at, as determined by the Director. Intimidated by their prowess, you take a [bane](../rule/dice/bane.md) on tests using that skill.
...
>
> **Power Roll + [Might](../rule/character/might.md), [Intuition](../rule/character/intuition.md), or [Presence](../rule/character/presence.md):**
>
> - **≤11:** Push or pull 1
...
**Benefit:** Choose a type of monster connected to your homeland's plight, such as a vampire, ghost, or medusa. You have a +1 bonus to saving throws related to that monster's abilities, and you treat your [characteristic](../rule/character/characteristic.md) scores as 1 higher than usual for the purpose of resisting potencies related to those abilities.
...
**Benefit:** You know one language of your choice. Additionally, you have one leveled treasure of your choice (see Treasures in Chapter 13: [Rewards](rewards.md)).
...
**Drawback:** Visions of your dead sibling haunt you at night. Whenever you take a respite, make an [Intuition](../rule/character/intuition.md) test that can't make use of any skill. On a tier 1 or tier 2 outcome, you regain 1 fewer [Recoveries](../rule/health/recoveries.md) than usual when you finish the respite.
...
**Benefit:** You can spend 5 uninterrupted minutes to rearrange your face to resemble the face of another creature of your ancestry who you've observed before. You have a double [edge](../rule/dice/edge.md) on tests made to impersonate that creature or to disguise your identity. You are unable to change your hair or other nonfacial features.
...
**Benefit:** Each time your party reaches 2, 4, and 6 Victories, you earn the party a [hero token](../rule/resource/hero-token.md).
...
**Drawback:** While you have [temporary Stamina](../rule/health/temporary-stamina.md) from this complication, you grow visible fangs, you take a [bane](../rule/dice/bane.md) on [Presence](../rule/character/presence.md) tests made to interact with humanoids, and your vampire progenitor can sense your location.
...
You broke a magic amulet, immersing your mind in weird energy that granted you the power of premonition. However, you struggle to control this new gift. Whenever you take a respite, make a [Reason](../rule/character/reason.md) test to determine whether you gain this complication's benefit or drawback.
