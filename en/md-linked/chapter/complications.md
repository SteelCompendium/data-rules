...
**Benefit:** As a maneuver, you take the form of a specific animal of size 1T. You retain all your other statistics aside from your size, but you can't talk or use actions, and the only maneuvers you can use are Escape Grab, Hide, and Stand Up. Based on the animal you can turn into, you might be able to [burrow](../movement/burrow.md) or [fly](../movement/fly.md), or to automatically climb or swim at full speed while moving. If your [animal form](../complication/animal-form.md) doesn't provide such additional movement, you have a +2 bonus to speed.
...
**Drawback:** While you are [dazed](../condition/dazed.md), if you start your turn adjacent to one or more creatures, you must use your main action to make a melee free strike against an adjacent creature.
...
>
> **Special:** If you have the Strike Now [tactician](../class/tactician.md) ability, the target can use a free triggered action instead of a triggered action to gain the benefit of this ability.
