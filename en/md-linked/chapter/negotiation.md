...
During negotiation, the Director assigns [NPCs](../rule/general/npc.md) four temporary statistics and features—interest, patience, motivations, and pitfalls. The heroes can strike a favorable deal if they maximize an [NPC](../rule/general/npc.md)'s interest by making arguments that invoke the [NPC](../rule/general/npc.md)'s motivations and avoid their pitfalls—but they have to do all that before the [NPC](../rule/general/npc.md)'s patience wears out.
...
Each motivation can be successfully appealed to only once during a negotiation. To successfully appeal to a motivation, the heroes must use the motivation in an argument without mentioning one of the [NPC](../rule/general/npc.md)'s pitfalls or being caught in a lie.

#### Pitfalls {data-scc="mcdm.heroes.v1/rule.negotiation/pitfall"}

Pitfalls are motivations that spark ire, discomfort, shame, fear, or some other negative response in an [NPC](../rule/general/npc.md). Using a pitfall in an argument causes an [NPC](../rule/general/npc.md)'s interest and patience to wane. Each [NPC](../rule/general/npc.md) has at least one pitfall, and many have at least two.

Pitfalls and motivations are two sides of the same concept. They're presented below as a single list, because what might be a motivation for one [NPC](../rule/general/npc.md) is a pitfall for another. Whenever the heroes make an argument, they risk stumbling into one of an [NPC](../rule/general/npc.md)'s pitfalls unless they do their research beforehand or read the [NPC](../rule/general/npc.md) well.

#### List of Motivations and Pitfalls

An [NPC](../rule/general/npc.md) can have any of the following twelve motivations or pitfalls.

##### Benevolence {data-scc="mcdm.heroes.v1/negotiation/benevolence"}

An [NPC](../rule/general/npc.md) with the [benevolence](../negotiation/benevolence.md) motivation believes in sharing what they have with others. However, an [NPC](../rule/general/npc.md) involved in a negotiation must be limited in their benevolence, so that they don't just give the heroes what they need.
...
An [NPC](../rule/general/npc.md) with the [benevolence](../negotiation/benevolence.md) pitfall has a cynical view of the world, believing that no creature has a right to anything just by being alive. The idea of helping others because it's the right thing to do is a preposterous, immature, or inexperienced idea to be laughed off or snuffed out.

Arguments that appeal to a [benevolence](../negotiation/benevolence.md) motivation contend that if the [NPC](../rule/general/npc.md) strikes a deal with the heroes, the people the [NPC](../rule/general/npc.md) cares about will benefit from the deal. Example arguments include the following:
...
An [NPC](../rule/general/npc.md) with the [discovery](../negotiation/discovery.md) pitfall has no interest in finding new places, peoples, or ideas. It might be that the unknown scares them or makes them so uncomfortable that they'd rather remain ignorant. Alternatively, a previous pursuit of discovery might have turned out poorly for them.

Arguments that appeal to a [discovery](../negotiation/discovery.md) motivation contend that striking a deal with the heroes will allow the [NPC](../rule/general/npc.md) to gain new knowledge or acquire unique property. Example arguments include the following:
...
An [NPC](../rule/general/npc.md) with the [freedom](../negotiation/freedom.md) motivation wants no authority above them and desires no authority over others. They might already have personal freedom and wish to maintain that status quo, or they might wish to liberate themself or others from someone else's authority.

An [NPC](../rule/general/npc.md) with the [freedom](../negotiation/freedom.md) pitfall believes that a world without authority is one in turmoil and chaos. They might even believe that they are the right person to rule, and that their ideals should be the ones that become the law of the land.

Arguments that appeal to a freedom motivation contend that by helping the heroes, an [NPC](../rule/general/npc.md) will maintain or grant freedom to themself or other people. Example arguments include the following:
...
An [NPC](../rule/general/npc.md) with the [greed](../negotiation/greed.md) pitfall has no interest in accumulating wealth or other resources, and becomes offended if anyone tries to buy their partnership. They hold their ideals above material desires.

Arguments that appeal to a greed motivation contend that helping the heroes will increase the [NPC](../rule/general/npc.md)'s wealth or assets. Example arguments include the following:
...
An [NPC](../rule/general/npc.md) with the [higher authority](../negotiation/higher-authority.md) pitfall scoffs at the idea of serving another. The [NPC](../rule/general/npc.md) might not believe that all people should be free, but they certainly believe that they personally shouldn't have to answer to anyone.
...
An [NPC](../rule/general/npc.md) with the [justice](../negotiation/justice.md) motivation wants to see the righteous rewarded and the wicked punished, however subjective their sense of who or what is good and evil. A priest who venerates a god of nature might believe that all who protect plants and animals are righteous, and that those who harvest natural resources as miners and lumberjacks do must die. Having a justice motivation doesn't necessarily make an [NPC](../rule/general/npc.md) kind or charitable.

An [NPC](../rule/general/npc.md) with the [justice](../negotiation/justice.md) pitfall doesn't believe that the timescape is an inherently just place, and has no interest in making it one. The world is eternal conflict, there is no such thing as justice, and anyone who thinks otherwise is a naive fool.

Arguments that appeal to a justice motivation position the heroes on the good side of an [NPC](../rule/general/npc.md)'s sense of right and wrong. Example arguments include the following:
...
An [NPC](../rule/general/npc.md) with a [legacy](../negotiation/legacy.md) pitfall cares nothing about leaving a personal mark on the world. To them, such vain thinking is nothing but a waste of time.

Arguments that appeal to a [legacy](../negotiation/legacy.md) motivation contend that striking a deal with the heroes increases the likelihood that people will talk about the [NPC](../rule/general/npc.md) for centuries to come. Example arguments include the following:
...
An [NPC](../rule/general/npc.md) with the [peace](../negotiation/peace.md) motivation wants calm in their life. Under typical circumstances, they want to be left alone to run their business, farm, kingdom, criminal empire, or whatever small slice of the timescape is theirs. Some such [NPCs](../rule/general/npc.md) don't have peace and need help obtaining it, while others want their peaceful status quo to be maintained.

An [NPC](../rule/general/npc.md) with the [peace](../negotiation/peace.md) pitfall hates being bored. They want excitement, drama, and danger in their life. For them, there's nothing worse than the status quo.

Arguments that appeal to a peace motivation contend that helping the heroes will earn the [NPC](../rule/general/npc.md) some peace, at least for a little while. Example arguments include the following:
...
An [NPC](../rule/general/npc.md) with the [power](../negotiation/power.md) motivation covets the authority of others. They want to increase their influence, no matter how great it already is, and maintain their domain. They might seek power through conquering others, the collection of artifacts, or through the infusion of supernatural rituals—though why choose one method when all three together achieve the best results? Some such [NPCs](../rule/general/npc.md) are world-traversing tyrants, but the petty administrators of village organizations and shrines can covet power just as hungrily.

An [NPC](../rule/general/npc.md) with the [power](../negotiation/power.md) pitfall has no interest in authority for themself. They might respect the authority of others, but they hate the thought of ruling over other people and roundly reject any suggestion of the idea.

Arguments that appeal to a power motivation contend that working with the heroes will increase or protect the [NPC](../rule/general/npc.md)'s power. Example arguments include the following:
...
An [NPC](../rule/general/npc.md) with the [protection](../negotiation/protection.md) motivation has land, people, information, items, or an organization they want protected above all else. Keeping

their charge safe is a duty they hold dear, and aiding in that protection earns their favor. Most people have friends or family they wish to protect, but an [NPC](../rule/general/npc.md) with the [protection](../negotiation/protection.md) motivation believes in doing so at any cost.

An [NPC](../rule/general/npc.md) with the [protection](../negotiation/protection.md) pitfall is happy to leave others to fend for themselves. They don't believe it's their responsibility to protect anyone other than themself, and might be outright disgusted at the thought of risking their life or their property to protect others.

Arguments that appeal to a protection motivation contend that helping the heroes allows an [NPC](../rule/general/npc.md) to better protect their charge. Example arguments include the following:
...
An [NPC](../rule/general/npc.md) with the [revelry](../negotiation/revelry.md) motivation just wants to have fun. They enjoy socializing at parties, thrill-seeking, or indulging in other hedonistic activities. Getting pleasure out of life while spending time with people they like is paramount to such [NPCs](../rule/general/npc.md).

An [NPC](../rule/general/npc.md) with the [revelry](../negotiation/revelry.md) pitfall sees social encounters and hedonism as a waste of time. They take pleasure only in work or in building their own skills and character. Others who suggest immature debauchery are not worth their time.

Arguments that appeal to the [revelry](../negotiation/revelry.md) motivation contend that striking a deal with the heroes will allow the [NPC](../rule/general/npc.md) to get back to reveling sooner, longer, or harder. Example arguments include the following:
...
An [NPC](../rule/general/npc.md) with the [vengeance](../negotiation/vengeance.md) motivation wants to harm another who has hurt them. Their desire for revenge could be proportional to the harm that was inflicted upon them, or they might wish to pay back their pain with interest. In some cases, a desire for vengeance can be satisfied only by the death of another, but an [NPC](../rule/general/npc.md) might wish to pay back their own suffering with embarrassment, career failure, or some other less permanent pain.

An [NPC](../rule/general/npc.md) with the [vengeance](../negotiation/vengeance.md) pitfall believes that revenge solves nothing. They might have gained this belief firsthand, or they might simply not have the ambition to seek revenge—and they take a dim view of others who do.

Arguments that appeal to the [vengeance](../negotiation/vengeance.md) motivation contend that the [NPC](../rule/general/npc.md) can gain payback for their pain by helping the heroes. Example arguments include the following:
...
>
> Just like the heroes, [NPCs](../rule/general/npc.md) in negotiations are complex individuals who can change over time. It's possible that the heroes might have to negotiate with the same [NPC](../rule/general/npc.md) for several different favors during the course of a campaign, over which time the [NPC](../rule/general/npc.md)'s motivations and pitfalls might change. If the heroes turn a bandit captain with the [greed](../negotiation/greed.md) and [power](../negotiation/power.md) motivations into a temporary ally, that criminal might learn from them, changing their ways to rob only those who exploit the poor and giving those earnings to people in need. The next time the heroes negotiate with the bandit captain, they have the [benevolence](../negotiation/benevolence.md) and [protection](../negotiation/protection.md) motivations.
...
The Director can decide that an [NPC](../rule/general/npc.md) who has something the players want could show up at their door and ask if the heroes want to negotiate. But it's always okay for the characters to say, "Not interested," and refuse to do so.
...
An [NPC](../rule/general/npc.md)'s starting negotiation stats depend on their attitude toward the heroes, as shown on the Negotiation Starting Attitudes table, and can be adjusted by the Director as they see fit. A naturally irascible [NPC](../rule/general/npc.md) might have lower patience, while a hostile [NPC](../rule/general/npc.md) with a greater-than-expected stake in the negotiation topic might have a higher-than-typical interest.

### Uncovering Motivations

If a hero wishes to figure out an [NPC](../rule/general/npc.md)'s motivations, they can begin by simply asking, "What do you want out of this deal?" In response, the
...
[NPC](../rule/general/npc.md) can willingly hint at or reveal one of their motivations, usually by asking for something. For instance, a monarch [NPC](../rule/general/npc.md) with the [greed](../negotiation/greed.md) motivation and a penchant for collecting rare animals might suggest that the heroes retrieving a griffon egg would earn the monarch's gratitude. The Director can also decide that during the natural course of the negotiation, the [NPC](../rule/general/npc.md) might offer up similar suggestions without the heroes asking, provided the [NPC](../rule/general/npc.md) already has an interest of 3 or higher.

If an [NPC](../rule/general/npc.md) isn't as forthcoming, or if the heroes want to learn one of the [NPC](../rule/general/npc.md)'s pitfalls, a hero can make a [Reason](../rule/character/reason.md), [Intuition](../rule/character/intuition.md), or [Presence](../rule/character/presence.md) [test](../rule/test/test.md) while interacting with the [NPC](../rule/general/npc.md) during the negotiation, based on the tactics used to draw out the [NPC](../rule/general/npc.md). The [test](../rule/test/test.md) has the following outcomes:
...
- **≤11:** The hero learns no information regarding the [NPC](../rule/general/npc.md)'s motivations or pitfalls, and the [NPC](../rule/general/npc.md) realizes the hero is trying to read them and becomes annoyed. As a consequence, the [NPC](../rule/general/npc.md)'s patience is reduced by 1.
- **12-16:** The hero learns no information regarding the [NPC](../rule/general/npc.md)'s motivations or pitfalls.
- **17+:** The hero learns one of the [NPC](../rule/general/npc.md)'s motivations or pitfalls (their choice).

After this [test](../rule/test/test.md) is made, the heroes can't make another [test](../rule/test/test.md) to determine the same [NPC](../rule/general/npc.md)'s motivations or pitfalls until they make an argument to the [NPC](../rule/general/npc.md) or the negotiation ends.

#### Outside of Negotiation

While the heroes can discover an [NPC](../rule/general/npc.md)'s motivations or pitfalls through [tests](../rule/test/test.md) made during negotiation, they can employ other methods of investigating motivations or pitfalls before negotiation. Research or a little reconnaissance (for instance, reading the [NPC](../rule/general/npc.md)'s diary or talking to their closest friends) can reveal quite a bit about a person!
...
If an argument doesn't include a pitfall and appeals to one of the [NPC](../rule/general/npc.md)'s motivations that hasn't already been appealed to, the hero making the argument can make an medium [test](../rule/test/test.md) to attempt to sway the [NPC](../rule/general/npc.md) with the argument. Depending on the argument, this can be a [Reason](../rule/character/reason.md), [Intuition](../rule/character/intuition.md), or [Presence](../rule/character/presence.md) [test](../rule/test/test.md) using any applicable skill—most commonly a skill from the interpersonal skill group. The [test](../rule/test/test.md) has the following outcomes:

**[Power Roll](../rule/dice/power-roll.md) + [Reason](../rule/character/reason.md), [Intuition](../rule/character/intuition.md), or [Presence](../rule/character/presence.md):**

- **≤11:** The [NPC](../rule/general/npc.md)'s patience decreases by 1.
- **12-16:** The [NPC](../rule/general/npc.md)'s interest increases by 1, and their patience decreases by 1.
- **17+:** The [NPC](../rule/general/npc.md)'s interest increases by 1, and their patience doesn't change.
...
If the heroes attempt to appeal to a motivation that's already been appealed to, the [NPC](../rule/general/npc.md)'s interest remains the same and their patience decreases by 1.

> **Appealing to Multiple Motivations**
>
> If a hero makes an argument that appears to appeal to more than one of an [NPC](../rule/general/npc.md)'s motivations, the Director can ask for clarification. After listing the motivations it seemed as though the player was trying to appeal to, they can ask the player to pick one from the list. If the player had another motivation in mind, it's up to the Director whether the argument appealed to that specific motivation or not.

#### No Motivation or Pitfall

If an argument doesn't include one of the [NPC](../rule/general/npc.md)'s motivations or pitfalls, the hero who makes the argument must make a more difficult [test](../rule/test/test.md) to appeal to the [NPC](../rule/general/npc.md). The [test](../rule/test/test.md) has the following outcomes:

**[Power Roll](../rule/dice/power-roll.md) + [Reason](../rule/character/reason.md), [Intuition](../rule/character/intuition.md), or [Presence](../rule/character/presence.md):**

- **≤11:** The [NPC](../rule/general/npc.md)'s patience decreases by 1, and their interest decreases by 1.
- **12-16:** The [NPC](../rule/general/npc.md)'s patience decreases by 1.
- **17+:** The [NPC](../rule/general/npc.md)'s interest increases by 1, and their patience decreases by 1.

**Effect:** On a [natural 19 or 20](../rule/dice/natural-19-20.md), the [NPC](../rule/general/npc.md)'s patience remains the same.

If the heroes try to use the same argument without a pitfall or motivation twice, the [test](../rule/test/test.md) automatically obtains a tier 1 outcome.

#### Caught in a Lie

If a hero lies to an [NPC](../rule/general/npc.md) with an argument that fails to increase the [NPC](../rule/general/npc.md)'s interest, the Director can decide that the [NPC](../rule/general/npc.md) catches the lie and is offended by it. The [NPC](../rule/general/npc.md)'s interest decreases by 1, in addition to any decrease imposed by the failure.
...
If an argument uses one of the [NPC](../rule/general/npc.md)'s pitfalls, it automatically fails and the [NPC](../rule/general/npc.md)'s interest and patience each decrease by 1. The [NPC](../rule/general/npc.md) might also warn the heroes not to treat them in such a way again.
...
- An [NPC](../rule/general/npc.md) responds positively if the heroes increase the [NPC](../rule/general/npc.md)'s interest. "That's an excellent point." "You've given me much to consider." "Fair enough." "Makes sense to me."
- An [NPC](../rule/general/npc.md) responds negatively if the heroes decrease their interest. "I don't buy that." "Poppycock!" "I hear you, but I disagree." "That's not going to sway me."
- An [NPC](../rule/general/npc.md) responds with impatience if the heroes fail to increase or decrease their interest. "I've heard that before." "Are you going to offer me anything real?" "This debate is tiresome." "BORING!"
...
The initial response should come with an offer (or a refusal to make an offer) based on the [NPC](../rule/general/npc.md)'s current interest. If a hero's argument reduces an [NPC](../rule/general/npc.md)'s patience to 0, the [NPC](../rule/general/npc.md) lets the heroes know that this is their final offer.

#### Interest 5 ("Yes, and...")

If the [NPC](../rule/general/npc.md)'s interest is 5, they offer everything the heroes initially asked for—and then sweeten the deal. This represents the best possible outcome for the heroes. If they offered to perform any services or make payments as part of the deal, the [NPC](../rule/general/npc.md) might waive those obligations, allowing the heroes to get what they want for free. Alternatively, the [NPC](../rule/general/npc.md) might hold the heroes to any offers they made and instead offer an extra service or item on top of what was asked for.
...
If the [NPC](../rule/general/npc.md)'s interest is 4, they offer the heroes everything they asked for but won't sweeten the deal. The [NPC](../rule/general/npc.md) also accepts anything the heroes have offered as part of the deal with this outcome.

For example, if the heroes offered to help spring a guild thief from prison in exchange for the elite assassins of the thieves' guild standing against Lord Saxton, the guildmaster agrees to those terms without attempting to adjust anything. This likely ends the negotiation, but it's possible that the heroes could push for a little more, provided the [NPC](../rule/general/npc.md) has the patience for another argument. A Director could prompt the heroes to push for more by having the [NPC](../rule/general/npc.md) ask a leading question, such as, "Is there anything else?" or "What else do you want from me?"
...
If the [NPC](../rule/general/npc.md)'s interest is 2, the [NPC](../rule/general/npc.md) can't give the heroes what they want. However, they are willing to offer other less impactful goods or services in exchange for whatever the heroes have promised. The guildmaster might not be willing to spare any troops to fight Lord Saxton, but could instead offer the latest spy reports on Saxton's movements in exchange for the jailbreak.

#### Interest 1 ("No.")

If the [NPC](../rule/general/npc.md)'s interest is 1, they outright reject the heroes' idea without a counteroffer. If the [NPC](../rule/general/npc.md) still has patience, they might press the heroes for a better deal, saying something like, "Why should we risk our necks to help you fight Lord Saxton? What's really in it for the thieves' guild, other than a short, brutal end when you inevitably fail?"

#### Interest 0 ("No, and...")

If an [NPC](../rule/general/npc.md)'s interest is 0, they offer nothing, refuse to negotiate further, and seek to harm the heroes. The [NPC](../rule/general/npc.md) might attack immediately, or they could take a different approach, perhaps spreading malicious rumors about the characters, sending assassins after them, or otherwise making their lives difficult. If the heroes don't want to be at odds with the [NPC](../rule/general/npc.md), they'll need to offer a valuable gift or undertake a quest just to make amends.

It is impossible to continue a negotiation when an [NPC](../rule/general/npc.md)'s interest drops to 0.

### Keep Going or Stop

If an [NPC](../rule/general/npc.md) still has patience after making an offer and their interest is between 1 and 4, the heroes can make another argument to attempt to improve the deal. Alternatively, they can accept the offer and end the negotiation. Let the players drive this decision. You can always have an [NPC](../rule/general/npc.md) show they have patience remaining by asking, "Is there anything else?"

If the [NPC](../rule/general/npc.md)'s patience is 0 or their interest is 5, then the offer the [NPC](../rule/general/npc.md) makes is their final offer to the characters. The heroes can accept the offer or not, but either way, the negotiation ends.

If the [NPC](../rule/general/npc.md)'s interest is 0, the [NPC](../rule/general/npc.md) ends the negotiation without accepting a deal. The heroes can walk away from a negotiation without accepting a deal at any time.
...
**Grace:** *Let's try to avoid any others. Val says, "We're sorry, Zola. We don't want to do anything else to offend you." I'd like to make an [Intuition](../rule/character/intuition.md) [test](../rule/test/test.md) and use my Read Person skill to gauge her reaction and try to discern any other pitfalls.*
...
**Director:** *I think that's a [Reason](../rule/character/reason.md) [test](../rule/test/test.md), since you're using logic to point out that you have a better chance together than on your own. It's easy too, since you're appealing to one of her motivations.*
...
**Director:** *You're appealing to one of her motivations, so make a [Presence](../rule/character/presence.md) [test](../rule/test/test.md).*
