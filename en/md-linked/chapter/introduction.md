...
**Crawl:** A movement mode that allows a [prone](../condition/prone.md) creature to move. A [prone](../condition/prone.md) creature must use 2 squares of movement to crawl 1 square.
...
**Dying:** A state a hero enters when their Stamina is 0 or lower but doesn't reach the negative of their winded value. While dying, a hero is [bleeding](../condition/bleeding.md) and they can't use the Catch Breath maneuver in combat. A hero dies when their Stamina equals the negative of their winded value.
...
**Escape Grab Maneuver:** A maneuver that allows a [grabbed](../condition/grabbed.md) creature to make an ability roll to escape.
...
**Falling:** When a creature falls 2 or more squares, they take 2 damage for each square they fall (to a maximum of 50 damage) and land [prone](../condition/prone.md). A falling creature can reduce the effective height of their fall by a number of squares equal to their Agility score (minimum 0).
...
**Grab Maneuver:** A maneuver that allows a creature to make an ability roll to make another creature [grabbed](../condition/grabbed.md) by them.
...
**[Restrained](../condition/restrained.md):** A condition that reduces a creature's speed to 0 and prevents them from using the Stand Up maneuver or being [force moved](../movement/forced-movement.md).
...
**Saint:** A legendary disciple of a god who can grant [divine power](../feature/trait/conduit/level-10/divine-power.md) to creatures who venerate them.
...
**Stand Up Maneuver:** A maneuver that a [prone](../condition/prone.md) creature can use to end the [prone](../condition/prone.md) condition on themself. Alternatively, a creature can use this maneuver on a willing adjacent [prone](../condition/prone.md) creature to end the [prone](../condition/prone.md) condition on them.
