...
>
> If planning everyone's turn order isn't fun for your group, you can leave it to the dice instead. At the start of combat, have each hero, enemy, and group of enemies make an [Agility](../rule/character/agility.md) [test](../rule/test/test.md), then record the totals. When it's time for someone on the heroes' side to act, the hero with the highest total goes first. On the next hero turn, the hero with the second-highest total takes their turn, and so on. The Director-controlled creatures act the same way. Creatures on the same side should reroll tied [Agility](../rule/character/agility.md) [tests](../rule/test/test.md) to determine who among the tied creatures acts before the others.
>
> At the Director's discretion, a hero can swap their turn in the order with another willing hero at the start of a new combat round. This allows certain abilities that interact with the core turn order system, such as the [shadow's](../class/shadow.md) [Hesitation Is Weakness](../feature/ability/shadow/level-1/hesitation-is-weakness.md) ability, to better work with this alternative system.
...
A free triggered action follows the same rules as a triggered action, but it doesn't count against your limit of one triggered action per round. For instance, a [shadow](../class/shadow.md) hero can use their [Hesitation Is Weakness](../feature/ability/shadow/level-1/hesitation-is-weakness.md) ability to take their turn in response to the trigger of another hero ending their turn. But because that ability is a free triggered action, the [shadow](../class/shadow.md) can still use their In All This Confusion triggered action later in the round.
...
If you are completely beneath the ground while [burrowing](../movement/burrow.md) and are adjacent to another creature who is [burrowing](../movement/burrow.md), you have [line of effect](../rule/combat/line-of-effect.md) to that creature, though you both have [cover](../rule/combat/cover.md) from each other.
...
If you are on the ground and adjacent to a creature who is beneath the ground while [burrowing](../movement/burrow.md), you can use a maneuver to pull that creature up 1 square out of the ground, provided the creature is willing.
...
- If a creature can [teleport](../movement/teleport.md) as part of their usual movement, they can use the [Advance](../feature/common/move-actions/advance.md) move action to [teleport](../movement/teleport.md) a number of squares up to their usual [speed](../rule/character/speed.md), unmodified by conditions or effects.
...
A creature who uses the [Aid Attack](../feature/common/maneuvers/aid-attack.md) maneuver chooses an enemy adjacent to them. The next [ability roll](../rule/dice/ability-roll.md) an ally makes against that enemy before the start of the aiding creature's next turn gains an [edge](../rule/dice/edge.md).
...
Many rules and abilities allow heroes to make [free strikes](../feature/common/main-actions/free-strike.md) when it isn't their turn, such as the [tactician's](../class/tactician.md) Overwatch ability. As well, all characters can make an [opportunity attack](../rule/combat/opportunity-attack.md) [free strike](../feature/common/main-actions/free-strike.md).

#### Granted Abilities

Some abilities, such as the [tactician's](../class/tactician.md) [Strike Now](../feature/ability/tactician/level-1/strike-now.md) or I'll Open and You'll Close abilities, allow another creature to use a [signature ability](../rule/combat/signature-ability.md) or [heroic ability](../rule/general/heroic-ability.md) when it isn't their turn. Unless otherwise stated, a creature can always use a [free strike](../feature/common/main-actions/free-strike.md) instead of a granted [signature ability](../rule/combat/signature-ability.md) or [heroic ability](../rule/general/heroic-ability.md).
...
A melee weapon free strike is a melee [strike](../rule/combat/strike.md) made with an unarmed [strike](../rule/combat/strike.md) or an improvised weapon. A ranged weapon free strike is a ranged [strike](../rule/combat/strike.md) made with an improvised weapon. At the Director's discretion, the [damage type](../rule/damage/damage-type.md) of an improvised weapon can change based on the object used. For example, if you use a burning torch as an improvised weapon, it could deal fire damage when used for a [free strike](../feature/common/main-actions/free-strike.md).
...
When you and one or more allies are adjacent to the same enemy and on opposite sides of the enemy, you are flanking that enemy. While flanking an enemy, you gain an [edge](../rule/dice/edge.md) on melee [strikes](../rule/combat/strike.md) against them.
...
During combat or under similarly stressful circumstances, you can hold your breath for a number of combat rounds equal to your [Might](../rule/character/might.md) score (minimum 1 round). At the end of each combat round after that, you take 1d6 damage while holding your breath.

Out of combat, you can hold your breath for a number of minutes equal to your [Might](../rule/character/might.md) score. Being unable to breathe after that time counts as a stressful condition, causing you to run out of air as above.
