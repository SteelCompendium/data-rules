...
When you use a persistent ability outside of combat (see [Persistent Magic](persistent-magic.md) below), you can maintain it for a number of rounds equal to your [Victories](../../../rule/resource/victories.md).
