...
scc: mcdm.heroes.v1/feature.trait.conduit.level-1/conduit-abilities
type: trait
---
...
**Effect:** Each target can spend a Recovery. Additionally, each target can use a free [triggered action](triggered-action.md) to end one effect on them that is ended by a saving throw or that ends at the end of their turn, or to stand up if [prone](../../../../condition/prone.md).
