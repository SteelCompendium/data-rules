...
scc: mcdm.heroes.v1/feature.trait.shadow.level-2/2nd-level-college-feature
type: trait
---

Your [shadow college](../level-1/shadow-college.md) grants you a feature, as shown on the 2nd-Level College Features table.
...
Additionally, when you use your [I'm No Threat](../../../ability/shadow/level-1/im-no-threat.md) ability, you can take the [Disengage](../../common/move-actions/disengage.md) move action as part of that ability.
