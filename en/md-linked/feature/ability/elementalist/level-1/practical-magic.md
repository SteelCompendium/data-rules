...
- You use the [Knockback](../../../trait/common/maneuvers/knockback.md) maneuver (see Chapter 10: [Combat](../../../../chapter/combat.md)), but its distance becomes the range of your [Hurl Element](hurl-element.md) ability, and you use Reason instead of Might for the power roll.
