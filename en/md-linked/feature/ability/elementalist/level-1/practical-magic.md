...
scc: mcdm.heroes.v1/feature.ability.elementalist.level-1/practical-magic
target: Self
type: ability
---
...
- You use the [Knockback](../../../common/maneuvers/knockback.md) maneuver (see Chapter 10: [Combat](../../../../chapter/combat.md)), but its [distance](../../../../rule/combat/distance.md) becomes the range of your [Hurl Element](hurl-element.md) ability, and you use [Reason](../../../../rule/character/reason.md) instead of [Might](../../../../rule/character/might.md) for the power roll.
- You choose a creature within the [distance](../../../../rule/combat/distance.md) of your [Hurl Element](hurl-element.md) ability and one of the following [damage types](../../../../rule/damage/damage-type.md): acid, cold, corruption, fire, lightning, poison, or sonic. That creature takes damage of the chosen type equal to your [Reason](../../../../rule/character/reason.md) score.
