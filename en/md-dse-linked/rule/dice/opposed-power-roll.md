...
Since opposed power rolls don't use tiers, when you make an opposed power roll, a double [edge](edge.md) provides a +4 bonus to the roll, a double [bane](bane.md) provides a -4 penalty to the roll, an automatic tier increase counts as a +4 bonus to the roll, and an automatic tier decrease counts as a -4 penalty to the roll.
