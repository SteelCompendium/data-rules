...
Players can also be awarded [hero tokens](hero-token.md) as part of a [test](../test/test.md)'s outcome when they succeed on the [test](../test/test.md) with a reward (see [Tests](../../chapter/tests.md)).

#### Spending Hero Tokens

Whenever [hero tokens](hero-token.md) are available, you can spend them in the following ways:

- You can spend a [hero token](hero-token.md) to gain 2 [surges](surge.md), allowing you to increase the [damage](../damage/damage.md) or [potency](../character/potency.md) of an ability. (See [Surges](surge.md) in [Classes](../../chapter/classes.md).)
