---
file_basename: implement
file_dpath: rule/treasure
item_id: implement
item_name: Imbue Implement
name: Imbue Implement
scc: mcdm.heroes.v1/rule.treasure/implement
...
An implement imbued with an [enhancement](enhancement.md) grants you special benefits while it is wielded. Additionally, when an implement receives its 1st-level [enhancement](enhancement.md), it grants your magic or psionic abilities that deal [rolled damage](../damage/rolled-damage.md) a +1 damage [bonus](../dice/bonuses-and-penalties.md). A 5th-level [enhancement](enhancement.md) increases the [bonus](../dice/bonuses-and-penalties.md) to +2, and a 9th-level [enhancement](enhancement.md) increases it to +3. [Censors](../../class/censor.md), [conduits](../../class/conduit.md), [elementalists](../../class/elementalist.md), [nulls](../../class/null.md), [talents](../../class/talent.md), and [troubadours](../../class/troubadour.md) benefit from using implements more than the other classes in this book.
...
**Seeking:** Your [ranged](../combat/ranged.md) magic or psionic abilities gain a +2 [distance](../combat/distance.md) [bonus](../dice/bonuses-and-penalties.md). Additionally, if you think the name of a specific creature, place, or object to the [implement](implement.md), the [implement](implement.md) points toward that target, provided you are on the same world.
...
**[Item Prerequisite](../downtime/item-prerequisite.md):** An [implement](implement.md) with a 1st-level [enhancement](enhancement.md); varies
...
**Warding II:** The [Stamina](../health/stamina.md) [bonus](../dice/bonuses-and-penalties.md) for the Warding I [enhancement](enhancement.md) becomes +12. Additionally, your [characteristic](../character/characteristic.md) scores are treated as 1 higher for the purpose of resisting [potencies](../character/potency.md).
...
**[Item Prerequisite](../downtime/item-prerequisite.md):** An [implement](implement.md) with a 5th-level [enhancement](enhancement.md); varies
...
**Displacing III:** When you use the [implement](implement.md)'s Displacing I [enhancement](enhancement.md), you can [teleport](../../movement/teleport.md) the creature up to 5 squares. Additionally, the creature takes a [bane](../dice/bane.md) on their next [power roll](../dice/power-roll.md) made before the end of their next [turn](../combat/turn.md).
