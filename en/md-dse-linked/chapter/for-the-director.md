...
- During the game, the Director is responsible for how the [NPCs](../rule/general/npc.md) and the environment react to the actions of the heroes. This includes changing and skipping prepared scenes and running new scenes on the fly.
...
*Long before the time of Good King Omund, the lands of [Vasloria](../rule/world/vasloria.md) and all of [Orden](../rule/world/orden.md) belonged to the Caelian Empire. The last emperor, Marcus Octavius, held near-omnipotent power, which he used to protect his citizens and extend the borders of the empire. But his greatest general, Actius Vispania, betrayed him and schemed to usurp the throne.*

*Knowing he had discovered this betrayal too late to stop it, Octavius took his knowledge and his weapons and spread them across [Orden](../rule/world/orden.md), sealing them behind powerful wards. All this was done in secret. Even his closest allies did not know the location of the wards, the number of which is now lost to the mists of time. Were there seven? Nine? Legends differ.*
...
- **Exploration:** How often are the heroes exploring new environments that are difficult to traverse? How often do you expect the heroes to make [tests](../rule/test/test.md) using skills from the [exploration skill group](../skill/exploration/exploration.md)?
- **Interpersonal:** How often are the heroes using negotiation and conversing with [NPCs](../rule/general/npc.md) to overcome challenges? How often do you expect the heroes to make [tests](../rule/test/test.md) using skills from the [interpersonal skill group](../skill/interpersonal/interpersonal.md)?
- **Intrigue:** How often are the heroes solving mysteries, finding double agents, and skulking about the shadows to achieve their goals? How embroiled will they get in the politics of competing people and factions? How often do you expect the heroes to make [tests](../rule/test/test.md) using skills from the [intrigue skill group](../skill/intrigue/intrigue.md)?
...
- **Exploration:** High. The heroes must traverse [Vasloria](../rule/world/vasloria.md)'s most remote locations to find the wards.
- **Interpersonal:** Low. Heroes will likely interact with other [NPCs](../rule/general/npc.md) as they track down leads on wards, but won't have frequent conversations or negotiations with them.
...
Some campaigns include restrictions on the character options players can choose. For example, a Director might be interested in running a game where the heroes are all [memonek](../ancestry/memonek.md) and [time raiders](../ancestry/time-raider.md) who have come to [Vasloria](../rule/world/vasloria.md) searching for a secret incursion of voiceless talkers. In this case, the Director might restrict all ancestries (see Chapter 3: [Ancestries](ancestries.md)) except those two. A campaign about citizens forming a rebellion to take on a tyrannical leader might restrict career options (see Chapter 4: [Background](background.md)) so that no one can take Aristocrat or Politician.
...
Writing your own campaign setting and adventures takes time! Maybe you want to save yourself some of that work and instead run a campaign in an official MCDM setting such as [Vasloria](../rule/world/vasloria.md), using our published adventures that take place in that setting. We also allow third-party publishers to make their own *Draw Steel* settings and adventures, so you might want to use one of those instead.
...
- **[NPC](../rule/general/npc.md)S:** Write the name, ancestry, age, gender, and a brief note on personality for each [NPC](../rule/general/npc.md) the characters might interact with in the locations you've created.
- **Adventure Sites:** Repeat the above two steps for any adventure sites the heroes might visit during their first adventure. Detail the sites, as well as any important [NPCs](../rule/general/npc.md) and villains the heroes might interact with.
...
If you're planning on running a long-arc campaign, you might want to make sure the villain's threat is quieter at certain times. Doing so gives the heroes a chance to take a [respite](../rule/resource/respite.md) now and then and work on their downtime projects.
...
As part of your worldbuilding, you can create an outline of the events that might occur in each [echelon](../rule/general/echelon.md) of your campaign. The farther these events get from the start of the campaign, the vaguer you can leave the details. The actions of the heroes should matter and influence the course of events, so don't plan too much. Otherwise, you might end up throwing out earlier preparation to make player and character decisions matter.

Your outline should include the plans of the villains in your campaign. Review [Echelons](../rule/general/echelon.md) of Play in Chapter 1: [The Basics](the-basics.md) to get an idea of the threat level and stories the heroes should be experiencing at each stage of the campaign. An [echelon](../rule/general/echelon.md) outline might look like this:
...
Every good adventure includes villains, a task to accomplish, [NPCs](../rule/general/npc.md), and interesting locations and adventure sites.
...
>
> When you're coming up with ideas for campaigns, adventures, and scenes, you should feel free to steal plots, action set pieces, characters, and anything else you want from your favorite movies, television shows, novels, comic books, and podcasts. You can then modify a few cosmetic details to make things your own. Borrowing a character who's a [human](../ancestry/human.md) man in your favorite novel to make an [NPC](../rule/general/npc.md)? Make the [NPC](../rule/general/npc.md) a [dwarf](../ancestry/dwarf.md) woman with a new name and no one is the wiser. Got an idea for an encounter based on a battle scene from your favorite science fiction flick? Make those invading aliens gnolls instead! Let your favorite stories inspire you, especially when you're looking for new ideas.
...
The heroes and the fell monsters they slay shouldn't be the only folks in an adventure. A few friendly (or at least nonhostile) [NPCs](../rule/general/npc.md) can supply the characters with information, equipment, and—most importantly—a good reason for putting their lives on the line. If all the people the characters come across are villainous, apathetic, or selfish, the players won't feel very motivated to get their heroics on.

The [NPCs](../rule/general/npc.md) the heroes meet during their adventures should be complex people. They have personal motivations for helping the heroes, personality and behavioral quirks, and character flaws. An adventure typically features at least three or four [NPCs](../rule/general/npc.md) you'll want to flesh out, depending on how many scenes you plan to play out and how many [NPCs](../rule/general/npc.md) each scene requires.

When you create an [NPC](../rule/general/npc.md), quickly jot down the following information about them.

##### Personal Details

What's this [NPC](../rule/general/npc.md)'s name? What do they do for a living?

##### Features

What's notable about the [NPC](../rule/general/npc.md)'s appearance? Do they have distinguishing features such as a streak of gray or color in their hair, a bushy beard, a tattoo of a snake skull, or a scar over one eye? Do they have a specific scent (good or bad)?

##### Voice

When the [NPC](../rule/general/npc.md) speaks, how does their voice sound? You don't have to put on a character voice every time you speak as the [NPC](../rule/general/npc.md), but telling the players, "This elf talks like a pirate," or "This [dwarf](../ancestry/dwarf.md) has a high-pitched voice that keeps cracking," helps them remember and differentiate that [NPC](../rule/general/npc.md) from others.

##### Behavior

What noticeable behavior does the [NPC](../rule/general/npc.md) have? Maybe they maintain constant, unbreaking eye contact, or maybe they rarely look up from their feet. They could pick their nose, repeat a catch phrase, talk to themself, bite their nails, whisper whenever they say something profound (or profane!), or constantly clear their throat. Giving an [NPC](../rule/general/npc.md) just one distinct behavior helps cement them in the players' minds and makes them more authentic.

##### Flaw

What character flaw does this [NPC](../rule/general/npc.md) have? They might be selfish when it comes to wealth, ignore their personal hygiene, lie to cover up their insecurities, or act cowardly in the face of threats. A single flaw does the trick. Too many flaws, and your [NPC](../rule/general/npc.md) will go from authentic to authentically unlikable fast.

##### Helping the Heroes

Why would this [NPC](../rule/general/npc.md) want to help the heroes during this adventure? They don't have to be fully on board with helping the characters at first. It might take some convincing, in the form of a [test](../rule/test/test.md), a negotiation, or a task the heroes need to accomplish to win the [NPC](../rule/general/npc.md)'s help. But there should be at least a kernel of motivation in the [NPC](../rule/general/npc.md) already—or they have no reason to help. It could be that they don't want the villain to succeed, they see a profitable opportunity in working with the heroes, or they feel they owe the heroes a favor thanks to a previous adventure.

##### Denying Aid

What would prevent this [NPC](../rule/general/npc.md) from helping the heroes? It's possible that the answer is "nothing," but most people have something or someone they're not willing to risk even if the fate of the world hangs in the balance. What could the villain threaten that makes the [NPC](../rule/general/npc.md) think twice about helping out the heroes? It might be a loved one, a meaningful location, or a valuable treasure.
...
- Which [NPCs](../rule/general/npc.md) who the heroes might interact with are found here?
...
Your adventure outline is a document you can use to run your game sessions. It contains information about the villain, the adventure goal, [NPCs](../rule/general/npc.md), locations and sites, and scenes. You can format this outline however you like, whether as fully written sentences, bullet points, a plotting web, or anything else that makes sense to you.

A standard adventure outline contains a bit of overview information regarding the adventure's villain, goal, and [NPCs](../rule/general/npc.md). It then contains a list of locations and sites, with specific sites breaking out the details of each scene that occurs there. The outline then wraps up with a conclusion section discussing the impact the heroes' actions have on the overall campaign and the game world.
...
Director sheets are a resource you can use to prepare and track the progress of characters during combat encounters, negotiations, and [montage tests](../rule/test/montage-test.md). These sheets allow you to track the [objectives](../rule/combat/objective.md) and numbers relevant to the challenge, such as the [Stamina](../rule/health/stamina.md) of enemies, [NPC](../rule/general/npc.md) interest and patience, and the number of successes and failures in a [montage test](../rule/test/montage-test.md). Each sheet has an optional second page you can use to track narrative details, potential rewards, and supporting [NPCs](../rule/general/npc.md) in the scene. You can download these sheets at *https://mcdm.gg/DS-Resources*.
...
It's okay for a [test](../rule/test/test.md) to be the *best* way to get necessary information or objects. But if the heroes fail or don't make the [test](../rule/test/test.md), make sure there's another way—likely a more difficult way—for the story to continue. When searching a necromancer's tower for a book that will help stop a ritual, characters might miss all the clues pointing to the book. But they can later run into the necromancer's apprentices, who know where the book is—and who aren't willing to give up that information without a difficult fight.

Other information and rewards the heroes can earn in an exploration scene can be hidden behind [tests](../rule/test/test.md) that can be failed or missed. If heroes don't think to check under the dead king's desk, they don't find the chalice that rolled under there. If they do find the chalice but fail a [Reason](../rule/character/reason.md) [test](../rule/test/test.md) to examine it, they don't learn that the chalice carries the residue of a rare poison, potentially leading them to a nearby alchemist who sells it. They can still solve the mystery without this information,
...
The heroes can usually obtain basic information just by interacting with their environment. If a player asks, "Does it look like the muddy floor of the cave would cling to someone's boots?", getting confirmation doesn't require a [test](../rule/test/test.md). However, following the tracks that lead out of the cave toward the bandits' new hideout does require a [test](../rule/test/test.md), because that's a harder task whose failure gives the bandits extra time to prepare an ambush for when the heroes arrive! If a character wants to meticulously dig through the refuse pile and examine each piece of trash, no [test](../rule/test/test.md) is required to find the torn-up pieces of the map unless they're under serious time pressure to do so. However, a character piecing the map back together needs to succeed on a [Reason](../rule/character/reason.md) [test](../rule/test/test.md) to do so, because failing that task means the heroes obtain only incomplete information as they continue their search.

Chapter 9: [Tests](tests.md) explains [tests](../rule/test/test.md) in detail and provides examples of different difficulties of [tests](../rule/test/test.md). A lot of other fantasy games reflexively ask for a roll of the dice anytime a hero attempts a task. However, *Draw Steel* is built around the idea that the Director calls for [tests](../rule/test/test.md) only when failure would make the story more interesting for the heroes and not grind the game to a halt. You might end up asking for fewer [tests](../rule/test/test.md) than you're used to—and that's the way the game is meant to be played!
...
By contrast, sometimes a player will propose what they think is a plausible or clever idea, but you'll think there's no way it could ever succeed. It's fine for you to tell the player, "That's not going to work." You're under no obligation to allow a player to attempt a [test](../rule/test/test.md) that should automatically fail.

##### Test Difficulty

[Tests](../rule/test/test.md) in *Draw Steel* have three levels of outcome, and all players know those outcomes and the dice rolls that generate them. Making a [test](../rule/test/test.md) always means something because every [test](../rule/test/test.md) comes with risks and stakes! Before you call for a [test](../rule/test/test.md), you need to set a difficulty for the [test](../rule/test/test.md) of easy, moderate, or hard.
...
When you call for a [test](../rule/test/test.md), you can tell the player making the [test](../rule/test/test.md) the difficulty. Saying "Make a hard [Reason](../rule/character/reason.md) [test](../rule/test/test.md)" can create a dramatic moment at the table as everyone holds their collective breath to see whether the outcome is success, failure, or failure with an additional consequence.

On the other hand, not sharing the difficulty of every [test](../rule/test/test.md) with the players lets you do a little fudging of those difficulties if you want to. You might call for a [test](../rule/test/test.md) and then realize that a [test](../rule/test/test.md) really wasn't necessary even as the player makes the roll. It's easy to simply say, "Hey, sorry. I shouldn't have asked for a [test](../rule/test/test.md). You just do the thing." But if you want to play it cool, remember that every level of an easy [test](../rule/test/test.md) is a success. It's simply a matter of whether a consequence or reward comes with it. If a hero gets an 11 or lower on a [test](../rule/test/test.md) and you think they should still succeed, then the [test](../rule/test/test.md) was easy difficulty.
...
If a [test](../rule/test/test.md) is a **failure**, the hero doesn't do what they set out to do. But even though they don't incur a formal consequence, negative effects can still accompany a failed [test](../rule/test/test.md) depending on circumstances. If a hero attempts to move silently past a group of guards, a failure on the [test](../rule/test/test.md) might draw the guards' attention, but the character should have a chance to react before the alarm is raised. But if the character had incurred a failure with a consequence, they would be spotted immediately as the shouting guards rush to the attack.

If a [test](../rule/test/test.md) is a **success with a consequence**, the hero succeeds but suffers a significant negative effect. They might sneak past the guards successfully but lose their belt pouch in the process, forcing them to decide whether to return for it or move on.

If a [test](../rule/test/test.md) is a **success**, the hero does what they set out to do! You can even let a player narrate the outcome of a successful [test](../rule/test/test.md) by asking them, "How did you pull this off ?"

If the [test](../rule/test/test.md) is a **success with a reward**, the hero does what they set out to do—and then some. A reward might grant another character who needs to make the same [test](../rule/test/test.md) an automatic success, grant an [edge](../rule/dice/edge.md) on a future [test](../rule/test/test.md) for the hero, reveal a hidden treasure the hero wasn't looking for, inspire a nearby [NPC](../rule/general/npc.md) to come forth and offer aid, or earn the group a [hero token](../rule/resource/hero-token.md). A reward on a [test](../rule/test/test.md) is yours to choose.

Sample consequences and rewards for [tests](../rule/test/test.md) are detailed in Chapter 9: [Tests](tests.md).
...
All activated hazards have some kind of trigger, and the heroes should be allowed to make [tests](../rule/test/test.md)—typically [Reason](../rule/character/reason.md) or [Intuition](../rule/character/intuition.md) [tests](../rule/test/test.md)—to notice and then disable that trigger. The deadlier the hazard, the harder the [test](../rule/test/test.md).

If a hero doesn't think to search for a trigger before stumbling into a hazard, you can still call for a [test](../rule/test/test.md) to let them notice the trigger when the hazard is about to activate, provided it makes sense to do so. If a hero is about to cross over a tripwire that triggers a trap, you might call for an [Intuition](../rule/character/intuition.md) [test](../rule/test/test.md) to notice the wire at the point when it can be clearly seen. On a failed [test](../rule/test/test.md), the character walks into the tripwire and activates the trap.

Once a trigger is noticed, the heroes might get a chance to disarm it if that's possible. There's probably nothing to be done short of renovating an old mine to stop it from collapsing when anyone damages its walls, but the characters can try to disable a magic rune in a corridor that [teleports](../movement/teleport.md) any creature moving over it into the middle of an ocean. Just remember that trying and failing to disarm a trigger might trigger the hazard!
...
A hero might get a chance to mitigate damage from a hazard, such as by making an [Agility](../rule/character/agility.md) [test](../rule/test/test.md) to outrun or dodge an avalanche, or making a [Reason](../rule/character/reason.md) [test](../rule/test/test.md) to resist the psychic damage of a psionic cloud. You can decide what sort of [test](../rule/test/test.md) needs to be made based on the circumstances.

The One-Time Hazard Deadliness and Perpetual Hazard Deadliness tables show the damage dealt by hazards. Hazards are organized by level, indicating their relative threat compared to the level of the heroes. Each entry features three damage expressions for a tier 1, tier 2, and tier 3 outcome on the [test](../rule/test/test.md) made to mitigate the hazard's damage. The worse the [test](../rule/test/test.md) outcome, the higher the damage.
...
- A character receives a gaping wound that causes them to take 1d10 damage whenever they roll a natural 2 before they next finish a [respite](../rule/resource/respite.md).
- A character is [teleport](../movement/teleport.md)ed into the middle of a nearby body of water.
...
Interaction scenes are similar to exploration scenes, except that the heroes obtain the information and objects they need by talking to one or more [NPCs](../rule/general/npc.md) instead of exploring an area. Just like with an exploration encounter, you make a list of necessary information that the [NPCs](../rule/general/npc.md) can offer to the heroes freely. [NPCs](../rule/general/npc.md) might then have other information or objects they can be convinced to give to the heroes if they make a persuasive argument, do something kind for the [NPC](../rule/general/npc.md), or succeed on a [test](../rule/test/test.md).

Interaction scenes aren't full negotiations, which are reserved for adventure-changing conversations. Still, keep in mind that different [NPCs](../rule/general/npc.md) react differently to various forms of persuasion. A coward might be easy to intimidate, while a battle-hardened soldier might be impossible to awe with displays of ferocity. A bribe might work for a corrupt noble, but a goodly queen who already has wealth beyond measure likely has no interest in whatever riches the heroes possess.

Refer to the details you wrote down for your [NPCs](../rule/general/npc.md) while you roleplay them. Keep in mind any distinct behaviors or attitudes you can throw in to help make the scene fun. You don't have to be a great actor to create a memorable interaction scene! Simply describing how an [NPC](../rule/general/npc.md) looks, sounds, and acts goes a long way even without doing funny voices. If you want to put on a character voice, go for it—but there's no obligation to.
...
It helps to know the various outcomes an [NPC](../rule/general/npc.md) might offer during a negotiation ahead of time. An adventure or campaign continuing should never hinge entirely on the outcome of a negotiation. You don't want the story to come grinding to a halt if the heroes fail to secure information, treasure, or help from an [NPC](../rule/general/npc.md). A failed negotiation might mean the adventure gets a lot harder, but should always provide options for continuing when the characters' negotiation skills fail them.

A negotiation has six possible outcomes, but two of those are predetermined. If a negotiation ends with the [NPC](../rule/general/npc.md) at interest 4, then the heroes get what they want. If the heroes end the negotiation at interest 1, the [NPC](../rule/general/npc.md) can't offer them anything. Even with four options left wide open, however, setting up outcomes actually requires less prep work than you might think.

> **Multiple [NPCs](../rule/general/npc.md)**
>
> The negotiation rules are built around the idea of the heroes facing off against a single dominant [NPC](../rule/general/npc.md)—a powerful leader, a ranking diplomat, a warlord, a key villain, and so forth. But this isn't to say that you can't run a negotiation with the heroes interacting with a group of [NPCs](../rule/general/npc.md), each with their own slightly different take on wheeling and dealing.
>
> If you set up a negotiation using more than one [NPC](../rule/general/npc.md), you don't give each [NPC](../rule/general/npc.md) their own negotiation stats, motivations, and pitfalls. Rather, you assign stats to the group as a whole, then have different [NPCs](../rule/general/npc.md) step to the fore in the negotiation when a particular motivation or pitfall is in play. For example, if you assign the greed pitfall to a group of knights, the well-dressed captain of that group might appear as though they're open to being bribed by the heroes. But when the dour sergeant-at-arms who resents the captain's flamboyant lifestyle angrily rejects the characters' offer, the captain must go along with it to keep the peace among their [followers](../rule/general/follower.md).

If a negotiation ends with the [NPC](../rule/general/npc.md)'s interest at 2 or 5, you need to know what the [NPC](../rule/general/npc.md) might offer the heroes instead of or in addition to their main ask. It's also a good idea to have a list of two favors, items, pieces of information, or other help the [NPC](../rule/general/npc.md) can offer the heroes, so that you aren't scrambling to think of something if these results come up.

Likewise, if the [NPC](../rule/general/npc.md)'s interest hits 3, they'll ask the heroes for a favor in exchange for what's being asked of them. The heroes might also directly ask the [NPC](../rule/general/npc.md) what they can offer to cinch the negotiation. In this case, it helps to have in mind two favors, items, pieces of information, or other help the [NPC](../rule/general/npc.md) could ask for from the heroes.

Finally, if the heroes really offend the [NPC](../rule/general/npc.md) and end the negotiation with their interest at 0, have some idea of what the [NPC](../rule/general/npc.md) might do to try to punish the heroes. If you don't have this ready, though, don't sweat it. Revenge is a dish best served cold—and maybe a few sessions from now—so you've got time to plan.

#### Hero Negotiation Stats

Many heroes have class features, titles, or other character options that make them better in negotiation. When you're preparing a negotiation, it helps if you know each hero's [Renown](../rule/resource/renown.md) score and any features they have that might impact a negotiation, such as the [troubadour's](../class/troubadour.md) [Scene Partner](../feature/troubadour/level-1/scene-partner.md) feature. Ask your players to tell you if any of their character options influence negotiation at the start of a campaign, and ask again whenever they gain a new level.

#### Heroes Must Initiate

A negotiation should always be initiated by the heroes, and the character (as with people in general) can't be forced to negotiate for something they don't want. As you prepare your negotiation, remember that the players might decide to gain what the characters need from the [NPC](../rule/general/npc.md) in some other way—calling in a favor from someone else who has the means to help them, stealing what they need from the [NPC](../rule/general/npc.md), simply pushing forward without the [NPC](../rule/general/npc.md)'s help, and so on.
...
An [NPC](../rule/general/npc.md)'s interest helps you determine their attitude toward the party's proposals, while their patience indicates how much time they're willing to give the heroes. In the same way that [Stamina](../rule/health/stamina.md) tells you when a monster is done with a fight, patience tells you when an [NPC](../rule/general/npc.md) is done talking and is ready to deal. The negotiation rules mean you never have to just roleplay a conversation until you and the players become bored with the scene, then someone makes a single [test](../rule/test/test.md) to see what happens. The negotiation rules let you roleplay with structure, risks, and rewards!

The most important thing to remember when it comes to negotiation is that the rules are meant to work with you—not against you. They're flexible on purpose. If a hero makes an excellent argument that you think should work without a [test](../rule/test/test.md), then it does. If a hero makes an unfortunate argument that should fail no matter what, then they're out of luck. You're empowered to run negotiation in whatever way will be the most fun for you and your players.

If players are having trouble roleplaying during a negotiation, try running your next negotiation without announcing that the characters are now in a negotiation. Simply ask them for [tests](../rule/test/test.md) when appropriate and have the [NPC](../rule/general/npc.md) respond based on the [test](../rule/test/test.md) outcomes and their motivations and pitfalls. This approach might help your players shake off focusing on the rules to simply roleplay as you track interest and patience on the side.

#### Research and Reconnaissance

If the players want to negotiate with an [NPC](../rule/general/npc.md) and the heroes have some time before the conversation starts, they might think to do a bit of research and reconnaissance into the [NPC](../rule/general/npc.md), hoping to discover their motivations and pitfalls. Characters have multiple ways to tackle this. They might do research into the [NPC](../rule/general/npc.md) as a downtime project, they could employ a [montage test](../rule/test/montage-test.md) to gather rumors and grease a few palms, or they might attempt to do favors for people close to the [NPC](../rule/general/npc.md) and earn information in exchange.
...
When it comes time for you to roleplay an [NPC](../rule/general/npc.md) during a negotiation, remember that the [NPC](../rule/general/npc.md), like all sapient creatures, is complex. Every [NPC](../rule/general/npc.md) has their own way of approaching negotiation. Some might be full of bluster. Others might say everything with a smile even while rejecting the heroes. One [NPC](../rule/general/npc.md) might be verbose, while yet another says as little as possible to keep the heroes guessing as to their real desires. As a starting point to figuring out how a specific [NPC](../rule/general/npc.md) might negotiate, you can refer to the notes on the [NPC](../rule/general/npc.md) that you created while preparing the adventure, reviewing their voice, behavior, and flaw, in addition to any motivations for helping or denying characters in need.

One important decision you should make ahead of time is how upfront the [NPC](../rule/general/npc.md) will be regarding what they want from the heroes. A straightforward [NPC](../rule/general/npc.md) can make for a faster negotiation if the heroes are willing to give the [NPC](../rule/general/npc.md) whatever they need. An unreadable [NPC](../rule/general/npc.md) can be a puzzle for the heroes to figure out, and can be more difficult to roleplay. If it's your first time using the negotiation rules, you should start out with a more straightforward [NPC](../rule/general/npc.md) before playing a coy customer.
...
Once a negotiation starts, the players and characters can obtain information about the [NPC](../rule/general/npc.md) involved only by making [tests](../rule/test/test.md), using their characters' features, or through engaging in conversation with the [NPC](../rule/general/npc.md). Whenever the [NPC](../rule/general/npc.md) makes an offer to the heroes after a [test](../rule/test/test.md), make it clear what the terms of the offer are. While some [NPCs](../rule/general/npc.md) might speak cryptically, it's best for the players to understand what they're getting their heroes into. It can be fun to trick the heroes, but many players don't feel the fun when they get tricked instead.

> **Sharing Interest and Patience**
>
> It's up to you as the Director to decide whether to share an [NPC](../rule/general/npc.md)'s interest or patience during a negotiation. Sometimes sharing this information can make an encounter more dramatic, with the players watching their progress rise and fall in real time. Other groups might find negotiation more fun and immersive if those exact numbers are hidden from the players, just as some groups like knowing the [Stamina](../rule/health/stamina.md) of every creature in a battle and others prefer to keep that information secret. Talk to your players about what they'd prefer.

#### Sample Negotiators

This section contains a number of sample [NPCs](../rule/general/npc.md) you can use for negotiation, sorted by their Impression scores. Each of these [NPCs](../rule/general/npc.md) is an archetype that you can easily adapt to specific situations. For example, the bandit chief could be the leader of a brigand gang, a pirate captain, or a rebel who redistributes wealth by stealing from corrupt nobles and giving the booty to those less fortunate.

Each archetype includes a list of motivations and pitfalls an [NPC](../rule/general/npc.md) could have. You should pick at least two from each list for any [NPC](../rule/general/npc.md) you create using the archetype. Feel free to change the wording on motivations and pitfalls and adjust numbers as you see fit.
...
- **Legacy:** Listen, I don't care what happens when I'm gone. I want my [followers](../rule/general/follower.md) shouting my name now, not in a hundred years.
...
- **Peace:** We must have [stability](../rule/character/stability.md). I will sacrifice anything—and anyone—for this.
...
You can use [montage tests](../rule/test/montage-test.md) to play out chases, escapes, investigations, wilderness travel, attempts to track other creatures, and any other exciting moments in a story that can be told by transitioning or cutting back and forth among the heroes.

#### Preparing Montage Tests

When you prepare a [montage test](../rule/test/montage-test.md), you'll want to write down some key information.

First, make a list of potential challenges the heroes can face during the [montage test](../rule/test/montage-test.md). This list should be at least as long as the number of successes the heroes must achieve to earn a total success. You might also prepare a list of consequences and rewards that could come up for individual [tests](../rule/test/test.md) made during the [montage test](../rule/test/montage-test.md), but since you can't predict what approaches the players will take to their characters' [tests](../rule/test/test.md), don't worry about covering every scenario. You can always fall back on earning Malice and giving out [hero tokens](../rule/resource/hero-token.md) as a default consequence and reward (see [Test](../rule/test/test.md) Outcomes in Chapter 9: [Tests](tests.md)).
...
When you run a [montage test](../rule/test/montage-test.md), start by setting the scene for the players and listing the various challenges the heroes must overcome. Allow the players to strategize about the order in which they'll tackle these challenges and make [tests](../rule/test/test.md).

When you adjudicate individual [tests](../rule/test/test.md) as part of a [montage test](../rule/test/montage-test.md), do so as you would any other [test](../rule/test/test.md) (see Adjudicating [Tests](../rule/test/test.md) in Chapter 9: [Tests](tests.md)). Individual [tests](../rule/test/test.md) should have rewards and consequences when appropriate. In addition to the usual options for rewards or consequences, you can choose to have those outcomes grant an [edge](../rule/dice/edge.md) or impose a [bane](../rule/dice/bane.md) on a [test](../rule/test/test.md) made later as part of the [montage test](../rule/test/montage-test.md). Do whatever makes sense for the heroes' actions in the narrative.

After each [test](../rule/test/test.md), narrate the hero's failure or success in such a way that the other players can understand if and how the challenge has been overcome. Your description might even spark some new ideas for what the characters can do next.

If a hero decides to tackle a problem using an ability, trait, or other feature instead of a [test](../rule/test/test.md) and it makes sense for them to do so, allow it. In a lot of cases, you can treat that approach as an automatic success that allows the group to overcome one of the challenges of the [montage test](../rule/test/montage-test.md), but you could decide that the success incurs a consequence. Alternatively, maybe the use of an ability or trait is beneficial enough to provide an [edge](../rule/dice/edge.md) on a future [test](../rule/test/test.md), or maybe it's so effective that it counts for multiple successes or solves the entire [montage test](../rule/test/montage-test.md) in one fell swoop! Always reward the clever actions of the players.

At the end of a [montage test](../rule/test/montage-test.md), narrate the outcome for the players as you describe the overall success or failure and any consequences. Then let them know the [montage test](../rule/test/montage-test.md) is done!

#### Montage Twist!

You can break up the individual [tests](../rule/test/test.md) within a [montage test](../rule/test/montage-test.md) by introducing a quick combat encounter, negotiation, or trap into the scene, or by adding more challenges to overcome. Keep track of the heroes' successes and failures, and decide how many [tests](../rule/test/test.md) they must attempt before introducing your twist. A single twist in a [montage test](../rule/test/montage-test.md) can often be introduced at the end of the first [montage test](../rule/test/montage-test.md) round.

When a twist is introduced, make sure the players understand that the [montage test](../rule/test/montage-test.md) has been paused but isn't over. Then when the twist has been established and dealt with, continue the [montage test](../rule/test/montage-test.md).

#### Example Montage Tests

You can use any of the following [montage tests](../rule/test/montage-test.md) in your game, or as inspiration that you can modify to your heart's content.
...
- **Move Burning Rubble:** [Shifting](../movement/shifting.md) burning debris blocking doorways can allow people to escape the blaze. *Suggested [Characteristic](../rule/character/characteristic.md):* [Might](../rule/character/might.md). *Suggested Skills:* Endurance, Lift. *Special:* A creature who doesn't have fire immunity loses a [Recovery](../rule/health/recoveries.md) if they incur a consequence on the [test](../rule/test/test.md) for this challenge.
- **Use the Freed Horses (if the Free the Horses challenge was successful):**  Characters can put the horses to work clearing rubble or bringing people to safety. *Suggested [Characteristics](../rule/character/characteristic.md):* [Reason](../rule/character/reason.md), [Presence](../rule/character/presence.md). *Suggested Skills:* Drive, Handle Animals, Ride.

###### Optional Twists

At the end of the first [montage test](../rule/test/montage-test.md) round, an emergency crops up. One or more heroes, selected by the players, must deal with the situation before the end of the round. If the heroes successfully deal with the twist, they earn a success for the [montage test](../rule/test/montage-test.md). Otherwise, they earn a failure.

- **Building Collapse:** While a hero is in or near a blazing building, it starts to collapse. The hero must escape before the building crumbles. *Suggested [Characteristics](../rule/character/characteristic.md):* [Agility](../rule/character/agility.md), [Intuition](../rule/character/intuition.md). *Suggested Skills:* Climb, Gymnastics, Jump.
- **Cause of the Fire:** At the end of the first round of the [montage test](../rule/test/montage-test.md), the hostile cause of the fire appears—a squad of an invading army, a dragon, a team of arsonists, and so forth. The characters must engage in a standard or hard encounter with this threat.
- **Help!** Townsfolk are about to run into a burning building to save a trapped relative. This twist requires two [tests](../rule/test/test.md), each of which nets a success or a failure for the [montage test](../rule/test/montage-test.md). One hero can try to prevent the townspeople from entering the burning building while another rescues the relative. *Suggested [Characteristics](../rule/character/characteristic.md):* [Might](../rule/character/might.md), [Presence](../rule/character/presence.md). *Suggested Skills:* Lift, Persuade.

###### Montage Test Outcomes

One of the following outcomes ends the [montage test](../rule/test/montage-test.md):

- **Total Success:** The fire is extinguished. Buildings are damaged but no lives were lost. Each character earns 2 [Victories](../rule/resource/victories.md) if the [montage test](../rule/test/montage-test.md) was hard, or 1 [Victory](../rule/resource/victories.md) if it was easy or moderate, in addition to any [Victories](../rule/resource/victories.md) earned from combat during the [montage test](../rule/test/montage-test.md).
- **Partial Success:** The fire is quenched, although many buildings burned and a few lives were lost. Each character earns 1 [Victory](../rule/resource/victories.md) if the [montage test](../rule/test/montage-test.md) was moderate or hard, in addition to any [Victories](../rule/resource/victories.md) earned from combat during the [montage test](../rule/test/montage-test.md).
- **Total Failure:** When the fire finally burns out, the town lies in ruins. Townsfolk mourn their dead or grimly prepare to find a new home. Characters earn no [Victories](../rule/resource/victories.md) from the [montage test](../rule/test/montage-test.md), but might earn [Victories](../rule/resource/victories.md) from combat undertaken during the [montage test](../rule/test/montage-test.md).
...
Half the work of any successful infiltration is done before setting foot in the target site. The players can choose to have the heroes make individual [tests](../rule/test/test.md) as part of the [montage test](../rule/test/montage-test.md) before they attempt to enter the palace. One round of [tests](../rule/test/test.md) can be made this way, and those [tests](../rule/test/test.md) don't affect the alarm level within the palace (see below).

The following challenges can be part of this initial preparation:

- **Bribe Guards:** The heroes can pay off the guards outside the palace to look the other way. If successful, one or more heroes' [Wealth](../rule/resource/wealth.md) is lowered by 1. *Suggested [Characteristic](../rule/character/characteristic.md):* [Presence](../rule/character/presence.md). *Suggested Skills:* Criminal Underworld, Flirt, Persuade.
- **Find Blueprints:** Researching secret entrances and little-known passageways can be undertaken in forgotten libraries or well-guarded town halls. *Suggested [Characteristics](../rule/character/characteristic.md):* [Agility](../rule/character/agility.md), [Reason](../rule/character/reason.md). *Suggested Skills:* Architecture, History, Sneak.
- **Identify Unguarded Entrances:** Scouting around or consulting contacts can reveal a forgotten back door or accessible window. *Suggested [Characteristics](../rule/character/characteristic.md):* [Agility](../rule/character/agility.md), [Intuition](../rule/character/intuition.md). *Suggested Skills:* Alertness, Architecture, Criminal Underworld.
- **Learn Guard Schedules:** By keeping their ears and eyes open, characters can learn when guards go off duty. *Suggested [Characteristics](../rule/character/characteristic.md):* [Intuition](../rule/character/intuition.md), [Reason](../rule/character/reason.md). *Suggested Skills:* Alertness, Eavesdrop, Track.
- **Use False Identities:** By procuring forged documents or badges, characters can prepare to walk into the palace in plain sight. *Suggested [Characteristics](../rule/character/characteristic.md):* [Presence](../rule/character/presence.md), [Reason](../rule/character/reason.md). *Suggested Skills:* Disguise, Forgery, Lie.

When the heroes start their infiltration, the alarm level of the palace starts at 0. While they infiltrate the site, whenever any hero fails a [test](../rule/test/test.md) as part of the [montage test](../rule/test/montage-test.md), the alarm level increases by 1, to a maximum of 2. Each time the heroes succeed on such a [test](../rule/test/test.md), the alarm level decreases, to a minimum of 0. While the alarm level is 1, [tests](../rule/test/test.md) made inside the palace by the characters as part of the [montage test](../rule/test/montage-test.md) take a [bane](../rule/dice/bane.md). While the alarm level is 2, such [tests](../rule/test/test.md) have a double [bane](../rule/dice/bane.md).

The first time any hero fails a [test](../rule/test/test.md) made as part of the [montage test](../rule/test/montage-test.md) while the alarm level is 2, they encounter guards and must engage in a hard combat encounter. The second time any hero fails such a [test](../rule/test/test.md) while the alarm level is 2, the [montage test](../rule/test/montage-test.md) is a total failure.

The following challenges can be part of the heroes' infiltration:

- **Aerial Route:** Characters can follow a path that leads along catwalks or high ledges. *Suggested [Characteristics](../rule/character/characteristic.md):* [Agility](../rule/character/agility.md), [Might](../rule/character/might.md). *Suggested Skills:* Climb, Gymnastics, Jump.
- **Avoid Traffic:** By finding the dustiest, least-traveled areas and sticking to them, characters can avoid notice. *Suggested [Characteristics](../rule/character/characteristic.md):* [Intuition](../rule/character/intuition.md), [Reason](../rule/character/reason.md). *Suggested Skills:* Navigate, Search, Track.
- **Lie Low:** Once while the alarm level is greater than 0, the heroes can find a place to hide for a bit, reducing the alarm level by 1. This activity doesn't require a [test](../rule/test/test.md) or generate a success or failure.
- **Make a Diversion:** After causing a ruckus, the characters quickly go the other way. *Suggested [Characteristics](../rule/character/characteristic.md):* [Might](../rule/character/might.md), [Presence](../rule/character/presence.md). *Suggested Skills:* Alchemy, Perform, Sabotage.
- **Pose as Guards:** Using stolen or specially prepared uniforms can let the characters move freely through the palace. The [test](../rule/test/test.md) for this challenge gains an [edge](../rule/dice/edge.md) if the characters prepared disguises in advance (including succeeding on the Use False Identities challenge) or defeated guards during their infiltration. *Suggested [Characteristics](../rule/character/characteristic.md):* [Intuition](../rule/character/intuition.md), [Presence](../rule/character/presence.md). *Suggested Skills:* Disguise, Lie, Search.
- **Skulk in the [Shadows](../class/shadow.md):** Keeping out of sight is the simplest way for characters to move through the palace. *Suggested [Characteristic](../rule/character/characteristic.md):* [Agility](../rule/character/agility.md). *Suggested Skills:* Hide, Sneak. *Special:* The heroes can attempt this challenge twice during the [montage test](../rule/test/montage-test.md).
...
- **Total Success:** The heroes reach their goal and secure an escape route that lets them leave the palace safely. Each character earns 2 [Victories](../rule/resource/victories.md) if the [montage test](../rule/test/montage-test.md) was hard, or 1 [Victory](../rule/resource/victories.md) if it was easy or moderate, in addition to any [Victories](../rule/resource/victories.md) earned from combat during the [montage test](../rule/test/montage-test.md).
- **Partial Success:** The heroes reach their goal, but they need to fight a standard combat encounter to escape the palace. Each character earns 1 [Victory](../rule/resource/victories.md) if the [montage test](../rule/test/montage-test.md) was moderate or hard, in addition to any [Victories](../rule/resource/victories.md) earned from combat during the [montage test](../rule/test/montage-test.md).
- **Total Failure:** The palace is locked down and the heroes' goal is out of reach. The characters need to fight a hard combat encounter to escape. Characters earn no [Victories](../rule/resource/victories.md) from the [montage test](../rule/test/montage-test.md), but might earn [Victories](../rule/resource/victories.md) from combat undertaken during the [montage test](../rule/test/montage-test.md).
...
- **Arms and Armor:** Crafting or repairing weapons and armor of all kinds can help rebuild the defenders' stores. *Suggested [Characteristics](../rule/character/characteristic.md):* [Might](../rule/character/might.md), [Reason](../rule/character/reason.md). *Suggested Skills:* Alchemy, Blacksmithing, Fletching.
- **Evacuation:** Heroes can help get noncombatants to safety before the invaders arrive. *Suggested [Characteristics](../rule/character/characteristic.md):* [Intuition](../rule/character/intuition.md), [Presence](../rule/character/presence.md). *Suggested Skills:* Handle Animals, Lead, Persuade.
...
At the end of the first round of the [montage test](../rule/test/montage-test.md), a fast-moving enemy vanguard attacks before the settlement's defenders are ready. The heroes must engage in an easy combat encounter.

###### Montage Test Outcomes

One of the following outcomes ends the [montage test](../rule/test/montage-test.md):

- **Total Success:** The settlement is fully fortified, and even if the heroes don't fight in its defense, the settlement and its people survive. If the heroes wish, they can leave the settlement and fight a standard combat encounter against the leader of the invaders and their lackeys, possibly killing or capturing the leader. Each character earns 2 [Victories](../rule/resource/victories.md) if the [montage test](../rule/test/montage-test.md) was hard, or 1 [Victory](../rule/resource/victories.md) if it was easy or moderate, in addition to any [Victories](../rule/resource/victories.md) earned from combat during the [montage test](../rule/test/montage-test.md).
- **Partial Success:** The settlement's fortifications are improved, but the settlement will still fall unless the heroes fight in its defense. To save the settlement, the heroes must triumph in a hard combat encounter against the leader of the invaders and their lackeys. If the heroes lose the encounter, the settlement falls. Each character earns 1 [Victory](../rule/resource/victories.md) if the [montage test](../rule/test/montage-test.md) was moderate or hard, in addition to any [Victories](../rule/resource/victories.md) earned from combat during the [montage test](../rule/test/montage-test.md).
- **Total Failure:** The heroes each lose a [Recovery](../rule/health/recoveries.md) from their failed efforts to defend the settlement, which is taken over by the invaders. If the players wish, the characters can fight two hard combat encounters against waves of invaders to allow some of the settlement's inhabitants to retreat to safety. Characters earn no [Victories](../rule/resource/victories.md) from the [montage test](../rule/test/montage-test.md), but might earn [Victories](../rule/resource/victories.md) from combat undertaken during the [montage test](../rule/test/montage-test.md).
...
- **Ask Around:** Characters can gather clues from locals or bystanders—or if they have access to the proper magic, from animals or the dead. *Suggested [Characteristics](../rule/character/characteristic.md):* [Intuition](../rule/character/intuition.md), [Presence](../rule/character/presence.md). *Suggested Skills:* Interrogate, Persuade, Rumors.
- **Follow the Trail:** Looking for tracks or other signs of the fugitive's passage can lead the characters on. *Suggested [Characteristic](../rule/character/characteristic.md):* [Intuition](../rule/character/intuition.md). *Suggested Skills:* Alertness, Search, Track. *Special:* The heroes can attempt this challenge twice during the [montage test](../rule/test/montage-test.md).
- **Obtain a Good View:** Characters can climb up high to get the big picture of where the fugitive might have gone. *Suggested [Characteristics](../rule/character/characteristic.md):* [Agility](../rule/character/agility.md), [Might](../rule/character/might.md). *Suggested Skills:* Climb, Gymnastics, Jump.
- **Predict the Next Move:** The heroes might have an idea where the quarry is headed. A character gains an [edge](../rule/dice/edge.md) on the [test](../rule/test/test.md) for this challenge if they know the quarry well. *Suggested [Characteristics](../rule/character/characteristic.md):* [Intuition](../rule/character/intuition.md), [Reason](../rule/character/reason.md). *Suggested Skills:* Navigate, Read Person, an appropriate skill from the [lore skill group](../skill/lore/lore.md) (Nature to follow an animal, Criminal Underworld to follow a criminal, and so forth).
- **Push Ahead:** While the quarry is resting, the heroes have a chance to close in. Suggested [Characteristic](../rule/character/characteristic.md): [Might](../rule/character/might.md). Suggested Skills: Drive, Endurance, Navigate, Ride. Special: The hero making the [test](../rule/test/test.md) for this challenge loses a [Recovery](../rule/health/recoveries.md).

###### Optional Twist

At the end of the first round of the [montage test](../rule/test/montage-test.md), the heroes stumble upon a trap set by the quarry or a problem they left behind. This might include such things as a pit trap set with poison spikes, a mob of angry locals who've been told the characters are criminals, or an intentionally set fire. The heroes must deal with the trap or problem before they continue the [montage test](../rule/test/montage-test.md).

###### Montage Test Outcomes

One of the following outcomes ends the [montage test](../rule/test/montage-test.md):

- **Total Success:** The heroes catch their quarry before the fugitive reaches their destination, or before a lost or kidnapped creature comes to harm. Each character earns 2 [Victories](../rule/resource/victories.md) if the [montage test](../rule/test/montage-test.md) was hard, or 1 [Victory](../rule/resource/victories.md) if it was easy or moderate, in addition to any [Victories](../rule/resource/victories.md) earned from combat during the [montage test](../rule/test/montage-test.md).
- **Partial Success:** If the quarry was trying to evade capture, they reach their destination. They find allies and a fortified position from which to defend themselves, or they might have time to cause more harm. If the quarry was lost or kidnapped, they are grievously injured when found. Each character earns 1 [Victory](../rule/resource/victories.md) if the [montage test](../rule/test/montage-test.md) was moderate or hard, in addition to any [Victories](../rule/resource/victories.md) earned from combat during the [montage test](../rule/test/montage-test.md).
- **Total Failure:** The trail has gone cold, and the heroes will need to seek fresh clues or a different approach before they can resume the hunt. Characters earn no [Victories](../rule/resource/victories.md) from the [montage test](../rule/test/montage-test.md), but might earn [Victories](../rule/resource/victories.md) from combat undertaken during the [montage test](../rule/test/montage-test.md).
...
- **Avoid Hazards:** Characters can determine ways to overcome the natural hazards of the wilderness, such as finding insect-repelling herbs in a swamp or making snowshoes to cross tundra. *Suggested [Characteristics](../rule/character/characteristic.md):* [Intuition](../rule/character/intuition.md), [Reason](../rule/character/reason.md). *Suggested Skills:* Heal, Nature, appropriate skill from the [crafting skill group](../skill/crafting/crafting.md) (such as Alchemy to make bug repellent).
- **Carry Baggage:** By carrying supplies for weaker party members, characters can increase the whole party's [speed](../rule/character/speed.md). *Suggested [Characteristic](../rule/character/characteristic.md):* [Might](../rule/character/might.md). *Suggested Skills:* Endurance, Lift.
- **Find the Path:** Avoiding getting lost is a major challenge for the characters. *Suggested [Characteristics](../rule/character/characteristic.md):* [Intuition](../rule/character/intuition.md), [Reason](../rule/character/reason.md). *Suggested Skills:* Alertness, Nature, Navigate.
- **Keep Up Spirits:** Characters can keep up the party's morale during a forced march with cheer and song. *Suggested [Characteristic](../rule/character/characteristic.md):* [Presence](../rule/character/presence.md). *Suggested Skills:* Lead, Music, Perform.
- **Keep Watch:** Characters must be on constant guard against danger. *Suggested [Characteristic](../rule/character/characteristic.md):* [Intuition](../rule/character/intuition.md). *Suggested Skills:* Alertness, Eavesdrop, Track.
- **Push On:** Characters must be ready to pick up the pace and push past their fatigue. *Suggested [Characteristics](../rule/character/characteristic.md):* [Might](../rule/character/might.md). *Suggested Skills:* Endurance, Lead; Drive, Handle Animals, or Ride if the party has mounts or vehicles.
- **Scout Ahead:** Investigating the path ahead lets the characters avoid dead-ends and arduous terrain. *Suggested [Characteristics](../rule/character/characteristic.md):* [Agility](../rule/character/agility.md), [Intuition](../rule/character/intuition.md). *Suggested Skills:* Alertness, Navigate, Sneak.

###### Optional Twist

At the end of the first round of the [montage test](../rule/test/montage-test.md), the characters' journey is interrupted by one of the following threats:

**Predatory Monster:** The characters stumble into or are stalked by a monstrous predator, and must engage in a standard combat encounter to overcome the threat or drive it off. If any character has obtained a success on the Scout Ahead challenge, you can let the characters make a [group test](../rule/test/group-test.md) to sneak past or set an ambush for the monster.

**Unexpected Hazard:** A natural hazard such as an avalanche, rockslide, or wildfire interrupts the journey. Each hero must make a [test](../rule/test/test.md) of your choice to avoid the hazard, losing a [Recovery](../rule/health/recoveries.md) on a failure.

###### Montage Test Outcomes

One of the following outcomes ends the [montage test](../rule/test/montage-test.md):

- **Total Success:** The heroes reach their goal in time. Each character earns 2 [Victories](../rule/resource/victories.md) if the [montage test](../rule/test/montage-test.md) was hard, or 1 [Victory](../rule/resource/victories.md) if it was easy or moderate, in addition to any [Victories](../rule/resource/victories.md) earned from combat during the [montage test](../rule/test/montage-test.md).
- **Partial Success:** To reach their goal in time, the heroes must sprint over the last leg of the journey, with each character spending 2 [Recoveries](../rule/health/recoveries.md) to do so. (If even one character doesn't have 2 [Recoveries](../rule/health/recoveries.md) remaining, the characters instead earn a total failure for the [montage test](../rule/test/montage-test.md).) Each character earns 1 [Victory](../rule/resource/victories.md) if the [montage test](../rule/test/montage-test.md) was moderate or hard, in addition to any [Victories](../rule/resource/victories.md) earned from combat during the [montage test](../rule/test/montage-test.md).
- **Total Failure:** The heroes don't arrive in time to avert catastrophe. Characters earn no [Victories](../rule/resource/victories.md) from the [montage test](../rule/test/montage-test.md), but might earn [Victories](../rule/resource/victories.md) from combat undertaken during the [montage test](../rule/test/montage-test.md).

### Running Respites

When the heroes decide to take a [respite](../rule/resource/respite.md) (see [Respite](../rule/resource/respite.md) in Chapter 1: [The Basics](the-basics.md)), your role as Director changes a bit. Most of the heroes' activities during [respites](../rule/resource/respite.md) revolve around downtime projects, which are typically self-directed. However, you still have levers you can pull to make the story interesting.

#### Safe Place

Heroes can't take a [respite](../rule/resource/respite.md) unless they're in a safe place. This typically means a place with a bed and four walls and a roof around them, where they're unlikely to get stabbed in their sleep. Characters aren't going to find 24 hours of peace to take a [respite](../rule/resource/respite.md) in a villain's lair, even if they barricade a door. However, this can become more of a gray area if the heroes attempt to take a [respite](../rule/resource/respite.md) while traveling in the wild.

"Why can't we camp in this seemingly peaceful wode for a day?" is the kind of thing you might decide is fine if you want the characters to be able to regain [Stamina](../rule/health/stamina.md) and [Recoveries](../rule/health/recoveries.md). Alternatively, you might want them to work harder for those resources, marking the wode as a dangerous place in the story. If the players want the heroes to take a [respite](../rule/resource/respite.md) in a place you deem unsafe, let them know it's impossible to get any meaningful rest or make progress on projects in that place while remaining constantly on guard for danger.

#### Too Many Respites?

It's up to the players how many [respites](../rule/resource/respite.md) the heroes take in a row. Characters eager to take a long series of [respites](../rule/resource/respite.md) to undertake downtime projects (Chapter 12: [Downtime Projects](downtime-projects.md)) is fine, but they should always feel pressure to get back to the fight. Remember that villains don't stop plotting and conquering while the heroes rest. Their plans continue! If the characters are taking their sweet time with [respites](../rule/resource/respite.md) so they can create as many Healing Potions as possible, have them get wind of the latest evil actions that nearby villains are taking. Heroes wanting to defend the people and values they love had better stop respiting and start adventuring.

If you prefer a campaign that has few [respites](../rule/resource/respite.md), you might want to deploy artisans, sages, and readily available [project sources](../rule/downtime/project-source.md) to allow the heroes a chance to craft useful items and do research, since their available time to do so will be limited.

#### Project Events

Downtime project events are a Director's time to shine during downtime. Remember that these events (detailed in Chapter 12: [Downtime Projects](downtime-projects.md)) are optional, and you can use them as frequently as you like. In general, more than one or two events per [respite](../rule/resource/respite.md) can be disruptive to the overall campaign. It's also fine to have no events if you just want to keep the campaign's main story rolling along.
...
If your play time is limited, you can have the players do everything they need to do during a [respite](../rule/resource/respite.md) between your game sessions, provided they end a game session by taking a [respite](../rule/resource/respite.md). Doing so lets you run any events over email or through a chat app. Then when folks return for the next session, they'll be ready to go with [project rolls](../rule/downtime/project-roll.md) completed, [XP](../rule/resource/experience.md) tallied, and [Stamina](../rule/health/stamina.md) and [Recoveries](../rule/health/recoveries.md) restored.

#### How Many Respites?

There's no right number of [respites](../rule/resource/respite.md) that works for every group. If you want the characters to be able to craft and research, you'll want to give them more downtime to do so. If you prefer to hand out all the treasure and secrets through adventuring, then they'll need fewer [respites](../rule/resource/respite.md). A good pace for many games sees the heroes taking between ten and twenty [respites](../rule/resource/respite.md) during each level of play, with many of those [respites](../rule/resource/respite.md) strung together.
...
Every [crafting project](../rule/downtime/crafting-project.md) requires that a hero obtain the project's [item prerequisite](../rule/downtime/item-prerequisite.md) and a [project source](../rule/downtime/project-source.md) in a specific language before the project can be started. These requirements exist so you can control the pace at which heroes can craft an arsenal of treasures to defeat their foes.

That said, you can make it easier to craft treasures and other items by changing the rules to require either the [item prerequisite](../rule/downtime/item-prerequisite.md) or the [project source](../rule/downtime/project-source.md) but not both, or by removing the language restrictions on [project sources](../rule/downtime/project-source.md). This works well in campaigns that don't have a lot of [respites](../rule/resource/respite.md). Just keep in mind that removing these barriers can lead to the heroes crafting more items and unbalancing the game in their favor.

### Granting Rewards

You should have as much fun giving out treasure, [Renown](../rule/resource/renown.md), wealth, and titles to the characters as the players have earning those rewards (see Chapter 13: [Rewards](rewards.md)). But what's the right amount of treasure to give out without turning the heroes into total badasses who can simply cut down every dragon they meet? How often do the rules of the game expect a hero to earn [Renown](../rule/resource/renown.md)? What about titles? This section has answers for you!
...
- A party should earn two [leveled treasures](../rule/treasure/leveled-treasure.md) per hero by 10th level. Some heroes need only one [leveled treasure](../rule/treasure/leveled-treasure.md) to be happy, though, so if you feel as if giving out another [leveled treasure](../rule/treasure/leveled-treasure.md) wouldn't actually help a character, you can swap that item out for a [trinket](../rule/treasure/trinket.md) of the character's current [echelon](../rule/general/echelon.md).
- A party should earn one [trinket](../rule/treasure/trinket.md) per hero per [echelon](../rule/general/echelon.md). Any [trinket](../rule/treasure/trinket.md) earned should be of a character's current [echelon](../rule/general/echelon.md) or lower.
- A party should also earn one to three [consumables](../rule/treasure/consumable.md) of their current [echelon](../rule/general/echelon.md) or lower each level.

You don't have to award the full complement of treasure to heroes especially those using their downtime to craft things! You can spread out the pace at which characters earn treasures by having them find the [project sources](../rule/downtime/project-source.md) and [item prerequisites](../rule/downtime/item-prerequisite.md) for crafting an item instead of finding an item outright.
...
- At 1st [echelon](../rule/general/echelon.md), each hero starts with a 1st-[echelon](../rule/general/echelon.md) [trinket](../rule/treasure/trinket.md).
- At 2nd [echelon](../rule/general/echelon.md), each hero starts with a [leveled treasure](../rule/treasure/leveled-treasure.md) and a 1st-[echelon](../rule/general/echelon.md) [trinket](../rule/treasure/trinket.md).
- At 3rd [echelon](../rule/general/echelon.md), each hero starts with two [leveled treasures](../rule/treasure/leveled-treasure.md), a 1st-[echelon](../rule/general/echelon.md) [trinket](../rule/treasure/trinket.md), and a 2nd-[echelon](../rule/general/echelon.md) [trinket](../rule/treasure/trinket.md).
- At 4th [echelon](../rule/general/echelon.md), each hero starts with two [leveled treasures](../rule/treasure/leveled-treasure.md), a 1st-[echelon](../rule/general/echelon.md) [trinket](../rule/treasure/trinket.md), a 2nd-[echelon](../rule/general/echelon.md) [trinket](../rule/treasure/trinket.md), and a 3rd-[echelon](../rule/general/echelon.md) [trinket](../rule/treasure/trinket.md).

The players can choose their hero's treasures, and can replace any [leveled treasure](../rule/treasure/leveled-treasure.md) or [trinket](../rule/treasure/trinket.md) for a [consumable](../rule/treasure/consumable.md) treasure of the hero's [echelon](../rule/general/echelon.md) or lower.
...
You can set limits on the number of [retainers](../rule/general/retainer.md) the heroes can have in their service. For a large group of heroes, having too many [retainers](../rule/general/retainer.md) can make combat complex, long, and unwieldy. Likewise, [retainers](../rule/general/retainer.md) are a great way to help a smaller group of heroes stand up to larger challenges. In general, it's a good idea to use [retainers](../rule/general/retainer.md) to help the heroes get the size of their party up to four but no larger than seven.
...
You can award [hero tokens](../rule/resource/hero-token.md) to the players for taking risks with their heroes beyond what the game typically expects of them. For instance, battling a group of monsters is part of the game and doesn't earn a [hero token](../rule/resource/hero-token.md). However, the following activities might:
...
A successful combat encounter in which the party's [objectives](../rule/combat/objective.md) are achieved earns each hero 1 [Victory](../rule/resource/victories.md). Particularly difficult encounters are worth 2 [Victories](../rule/resource/victories.md) when completed successfully. *Draw Steel: Monsters* has more information about [Victories](../rule/resource/victories.md) and combat difficulty.

##### Montage Tests

Each hero earns 1 [Victory](../rule/resource/victories.md) when they achieve total success on an easy or moderate [montage test](../rule/test/montage-test.md), and 2 [Victories](../rule/resource/victories.md) for total success on a hard [montage test](../rule/test/montage-test.md). They earn 1 [Victory](../rule/resource/victories.md) if they achieve a partial success on a moderate or hard [montage test](../rule/test/montage-test.md).

##### Negotiation

Each hero earns 1 [Victory](../rule/resource/victories.md) if the party ends a Negotiation with an [NPC](../rule/general/npc.md)'s interest at 3 or higher, with that interest 2 or more higher than it started, and with agreement on a deal.

##### Hazards and Traps

If the heroes overcome a complicated hazard or trap that required multiple [tests](../rule/test/test.md) to detect and survive, each earns 1 [Victory](../rule/resource/victories.md).

##### Puzzles

If the heroes solve a complicated puzzle that feels to you as if it would take most people at least 10 minutes to complete, each earns 1 [Victory](../rule/resource/victories.md).

##### Story Goals

If the heroes achieve a major story goal that accomplishes a quest, such as saving a prince trapped by an evil baron or stopping a necromancer from performing a world-ending ritual, each earns 1 [Victory](../rule/resource/victories.md).

##### Clever Thinking

If the heroes use clever thinking to easily and surprisingly overcome or bypass a combat encounter, a negotiation, a [montage test](../rule/test/montage-test.md), a trap, a puzzle, or some other challenge that would have awarded them 1 or more [Victories](../rule/resource/victories.md) in a more difficult fashion, award each character the [Victories](../rule/resource/victories.md) they would have earned had they faced and overcome the problem head on.
