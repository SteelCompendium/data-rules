...
>
> You can turn a perk into a 1st-echelon title simply by giving it a prerequisite (see Chapter 7: [Perks](chapter/perks.md)). For example, a hero might gain the Familiar perk as a title instead if they complete a quest for an archmage, who then teaches the hero the conjuring ritual as a reward.
