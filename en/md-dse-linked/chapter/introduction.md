...
**Dying:** A state a hero enters when their Stamina is 0 or lower but doesn't reach the negative of their winded value. While dying, a hero is [bleeding](../condition/bleeding.md) and they can't use the [Catch Breath](../feature/trait/common/maneuvers/catch-breath.md) maneuver in combat. A hero dies when their Stamina equals the negative of their winded value.
...
**Opportunity Attack:** When an adjacent enemy willingly moves away from a creature without [shifting](../movement/shifting.md) or [teleporting](../movement/teleport.md), the creature can make a melee [free strike](../feature/trait/common/main-actions/free-strike.md) as an opportunity attack against the enemy.
...
**Speed:** A measure of how many squares a creature can move when taking the [Advance](../feature/trait/common/move-actions/advance.md) move action during combat.
