...
- *Healing Gift:* You can use the 1st-level [Conduit](../class/conduit.md) feature [Healing Grace](../feature/ability/conduit/level-1/healing-grace.md) as if you had spent 1 [piety](../feature/trait/conduit/level-1/piety.md) (see Chapter 5: [Classes](../chapter/classes.md)). Once you use this benefit, you can't use it again until you earn 1 or more Victories.
