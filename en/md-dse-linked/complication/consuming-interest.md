---
benefit: 'You have one skill of your choice from the [lore skill group](../skill/lore/lore.md), and you can use the Study Lore project (see below) up to three times for that skill. Each time you use the project, you must use a different [project source](../rule/downtime/project-source.md), and the project goal increases. (See Chapter 12: [Downtime Projects](../chapter/downtime-projects.md).)'
