...
**Benefit:** You are a sapient fungus who inhabits a humanoid body. Your [host body](host-body.md) follows all the usual rules for a character and is considered to be alive. At any time while your [host body](host-body.md) is alive, or for 24 hours after it dies, you can use a main action to move to a dead humanoid within 10 squares of the body and use it as your new [host body](host-body.md), provided the body belongs to a playable ancestry. When you do so, your original [host body](host-body.md) dies if it was alive. Your new [host body](host-body.md) gains all your statistics except size, [ancestry traits](../feature/trait/ancestry-traits.md), and other statistics related to your former [host body's](host-body.md) ancestry, which you instead gain from your new [host body](host-body.md). When you inhabit a new [host body](host-body.md), you start with 1 Stamina and can immediately spend a Recovery.
