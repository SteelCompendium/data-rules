...
```ds-feature
effects:
    - effect: Once per combat round while you are not [dying](../../../rule/health/dying.md), you can spend 2 clarity when you use a triggered action to turn it into a free triggered action.
feature_type: feature
metadata:
    class: talent
    level: "5"
