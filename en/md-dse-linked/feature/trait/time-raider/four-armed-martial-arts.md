...
```ds-feature
effects:
    - effect: Your multiple arms let you take on multiple tasks at the same time. Whenever you use the [Grab](../../common/maneuvers/grab.md) or [Knockback](../../common/maneuvers/knockback.md) maneuver against an adjacent creature, you can target one additional adjacent creature, using the same [power roll](../../../rule/dice/power-roll.md) for both targets. Additionally, you can have up to two creatures [grabbed](../../../condition/grabbed.md) at a time.
feature_type: trait
metadata:
    ancestry: time-raider
    name: Four-Armed Martial Arts
