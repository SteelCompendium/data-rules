...
file_dpath: feature/trait/elementalist/level-2
item_id: disciple-of-the-green
item_name: Disciple of the Green
level: "2"
name: Disciple of the Green
scc: mcdm.heroes.v1/feature.trait.elementalist.level-2/disciple-of-the-green
...
effects:
    - effect: |-
        ...
        | Great cat           | 3rd   | 5                 | 6 (climb)     | 2    | +0              | +1/+1/+1           | As a maneuver, you can jump up to 3 squares in any direction. If you land on<br>an enemy of your size or smaller, that enemy is [knocked prone](../../../../condition/prone.md), and you can<br>make a melee [free strike](../../common/main-actions/free-strike.md) against them (no action required).                                                       |
        | Giant frog          | 4th   | 5                 | 5 (swim)      | 2    | +0              | +0/+0/+0           | Your melee [free strike](../../common/main-actions/free-strike.md) has a distance of melee 3. When you take the Advance<br>move action, you can high jump or long jump up to half your speed. This<br>jump can allow you to move more squares than your speed.                                                              |
        | Horse               | 4th   | 5                 | 8             | 2    | +1              | +0/+0/+0           | You can use the [Charge](../../common/main-actions/charge.md) main action as a maneuver. You can't use two Charge<br>main actions on the same turn.                                                                                                                                                                    |
        ...
        | Giant bird          | 5th   | 0                 | 7 ([fly](../../../../movement/fly.md))       | 2    | +0              | +1/+1/+1           | After making a melee [free strike](../../common/main-actions/free-strike.md), you can [shift](../../../../movement/shifting.md) up to 3 squares as a free<br>triggered action.                                                                                                                                                                                  |
        | Giant<br>salamander | 6th   | 5                 | 5             | 1L   | +3              | +2/+2/+2           | Your melee [free strike](../../common/main-actions/free-strike.md) deals fire damage. Additionally, you have fire immunity<br>3.                                                                                                                                                                                            |
        | Giant spider        | 6th   | 0                 | 5 (climb)     | 2    | +0              | +0/+1/+2           | You have a double edge on melee [free strikes](../../common/main-actions/free-strike.md) against creatures you are hidden<br>from.                                                                                                                                                                                          |
        | Giant snake         | 7th   | 5                 | 5             | 3    | +0              | +0/+1/+2           | Whenever you obtain a tier 2 or tier 3 outcome on a melee [free strike](../../common/main-actions/free-strike.md), you<br>can automatically grab the target. While [grabbed](../../../../condition/grabbed.md) this way, the target takes 2<br>damage at the start of each of their turns.                                                                      |
        | Kangaroo            | 7th   | 0                 | 7             | 1L   | +1              | +0/+0/+4           | When you score a critical hit with a melee [free strike](../../common/main-actions/free-strike.md), the target is [dazed](../../../../condition/dazed.md) (save<br>ends). When you take the [Advance](../../common/move-actions/advance.md) move action, you can high jump or long<br>jump up to half your speed. This jump can allow you to move more squares<br>than your speed.                    |
        ...
        | Giant octopus       | 9th   | 5                 | 5 (swim)      | 3    | +2              | +0/+0/+0           | You can breathe in water. Additionally, you can target two creatures or objects<br>with your melee [free strike](../../common/main-actions/free-strike.md). Whenever you obtain a tier 2 or tier 3 outcome on<br>a melee [free strike](../../common/main-actions/free-strike.md), you can automatically grab the target. You can have up to<br>eight creatures [grabbed](../../../../condition/grabbed.md). |
        | Rhinoceros          | 9th   | 10                | 8             | 2    | +5              | +2/+2/+2           | Whenever you make a melee [free strike](../../common/main-actions/free-strike.md) as part of the Charge action, that<br>strike gains an edge.                                                                                                                                                                               |
        | King terror lizard  | 10th  | 20                | 5             | 4    | +3              | +2/+2/+2           | Your melee [free strike](../../common/main-actions/free-strike.md) is a 1 burst with the Area and Strike keywords.                                                                                                                                                                                                          |
feature_type: trait
metadata:
    class: elementalist
    level: "2"
