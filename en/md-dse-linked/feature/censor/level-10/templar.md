...
effects:
    - effect: |-
        You are the ultimate representation of your god's justice in the timescape. Whenever you use your [Judgment](../../ability/censor/level-1/judgment.md) ability, you can use a free triggered action to use a [conduit](../../../class/conduit.md) domain effect (see [Domain Piety and Effects](../../conduit/level-1/domain-piety-and-effects.md) in the [Conduit](../../../class/conduit.md) section) associated with your chosen domain, or a domain you access with [virtue](virtue.md) (see below). If the effect calls for the use of your [Intuition](../../../rule/character/intuition.md) score, you use your [Presence](../../../rule/character/presence.md) score instead. If the effect uses your [conduit](../../../class/conduit.md) level, use your [censor](../../../class/censor.md) level instead.
