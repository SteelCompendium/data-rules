...
A weapon's damage [bonus](scc:mcdm.heroes.v1/rule.dice/bonuses-and-penalties) only adds to [melee](scc:mcdm.heroes.v1/rule.combat/melee) abilities if your kit has a [melee](scc:mcdm.heroes.v1/rule.combat/melee) damage [bonus](scc:mcdm.heroes.v1/rule.dice/bonuses-and-penalties). A weapon's damage [bonus](scc:mcdm.heroes.v1/rule.dice/bonuses-and-penalties) only adds to [ranged](scc:mcdm.heroes.v1/rule.combat/ranged) abilities if your kit has a [ranged](scc:mcdm.heroes.v1/rule.combat/ranged) damage [bonus](scc:mcdm.heroes.v1/rule.dice/bonuses-and-penalties).
...
If two treasures give a creature a [bonus](scc:mcdm.heroes.v1/rule.dice/bonuses-and-penalties) to their [Stamina](scc:mcdm.heroes.v1/rule.health/stamina) or a [bonus](scc:mcdm.heroes.v1/rule.dice/bonuses-and-penalties) to the [rolled damage](scc:mcdm.heroes.v1/rule.damage/rolled-damage) of their abilities, only the higher [bonus](scc:mcdm.heroes.v1/rule.dice/bonuses-and-penalties) applies unless the treasure's description notes otherwise. [Stamina](scc:mcdm.heroes.v1/rule.health/stamina) [bonus](scc:mcdm.heroes.v1/rule.dice/bonuses-and-penalties)es and damage [bonus](scc:mcdm.heroes.v1/rule.dice/bonuses-and-penalties)es from [consumables](scc:mcdm.heroes.v1/rule.treasure/consumable) ignore this rule, and can be stacked with other [Stamina](scc:mcdm.heroes.v1/rule.health/stamina) [bonus](scc:mcdm.heroes.v1/rule.dice/bonuses-and-penalties)es and damage [bonus](scc:mcdm.heroes.v1/rule.dice/bonuses-and-penalties)es granted by treasures.
...
Although the Director gives out titles, if you want to earn a specific title, let your Director know. For instance, you might say, "I'm interested in the [Dragon Blooded](scc:mcdm.heroes.v1/title/dragon-blooded) title. Can my hero listen for rumors of any wicked dragons nearby that need smiting?" Having ambition is good! Pursue the titles you want that will make you a better hero.

### Title Echelons

Each title is assigned to an [echelon](scc:mcdm.heroes.v1/rule.general/echelon) of play where it is most likely to be earned. For instance, knighthood is something that can be typically earned by the 2nd [echelon](scc:mcdm.heroes.v1/rule.general/echelon), but becoming a [monarch](scc:mcdm.heroes.v1/title/monarch) can usually only be achieved in the 4th [echelon](scc:mcdm.heroes.v1/rule.general/echelon). But don't let the rules get in the way of a good story! If the Director decides that your character somehow wins a knighthood at 1st level, bask in the glory of this great accomplishment.

> For the Director: Granting Titles Early
>
> Granting titles before characters reach the recommended [echelon](scc:mcdm.heroes.v1/rule.general/echelon) can be fun, but it's worth noting that doing so might have unwanted effects on the game. Higher-[echelon](scc:mcdm.heroes.v1/rule.general/echelon) titles often grant more significant benefits than lower-[echelon](scc:mcdm.heroes.v1/rule.general/echelon) titles. If a hero becomes queen at 1st level, her royal responsibilities might overshadow her other adventures. Don't grant a title more than one [echelon](scc:mcdm.heroes.v1/rule.general/echelon) early unless you know what you're getting yourself into!
...
There is no hard-and-fast rule for the number of titles characters should accumulate by a certain level. If a character wins a title whenever they accomplish a truly notable deed—once every few adventures—then they might earn about one title per [echelon](scc:mcdm.heroes.v1/rule.general/echelon). Sticking to this rate isn't a requirement, though. Characters might easily earn twice or half as many titles, making them a bit more or less powerful than they otherwise would be. A Director can even skip granting titles altogether if they wish.
