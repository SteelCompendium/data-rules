---
file_basename: thellasko
file_dpath: god
item_id: thellasko
item_name: Thellasko the Great Designer
...
Thellasko the Great Designer, the Game Master, [Saint](scc.v1:mcdm.heroes.v1/rule.world/saint) of Strategy did not invent war—[humans](scc.v1:mcdm.heroes.v1/ancestry/human) in [Orden](scc.v1:mcdm.heroes.v1/rule.world/orden) hold that honor. Thellasko invented war simulation. Creating what were effectively games to train cadets and lieutenants at the wartable to ensure [victory](scc.v1:mcdm.heroes.v1/rule.resource/victories) on the field.
...
Expensive to produce, *The Game of War* was never very popular outside the Academy of Dis, but Thellasko used it to train a generation of lieutenants on the art of war. His students and best players led the armies of Dis from [victory](scc.v1:mcdm.heroes.v1/rule.resource/victories) to [victory](scc.v1:mcdm.heroes.v1/rule.resource/victories). Thellasko taught his students that an army must fight. All other things being equal, the army with the most experience wins.
...
Kuryalka the False Principle, Soulstealer, Audacity, [Saint](scc.v1:mcdm.heroes.v1/rule.world/saint) of Ambition is credited with inventing the trading scheme known as the Kuryalka Ploy. Daughter and eldest child of Orliath IX—Marquis of Naraka, the City of Blood—tradition held Kuryalka would ascend to the house throne upon her mother's death and rule, but from childhood Kuryalka was obsessed with what was informally known as "the Trade"—the buying and selling of mortal souls from [Orden](scc.v1:mcdm.heroes.v1/rule.world/orden) and elsewhere in the timescape.
...
Sutekh's terrifying hollow laughter could be heard throughout Hell. No mortal, he said, had ever embodied such naked ambition. He accepted her offer, making her the first [Saint](scc.v1:mcdm.heroes.v1/rule.world/saint) of Hell. Sutekh took Kuryalka's souls and founded the Exchange, making the trade in souls an official government department in Hell, and building an entire bureaucracy around it.
