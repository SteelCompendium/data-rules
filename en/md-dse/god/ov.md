...
Though the rest of her captured clan believed the proteans had, for some reason, come to free them, Cho'kassa was not so optimistic. Eventually, the boarding party made it to the prison deck and opened the cells. They were evidently as [surprised](scc.v1:mcdm.heroes.v1/rule.combat/surprised) to find the imprisoned kuran'zoi as the [time raiders](scc.v1:mcdm.heroes.v1/ancestry/time-raider) were to be rescued by proteans!

"You were prisoners, now you are our thralls. Obey and earn your freedom."

The rest of her clan were unsure of their options, but Cho'kassa [grabbed](scc.v1:mcdm.heroes.v1/condition/grabbed) the protean captain's hardlight pistol out of his hand and shot him in the chest. Her clan were now sure.

With that pistol shot, the fight for the UNISOL corvette became a running battle between three factions. The [time raiders](scc.v1:mcdm.heroes.v1/ancestry/time-raider) stole weapons from the bodies their enemies left behind, and the small band fought their way to the bridge, none knowing what they would do once they got there.

On gaining the bridge, messages blared from every signal receiver. Each side demanding the [time raiders](scc.v1:mcdm.heroes.v1/ancestry/time-raider) join them and defeat their enemies. Many promises and threats were made. The kuran'zoi looked to Cho'kassa.
...
Cho'kassa ordered her clan to hold the bridge and seal the door behind her, and she fled alone to the engine room. She picked up a protean rifle as she ran, and though she could hear the battle between the [memonek](scc.v1:mcdm.heroes.v1/ancestry/memonek) and proteans raging, her path was mercifully clear of enemies.
...
The energies of the wounded star-engine ripped through the ship killing the [memonek](scc.v1:mcdm.heroes.v1/ancestry/memonek) and proteans onboard, but did not breach the door to the bridge. Cho'kassa piloted her new body with her family nestled safely inside through the course the wave pilot had set.
...
With her clan manning the blaster turrets, Cho'kassa destroyed the [memonek](scc.v1:mcdm.heroes.v1/ancestry/memonek) ship. Erasing the timeline in which they had originally been captured.
