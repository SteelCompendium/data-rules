...
skills:
    - The [Navigate](scc:mcdm.heroes.v1/skill.exploration/navigate) skill (from the [exploration skill group](scc:mcdm.heroes.v1/skill.group/exploration)), plus two more skills from the [exploration group](scc:mcdm.heroes.v1/skill.group/exploration) (*Quick Build:* [Climb](scc:mcdm.heroes.v1/skill.exploration/climb), [Heal](scc:mcdm.heroes.v1/skill.exploration/heal), [Navigate](scc:mcdm.heroes.v1/skill.exploration/navigate).)
