...
skills:
    - The [Religion](scc:mcdm.heroes.v1/skill.lore/religion) skill (from the [lore skill group](scc:mcdm.heroes.v1/skill.group/lore)), plus two more skills from the [lore group](scc:mcdm.heroes.v1/skill.group/lore) (*Quick Build:* [Culture](scc:mcdm.heroes.v1/skill.lore/culture), [Magic](scc:mcdm.heroes.v1/skill.lore/magic), [Religion](scc:mcdm.heroes.v1/skill.lore/religion).)
