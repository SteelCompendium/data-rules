...
skills:
    - The [Endurance](scc:mcdm.heroes.v1/skill.exploration/endurance) skill (from the [exploration skill group](scc:mcdm.heroes.v1/skill.group/exploration)), plus two skills from either the [crafting group](scc:mcdm.heroes.v1/skill.group/crafting) or the [exploration group](scc:mcdm.heroes.v1/skill.group/exploration) (*Quick Build:* [Blacksmithing](scc:mcdm.heroes.v1/skill.crafting/blacksmithing), [Endurance](scc:mcdm.heroes.v1/skill.exploration/endurance), [Lift](scc:mcdm.heroes.v1/skill.exploration/lift).)
