...
**Skill Options:** One skill from the [interpersonal skill group](scc:mcdm.heroes.v1/skill.group/interpersonal). (*Quick Build:* [Lead](scc:mcdm.heroes.v1/skill.interpersonal/lead).)
