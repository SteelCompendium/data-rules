...
**Skill Options:** One skill from the [intrigue skill group](scc:mcdm.heroes.v1/skill.group/intrigue). (*Quick Build:* [Sneak](scc:mcdm.heroes.v1/skill.intrigue/sneak).)
