...
scc: mcdm.heroes.v1/feature.null.level-1/psionic-augmentation
...
```ds-feature
effects:
    - effect: Your training has turned your body into the perfect psionic weapon, shaping pathways in your mind that enhance your physical form. Choose one of the following augmentations. You can change your augmentation by undergoing a psionic meditation as a [respite](scc:mcdm.heroes.v1/rule.resource/respite) activity. (*Quick Build:* [Speed Augmentation](scc:mcdm.heroes.v1/feature.null.level-1/speed-augmentation).)
feature_type: feature
metadata:
    class: "null"
    level: "1"
