...
```ds-feature
effects:
    - effect: You can maintain bonds with up to three willing creatures using your [Invocation of the Heart](scc:mcdm.heroes.v1/feature.censor.level-4/invocation-of-the-heart) feature. Additionally, you have the following ability.
feature_type: feature
metadata:
    class: censor
    level: "7"
