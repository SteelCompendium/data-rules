...
effects:
    - effect: |-
        Your [elemental specialization](scc:mcdm.heroes.v1/feature.elementalist.level-1/elemental-specialization) grants you a triggered action, as shown on the Specialization Triggered Actions table.
