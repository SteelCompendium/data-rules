...
effects:
    - effect: You spend a Recovery and the target regains Stamina equal to your recovery value.
    - effect: '1 Wrath: You can end one effect on the target that is ended by a saving throw or that ends at the end of their turn, or a prone target can stand up.'
      name: Spend
feature_type: ability
flavor: You channel some of your vitality into more resilience for you or an ally.
keywords:
