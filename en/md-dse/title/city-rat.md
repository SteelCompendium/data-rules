...
item_name: City Rat
name: City Rat
prerequisite: You have spent at least five [respites](scc:mcdm.heroes.v1/rule.resource/respite) in a metropolis.
...
- *Street Smart:* While in a settlement, you can't be [surprised](scc:mcdm.heroes.v1/rule.combat/surprised).
