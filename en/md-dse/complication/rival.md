---
benefit: Choose one of your skills. That skill grants a +3 [bonus](scc:mcdm.heroes.v1/rule.dice/bonuses-and-penalties) to [tests](scc:mcdm.heroes.v1/rule.test/test) instead of +2.
