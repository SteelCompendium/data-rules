...
drawback: While [dying](scc:mcdm.heroes.v1/rule.health/dying), you grow and retract uncoordinated limbs at random, imposing a [bane](scc:mcdm.heroes.v1/rule.dice/bane) on your [power rolls](scc:mcdm.heroes.v1/rule.dice/power-roll).
file_basename: chaos-touched
file_dpath: complication
flavor: You came into contact with a mote of pure chaos energy, or were subjected to a supernatural effect or object that fused chaos into your very being. Now you can sprout and retract your limbs in a way that horrifies unprepared onlookers.
